...
\item[Step 2.] Read "Adventure Background" for more context and familiarize yourself with the Key NPCs (p. 1) table, which describes important individuals the characters will interact with throughout the adventure.
...
After finding the bulette, the characters might follow the sounds of belching and laughter (see "Hill Giant Camp") or might reconnoiter the area (see "Tunnels to the Dragon's Lair"). Use the "Surface" half of Nakari's Lair (p. 1) map for either approach.
