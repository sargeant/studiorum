...
\begin{description}
\item[Key Plot Points] \textbf{Key Plot Points.} A summary of the key elements in the adventure's story
\item[Preparation] \textbf{Preparation.} Steps to get yourself ready to run the adventure, including a list of all the stat blocks from the Monster Manual you might need
\item[Key NPCs] \textbf{Key NPCs.} A table summarizing key nonplayer characters in the adventure---their names, roles, stat blocks, and locations---to help you keep track of them during play
\end{description}
...
\begin{description}
\item[Initiative Tracker] \textbf{Initiative Tracker.} In combat, one player tracks Initiative for the characters and monsters.
\item[Monster Wranglers] \textbf{Monster Wranglers.} Whenever the characters enter combat with Hostile monsters, one or two players run these monsters using the stat blocks in the Monster Manual. (Two players can share this role.)
\item[Rules Consultant] \textbf{Rules Consultant.} One player references rules in the Player's Handbook or other books as needed.
\end{description}
...
\begin{description}
\item[Deciphering Clues] \textbf{Deciphering Clues.} The adventurers undertake a quest to find the lost verses of a magical song that can rejuvenate the soil of a dying land. The characters must decipher clues hidden in another song's lyrics with the help of chatty locals.
\item[Braving the Rattle] \textbf{Braving the Rattle.} Having learned where the lost verses are, the characters travel to a copper dragon's lair in the hills of a region called the Rattle.
\item[Navigating Nakari's Lair] \textbf{Navigating Nakari's Lair.} The characters must convince Nakari, the copper dragon, to hand over the verses. Failing that, they can try to take the verses by force or learn them from a source hidden within the dragon's lair.
\end{description}
\section{Preparation}
...
\begin{description}
\item[Step 1] \textbf{Step 1.} If you're running the adventure for a single adventurer, read the "Running for One Character" section.
\item[Step 2] \textbf{Step 2.} Read "area Adventure Background" for more context and familiarize yourself with the Key NPCs (p. 1) table, which describes important individuals the characters will interact with throughout the adventure.
\item[Step 3] \textbf{Step 3.} Make a copy of the Copper for a Song handout for each player. (You will share it with them shortly after the adventure starts.)
\item[Step 4] \textbf{Step 4.} Bookmark the following stat blocks in the Monster Manual or on D\&D Beyond:
\end{description}
...
\begin{description}
\item[Nakari] \textbf{Nakari.} The copper dragon, Nakari, loves art. The kobolds hope she will appreciate the clay statue they've crafted for her. The kobolds don't know where the dragon keeps her hoard; they've had no luck finding it.
\item[Secret Doors] \textbf{Secret Doors.} Nakari's lair contains secret doors that the kobolds have witnessed the dragon open magically. (The kobolds can lead characters to the secret doors concealing areas area N7, area N12, and area N15, but the kobolds can't open them. The kobolds are unaware of the secret door concealing area area N16, having never visited that part of the lair.)
\item[Wyrmlings] \textbf{Wyrmlings.} Nakari rescued a pair of wyrmlings from the nearby forest and is raising them as her own. Both wyrmlings have tried to murder the kobolds more than once. (The kobolds don't know the wyrmlings' names.)
\end{description}
...
\begin{description}
\item[Gnome's Name] \textbf{Gnome's Name.} The gnome's name was Gleem Happenbolt.
\item[Home] \textbf{Home.} The gnome came from a mining settlement five miles north of the Rattle.
\item[War Pick] \textbf{War Pick.} The gnome's weapon is a family heirloom Gleem inherited from his uncle (see "Treasure" below).
\item[What Happened] \textbf{What Happened.} The gnome was searching the hills for gem deposits when he saw a copper dragon flying overhead. Believing the dragon to be friendly and thinking it might lead him to treasure, he followed it. The dragon led Gleem to this cave complex, but some of the boulders here "woke up" and tried to scare him away. When he wouldn't leave, they battered him to death.
\end{description}
...
\begin{description}
\item[Lead Designers:] \textbf{Lead Designers:} Amanda Hamon, James Wyatt
\item[Designers:] \textbf{Designers:} Justice Ramin Arman, Makenzie De Armas, Anthony Joyce-Rivera, Renee Knipe, Ron Lundeen, Christopher Perkins, Patrick Renie, Erin Roberts, F. Wesley Schneider, Carl Sibley, Jason Tondro, Steve Townshend
\item[Rules Developers:] \textbf{Rules Developers:} Makenzie De Armas (lead), Jeremy Crawford, Ron Lundeen
\item[Editors:] \textbf{Editors:} Judy Bauer (lead), Emma Candon, Sadie Lowry, Hannah Rose, Sue Weinlein, Hans Ziegler
\item[Art Directors:] \textbf{Art Directors:} Matt Cole (lead), Fury Galluzzi, Josh Herman, Kate Irwin, Emi Tanji
\item[Graphic Designers:] \textbf{Graphic Designers:} Matt Cole, Paolo Vacala
\item[Cover Illustrators:] \textbf{Cover Illustrators:} Justine Jones, Greg Staples
\item[Interior Illustrators:] \textbf{Interior Illustrators:} Tom Babbey, Daren Bader, Clyde Caldwell, Chippy, Simon Dominic, Jeff Easley, Luke Eidenschink, Larry Elmore, Jason A. Engle, Lars Grant-West, John Grello, Johan Grenier, Justine Jones, Andrew Kolb, Vance Kovacs, Andrey Kuzinskiy, Ed Kwong, Todd Lockwood, Antonio José Manzanedo, Dominik Mayer, Caio Monteiro, Martin Mottet, Jodie Muir, Mark A. Nelson, Alexander Ostrowski, Keith Parkinson, Anna Podedworna, Steve Prescott, Chris Rallis, Joshua Raphael, Richard Sardinha, Chris Seaman, Rudy Siswanto, Craig J Spearing, Ron Spencer, Leroy Steinmann, Zack Stella, Matt Stewart, Matt Stikker, David C. Sutherland, Autumn Rain Turkel, Paolo Vacala, Svetlin Velinov, Raoul Vitale, Jabari Weathers, Campbell White
\item[Cartographers:] \textbf{Cartographers:} Francesca Baerald, Jared Blando, CoupleOfKooks, Andrew Kolb, Dyson Logos, Damien Mammoliti, Mike Schley, Paolo Vacala
\item[Consultants:] \textbf{Consultants:} Shawn Banerjee, Eytan Bernstein, Daniel Delgado, Sameer Joseph
\item[Producers:] \textbf{Producers:} Rob Hawkey (lead), Bill Benham, Siera Bruggeman, Vanessa Hoskins
\end{description}
