...
async def test_new_content_types():
    ...
    try:
        ...
        data_paths = [Path("5etools-src/data"), Path("test-data")]
                    ...
                    "background": [
                        {
                            ...
                            "entries": ["A simple test background."],
                        }
                    ]
                }
                import json
    ...
    try:
        ...
        for content_type, name in test_cases:
            try:
                ...
                type_specific = [
                    item for item in found_items if item.content_type == content_type
                ]
                ...
                if type_specific:
                    ...
                    print(
                        f"- {name} ({content_type.value}) not found (may not be in test data)"
                    )
