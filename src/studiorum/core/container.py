...
class DefaultServiceContainer:
    ...
    def get_omnidexer(self) -> Result[Omnidexer, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import create_omnidexer_proxy
    ...
    def get_tag_resolver(self) -> Result[TagResolver, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import create_tag_resolver_proxy
    ...
    def get_content_type_registry(self) -> Result[ContentTypeRegistry, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import (
                create_content_type_registry_proxy,
            )
    ...
    def get_display_manager(self) -> Result[DisplayManager, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import create_display_manager_proxy
    ...
    def get_content_factory(self) -> Result[ContentFactory, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import create_content_factory_proxy
    ...
    def get_entry_registry(self) -> Result[EntryTypeRegistry, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import create_entry_registry_proxy
    ...
    def get_reference_manager(self) -> Result[ReferenceManager, ServiceError]:
        ...
        """
        try:
            from studiorum.core.services.proxies import create_reference_manager_proxy
...
async def create_mcp_request_container(
    ...
    """
    from studiorum.core.services.container import RequestScopedContainer
