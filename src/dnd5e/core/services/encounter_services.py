...
if TYPE_CHECKING:
    ...
    from dnd5e.mcp.tools.encounter.balancer import (
        BalanceAnalysis,
        BalanceStrategy,
        EncounterBalancer,
        OptimizationGoal,
...
from dnd5e.core.services.encounter_collector import EncounterCollector
...
def register_encounter_services(container: Any) -> None:  # ModernServiceContainer
    ...
    """
    from dnd5e.core.services.lifecycle import CleanupPriority, ServiceLifecycle
...
def get_encounter_service_lifecycle_summary() -> dict[str, dict]:
    ...
    """
    from dnd5e.core.services.lifecycle import CleanupPriority
