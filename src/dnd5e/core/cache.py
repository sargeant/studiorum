...
class CacheManager:
    ...
    def _get_cache_path(self, key: str) -> Path:
        ...
        # Create hash of key for filename (using SHA256 for security)
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        with self._lock:
            ...
            try:
                ...
                # Load cached data
                # Note: Using pickle for local cache only - never load untrusted data
                # This cache only contains data generated by this application
    ...
    def set(self, key: str, value: Any, ttl: timedelta | None = None) -> None:
        ...
        with self._lock:
            ...
            try:
                # Save data
                # Note: Using pickle for local cache only - data is application-generated
                with open(cache_path, "wb") as f:
                    pickle.dump(value, f)  # nosec B301
