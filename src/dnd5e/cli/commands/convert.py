...
def convert_creatures(
    ...
    # Combat filtering
    min_ac: int | None = typer.Option(None, "--min-ac", help="Minimum armor class"),
    max_ac: int | None = typer.Option(None, "--max-ac", help="Maximum armor class"),
    min_hp: int | None = typer.Option(None, "--min-hp", help="Minimum hit points"),
    max_hp: int | None = typer.Option(None, "--max-hp", help="Maximum hit points"),
    # Special abilities
