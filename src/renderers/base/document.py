...
class DocumentRenderer(BaseRenderer):
    ...
    def render_document_to_file(self, content_items: List[BaseContent],
                               output_path: Path, context: RenderContext) -> None:
        ...
        try:
            ...
            raise RenderingError(f"Failed to render document to {output_path}: {e}") from e