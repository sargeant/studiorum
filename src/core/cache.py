...
class CacheManager:
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        with self._lock:
            ...
            try:
                ...
                ttl = timedelta(seconds=metadata.get('ttl', self.default_ttl.total_seconds()))
    ...
    def cached_call(self, key: str, func: Callable, *args, ttl: Optional[timedelta] = None, **kwargs) -> Any:
        """
        ...
        try:
            ...
            for meta_file in self.cache_dir.glob("*.meta"):
                try:
                    ...
                    cache_file = self.cache_dir / meta_file.name.replace('.meta', '.cache')
