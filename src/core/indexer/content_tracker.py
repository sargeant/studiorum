...
class ContentTracker:
    ...
    def add_content(self, content_type: str, name: str, source: Optional[str] = None, 
    ...
    def get_tracked_content_by_type(self, content_type: str) -> List[TrackedContent]:
        ...
        return [
            content for content in self.get_tracked_content()
            if content.content_type == content_type
        ]
    
    def get_content_count(self, content_type: str, name: str, source: Optional[str] = None) -> int:
    ...
    def has_content(self, content_type: str, name: str, source: Optional[str] = None) -> bool:
    ...
    def remove_content(self, content_type: str, name: str, source: Optional[str] = None) -> bool:
    ...
    def merge_tracker(self, other: 'ContentTracker') -> None:
        ...
        for content in other._tracked_content:
            ...
            self.add_content(content.content_type, content.name, content.source, content.page)
