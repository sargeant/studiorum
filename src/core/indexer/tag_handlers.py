...
from .tag_ast import (
    ASTNode, TagNode, TextNode, CreatureTagNode, SpellTagNode, ItemTagNode,
    ClassTagNode, RaceTagNode, BackgroundTagNode, FeatTagNode, BoldTagNode,
    ItalicTagNode, DiceTagNode, HitTagNode, DCTagNode, DamageTagNode,
    ConditionTagNode, ChanceTagNode, RechargeTagNode, AdventureTagNode,
    BookTagNode, FilterTagNode, LoaderTagNode
)
...
class BoldTagHandler(TagHandler):
    ...
    def render(self, node: BoldTagNode, context: 'RendererContext') -> str:
        ...
        content = "".join(
            context.render_node(child) for child in node.content_nodes
        )
