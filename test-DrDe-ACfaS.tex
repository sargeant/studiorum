...
\title{Adventure: Dragon Delves: A Copper for a Song}
\date{\today}
...
\subsubsection{One-Shot Adventure}
...
\subsubsection{In an Ongoing Campaign}
...
\subsubsection{Option 1: Mysterious Patron}
...
\subsubsection{Player Assistance}
...
\subsubsection{Adventures for One Character}
...
\subsubsection{Blessing of the Lone Champion}
...
\item \textbf{Step 2.} Read "area Adventure Background" for more context and familiarize yourself with the 1 (p. Key NPCs) table, which describes important individuals the characters will interact with throughout the adventure.
...
\subsubsection{Proclaimer Ward's Quest}
...
\subsubsection{Listening Post Conversations}
...
\subsubsection{Danger in the Hills}
...
After finding the bulette, the characters might follow the sounds of belching and laughter (see "area Hill Giant Camp") or might reconnoiter the area (see "area Tunnels to the Dragon's Lair"). Use the "Surface" half of 1 (p. Lair Locations) map for either approach.

\paragraph{Hill Giant Camp}
...
Use the "Surface" half of 1 (p. Lair Locations) map for this encounter. The characters approach from the east.

The glittering crystalline formations in the rock drew Nakari to this area. These crystals are pretty but not valuable.

\subparagraph{Hill Giants}
...
\paragraph{Tunnels to the Dragon's Lair}

Characters who reconnoiter the area notice four tunnel entrances (marked on the "Surface" half of 1 (p. Lair Locations)), all of which lead down to the dragon's lair. The tunnels are too small for the giants to enter comfortably, so they don't even try.
...
\subparagraph{Roleplaying the Kobolds}
...
\subparagraph{Sculpting the Statue}
...
\paragraph{N8: Southern Boulder Cave}
...
\paragraph{N11: Northern Boulder Cave}
...
\subparagraph{Sequestered Maestro}
...
\paragraph{N14: Western Boulder Cave}
...
\paragraph{N15: Tunnel to the Dragon's Den}

This tunnel is filled with laughing gas (see "area Lair Features").

\paragraph{N16: Hidden Hoard}
...
\subparagraph{Roleplaying Nakari}
...
\section{N1: East Entrance}\label{sec:n1-east-entrance-3}

\section{N2: South Entrance}\label{sec:n2-south-entrance-4}

\section{N3: North Entrance}\label{sec:n3-north-entrance-5}

\section{N4: West Entrance}\label{sec:n4-west-entrance-6}

\section{N5: Eastern Boulder Cave}\label{sec:n5-eastern-boulder-cave-7}

\section{N6: Kobold Cave}\label{sec:n6-kobold-cave-8}

\section{N7: Molting Cave}\label{sec:n7-molting-cave-9}

\section{N8: Southern Boulder Cave}\label{sec:n8-southern-boulder-cave-10}

\section{N9: Laughing Cave}\label{sec:n9-laughing-cave-11}

\section{N10: Reception Cave}\label{sec:n10-reception-cave-12}

\section{N11: Northern Boulder Cave}\label{sec:n11-northern-boulder-cave-13}

\section{N12: Maestro's Cave}\label{sec:n12-maestros-cave-14}

\section{N13: Worm Cave}\label{sec:n13-worm-cave-15}

\section{N14: Western Boulder Cave}\label{sec:n14-western-boulder-cave-16}

\section{N15: Tunnel to the Dragon's Den}\label{sec:n15-tunnel-to-the-dragons-den-17}

\section{N16: Hidden Hoard}\label{sec:n16-hidden-hoard-18}

\section{N17: Nakari's Den}\label{sec:n17-nakaris-den-19}

\section{N18: Wyrmlings' Nursery}\label{sec:n18-wyrmlings-nursery-20}

\chapter{Credits}\label{ch:credits-21-3}
