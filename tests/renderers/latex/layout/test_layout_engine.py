...
from dnd5e.renderers.latex.layout.layout_engine import LayoutEngine
...
class TestLayoutEngine:
    ...
    def test_managers_sorted_by_priority(self):
    ...
    def test_process_content_with_strategy(self):
    ...
    def test_process_content_with_hints(self):
    ...
    def test_determine_strategy_from_content_type(self):
    ...
    def test_determine_strategy_from_hints(self):
    ...
    def test_determine_strategy_unknown_type(self):
    ...
    def test_process_content_blocks_empty(self):
        """Test processing empty content blocks."""
        result = self.engine.process_content_blocks([])
        assert result == []

    def test_process_content_blocks_single(self):
    ...
    def test_process_content_blocks_multiple(self):
    ...
    def test_analyze_content_blocks(self):
    ...
    def test_estimate_page_position(self):
    ...
    def test_generate_block_hints_first_block(self):
    ...
    def test_generate_block_hints_last_block(self):
    ...
    def test_generate_block_hints_content_type_change(self):
    ...
    def test_generate_block_hints_creature_content(self):
    ...
    def test_optimize_block_sequence_disabled(self):
        """Test block sequence optimization when disabled."""
        engine = LayoutEngine({"enable_optimization": False})
    ...
    def test_optimize_block_sequence_enabled(self):
    ...
    def test_content_has_floats(self):
    ...
    def test_content_has_sidebars(self):
    ...
    def test_content_has_tables(self):
    ...
    def test_get_manager_by_type(self):
        """Test getting manager by type."""
        from dnd5e.renderers.latex.layout.float_manager import FloatManager
    ...
    def test_set_global_strategy(self):
    ...
    def test_optimize_for_adventure_document(self):
    ...
    def test_optimize_for_reference_document(self):
    ...
    def test_optimize_for_supplement_document(self):
    ...
    def test_get_layout_statistics_empty(self):
    ...
    def test_get_layout_statistics_mixed_content(self):
