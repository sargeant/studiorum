...
from dnd5e.renderers.latex.dnd_template import (
    DNDTemplateManager,
...
class TestDNDTemplateManager:
    ...
    def test_find_template_file_found(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_find_template_file_not_found(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_find_template_file_timeout(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_find_template_file_no_kpsewhich(self, mock_run):
    ...
    def test_check_template_availability_all_found(self, mock_find):
    ...
    @patch.object(DNDTemplateManager, "_find_template_file")
    def test_check_template_availability_some_missing(self, mock_find):
        """Test template availability when some files are missing."""

        def mock_find_side_effect(filename):
    ...
    @patch("subprocess.run")
    def test_check_latex_installation_available(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_check_latex_installation_not_available(self, mock_run):
    ...
    def test_check_required_packages_all_available(self, mock_check):
    ...
    @patch.object(DNDTemplateManager, "_check_package_available")
    def test_check_required_packages_some_missing(self, mock_check):
        """Test required packages check when some are missing."""

        def mock_check_side_effect(package):
            return package != "expl3"
    ...
    @patch("subprocess.run")
    def test_check_package_available_found(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_check_package_available_not_found(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_get_texmf_paths_with_kpsewhich(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_get_texmf_paths_fallback(self, mock_run):
    ...
    def test_get_system_info(self, mock_check_latex):
    ...
    def test_create_installation_guide(self):
    ...
    def test_print_status_report(self, mock_packages, mock_latex, mock_template):
...
class TestUtilityFunctions:
    ...
    def test_check_dnd_template_status_all_good(
        self, mock_packages, mock_template, mock_latex
    ):
        ...
        result = check_dnd_template_status()
        assert result is True

    @patch.object(DNDTemplateManager, "check_latex_installation")
    def test_check_dnd_template_status_no_latex(self, mock_latex):
    ...
    @patch.object(DNDTemplateManager, "check_latex_installation")
    @patch.object(DNDTemplateManager, "check_template_availability")
    def test_check_dnd_template_status_no_template(self, mock_template, mock_latex):
    ...
    def test_get_dnd_document_class_options(self):
        """Test getting document class options."""
        options = get_dnd_document_class_options()
    ...
    def test_get_recommended_class_options(self):
        ...
        adventure_options = get_recommended_class_options("adventure")
        ...
        unknown_options = get_recommended_class_options("unknown")
...
class TestIntegration:
    ...
    @patch.object(DNDTemplateManager, "check_latex_installation")
    @patch.object(DNDTemplateManager, "check_required_packages")
    def test_full_system_check(self, mock_packages, mock_latex, mock_template):
    ...
    def test_get_class_options_comprehensive(self):
        ...
        for content_type in content_types:
            recommendations = get_recommended_class_options(content_type)
