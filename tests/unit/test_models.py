...
from src.core.models.creatures import ArmorClass, Creature, HitPoints, Speed, CreatureType, Ability
...
class TestCreature:
    ...
    def test_creature_type_field_validation(self):
        ...
        # String type
        data1 = {"name": "Test", "source": {"abbreviation": "TST"}, "size": ["M"], "type": "beast", "alignment": ["N"], "ac": [15], "hp": {"average": 10}, "speed": {"walk": 30}, "str": 10, "dex": 10, "con": 10, "int": 10, "wis": 10, "cha": 10}
    ...
    def test_creature_ac_field_validation(self):
        ...
        base_data = {"name": "Test", "source": {"abbreviation": "TST"}, "size": ["M"], "type": "beast", "alignment": ["N"], "hp": {"average": 10}, "speed": {"walk": 30}, "str": 10, "dex": 10, "con": 10, "int": 10, "wis": 10, "cha": 10}
    ...
    def test_creature_hp_speed_validation(self):
        ...
        base_data = {"name": "Test", "source": {"abbreviation": "TST"}, "size": ["M"], "type": "beast", "alignment": ["N"], "ac": [15], "speed": {"walk": 30}, "str": 10, "dex": 10, "con": 10, "int": 10, "wis": 10, "cha": 10}
    ...
    def test_creature_ability_parsing(self):
        ...
        base_data = {"name": "Test", "source": {"abbreviation": "TST"}, "size": ["M"], "type": "beast", "alignment": ["N"], "ac": [15], "hp": {"average": 10}, "speed": {"walk": 30}, "str": 10, "dex": 10, "con": 10, "int": 10, "wis": 10, "cha": 10}
        
        # Trait parsing
        data = base_data.copy()
        data["trait"] = [{"name": "Keen Sight", "entries": ["The eagle has advantage on perception checks."]}]
    ...
    def test_creature_alignment_text_formatting(self):
        ...
        base_data = {"name": "Test", "source": {"abbreviation": "TST"}, "size": ["M"], "type": "beast", "hp": {"average": 10}, "speed": {"walk": 30}, "ac": [15], "str": 10, "dex": 10, "con": 10, "int": 10, "wis": 10, "cha": 10}
    ...
    def test_creature_text_methods(self):
        ...
        base_data = {"name": "Test Dragon", "source": {"abbreviation": "TST"}, "size": ["L"], "type": "dragon", "alignment": ["C", "E"], "ac": [{"ac": 18, "from": ["natural armor"]}], "hp": {"average": 100, "formula": "10d10 + 50"}, "speed": {"walk": 40, "fly": 80}, "str": 20, "dex": 14, "con": 20, "int": 16, "wis": 13, "cha": 16}
...
class TestSpeed:
    ...
    def test_speed_with_conditions(self):
        ...
        speed = Speed(
            walk=30,
            fly={"number": 60, "condition": "hover, magical"}
        )
        result = str(speed)
        assert "30 ft." in result
...
class TestAbility:
    ...
    def test_ability_basic(self):
        ...
        ability = Ability(name="Multiattack", entries=["The dragon makes three attacks."])
