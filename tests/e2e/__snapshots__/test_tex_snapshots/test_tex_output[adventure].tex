...
\chapter{The Beginning}\label{ch:the-beginning-1-1}
...
\section{The Quest}\label{sec:the-quest-2}

\section{The Journey}\label{sec:the-journey-3}

\chapter{The Repository}\label{ch:the-repository-4-2}
