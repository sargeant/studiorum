...
\tableofcontents
\newpage
\chapter{A Book of Books}
\DndDropCapLine{{}{}@i Candlekeep Mysteries} is an anthology of adventures written by members of the Dungeons \& Dragons community. Each adventure begins with a book that the characters find in Candlekeep, an enormous library located on the Sword Coast in the Forgotten Realms setting.
...
\begin{itemize}
\item On the world of Exandria, the Soltryce Academy in Rexxentrum (a large city on the continent of Wildemount) or the Cobalt Reserve in Westruun (a small city on the continent of Tal'dorei)
\item On the world of Eberron, the Library of Korranberg in the nation of Zilargo, the University of Wynarn's library in the nation of Aundair, or Morgrave University's library in the city of Sharn
\item On the world of Oerth, the Great Library in the Free City of Greyhawk
\end{itemize}
...
\begin{itemize}
\item The characters discover a book in the library that contains a mystery. Getting to the bottom of this mystery requires embarking on an adventure.
\item The characters come to Candlekeep on a quest for information, perhaps to solve a crisis elsewhere in the world. During their research, they uncover a book and the mystery it contains, which leads to adventure.
\end{itemize}
...
\subsubsection{Be a Sensitive Dungeon Master}
...
\subsubsection{Dissecting the Adventures}
...
\subsubsection{About the Forgotten Realms}
...
\begin{DndSidebar}[float=!b]{Tendays and Dalereckoning}
...
\begin{DndTable}[header=Candlekeep Mysteries]{XXX}
...
\begin{DndTable}[header=Avowed Adjutants]{cX}
...
\subparagraph{Magic Restriction}
...
\subsection{Orders of Accordance}
...
\section{Sages and Master Sages}
...
\begin{itemize}
\item A'lai Aivenmore, a human master sage and worshiper of Oghma (god of knowledge). Primary expertise: divinity (the gods and the nature of the divine).
\item Alkrist, a dragonborn master sage of bronze dragon ancestry. Primary expertise: politics, military strategy, and significant battles of Toril.
\item Daral Yashenti, a human master sage and poet. Primary expertise: music, poetry, and literature.
\item Fheminor Scrivenbark, a lightfoot halfling master sage. Primary expertise: history, folklore, and the cultures of Toril (past and present).
\item Kazryn Nyantani, a human master sage. Primary expertise: the natural world and celestial navigation.
\item Sylvira Savikas, a tiefling archmage. Primary expertise: the Great Wheel of the planes.
\item Teles Ahvoste, a human archmage. Primary expertise: magic items, curses, and the Weave.
\item V'ziir-Ag, a githzerai master sage. Primary expertise: all things unnatural (including aberrations, undead, and the Far Realm).
\end{itemize}

\subsubsection{Master Readers}
...
\subparagraph{Demiplanar Chambers}
...
\begin{DndSidebar}[float=!b]{Little One}
...
\subsubsection{Bath and Steam House}
...
\subsubsection{House of the Binder}
...
\subparagraph{Works of the Avowed}
...
\subsubsection{Pillars of Pedagogy}
...
\subsubsection{Erudite Outfitters \& Clothiers}
...
\subsubsection{Smithy and Stables}
...
\begin{DndSidebar}[float=!b]{Extradimensional Spaces}
...
\subsubsection{Miirym the Sentinel Wyrm}
...
\subsubsection{Echoes of Alaundo}
...
\subsubsection{Chamber of Lost Lore}
...
\begin{itemize}
\item Creating permanent versions of existing spells
\item Demiplanes, pocket dimensions, and other spaces that exist outside the Material Plane
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Imp Figurine}
...
\subsection{Encounter Locations}
...
\subsection{Middle Level (M1-M9)}
\subsubsection{M1. Foyer and Hallway}
...
\subsubsection{M4. Exercise Room}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item Almost all the books in this study were written by someone named Fistandia. Most are her memoirs.
\item Fistandia was a powerful mage as well as a priest of Mystra. She frequented Candlekeep to further her studies.
\item In exchange for Fistandia's pious service and achievements in expanding the arts of magic, Mystra granted Fistandia a permanent extradimensional mansion for her to reside in when studying in Candlekeep.
\item Fearful that a guest might become trapped in the mansion, Fistandia hid the command word to open the portal to Candlekeep on the spines of seven books in her mansion.
\end{itemize}
...
\begin{itemize}
\item Cumin was created by Fistandia, while Coriander says that a mage named Freyot created it.
\item Their masters went away a long time ago.
\item They have been warned by their masters not to touch any books that have single letters on their spines. (The homunculi don't know the significance of these lettered books.)
\item Fistandia used to go into the planetarium (area M12) and disappear for a long time afterward.
\item Something keeps building piles of books in the library. (The homunculi are unaware of the swarm of animated books in area M3.)
\item The imp that Fistandia summoned hasn't been seen in some time.
\item The faerie dragons in the arboretum (area M9) are mischievous but harmless. Try to stay out of their way.
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Fistandia's and Freyot's Homunculi}
...
\subsection{Upper Level (M10-M16)}
\subsubsection{M10. Stairs}
...
\subparagraph{Planetarium Puzzle}
...
\subsubsection{M13. The Chained Library}
...
\subsection{Lower Level (M17-M19)}
\subsubsection{M17. Alchemical Laboratory}
\begin{DndReadAloud}{}
...
\subsubsection{M18. Summoning Room}
\begin{DndReadAloud}{}
...
\subsubsection{M19. Preserved Menagerie}
\begin{DndReadAloud}{}
...
\subsection{Assembling the Books}
...
\begin{itemize}
\item Magic and the Weave
\item Lycanthropy and its origins
\item Demon lords of the Abyss
\end{itemize}
...
\subsection{Essays and Ramblings}
...
\begin{itemize}
\item All magic depends on the Weave, an interface between casters and raw magic that is governed by Mystra, god of magic. Arcane spellcasters access the Weave directly, while divine spellcasters are granted access to it by their deities and ideals. Damage to the Weave can cause unimaginable destruction, as evidenced by the Spellplague in 1385 DR, the Year of Blue Fire.
\item Some scholars believe that Malar, god of the hunt, is responsible for lycanthropy. Mazfroth disagrees with this theory on the basis that not all lycanthropes are evil as Malar is. Werebears are an example of lycanthropes that are usually good.
\item The Abyss is ruled by demon lords—Baphomet, Demogorgon, Graz'zt, Juiblex, Orcus, Yeenoghu, Zuggtmoy, and many others. Mazfroth ties the origins of several monsters to these demon lords (saying Juiblex created all oozes, for example).
\end{itemize}
...
\subsection{What the Avowed Know}
The following information can be learned from talking to Candlekeep's monks and sages:


\begin{itemize}
\item Mazfroth's Mighty Digressions is the third book to transform into an ectoplasmic monster. The other two books were The Dark Hunger (about a powerful entity served by star-fearing warlocks) and Fallen Tethyamar (about a dwarf king named Ghellin who sought to reclaim his kingdom in the Desertmouth Mountains).
\item All three books were used to gain entrance to Candlekeep in the past two months.
\item The Avowed keep records of the seekers allowed into Candlekeep and the books they gifted the library. Two seekers who gained entry with monstrous books are still in Candlekeep: Yalerion Highscroll (who brought Mazfroth's Mighty Digressions) and Valor (who brought The Dark Hunger). The Avowed know where to find them.
\end{itemize}
...
\subsection{Questioning Seekers}
...
\subsubsection{Yalerion Highscroll}
...
\begin{itemize}
\item Ten days ago, Yalerion bought the book they thought was Mazfroth's Mighty Digressions from a market stall in the Wide, a large and crowded marketplace in the Upper City of Baldur's Gate.
\item They remember that the stall's name had "dune" in it, but nothing else about the place. The Wide was too noisy and hectic for their liking.
\item They arrived at Candlekeep five days ago and intend to stay for five more.
\end{itemize}
...
\begin{itemize}
\item Autumn's Breads, a street bakery with fresh pastries, breads, and cakes for 1 sp each.
\item Coppers to Crowns, an "antiques" shop selling a miscellany of trinkets and oddities (roll 2d4 times on the trinket in the Player's Handbook). Each trinket costs 2d10 cp.
\item Gems for All, a shop with a variety of gemstones, all worth 50 gp or less.
\item Heath's Hot Drinks, a stall offering cups of mulled wine, hot cider, and strong teas for 2 sp each. In the summer, the sign is repainted to read "Heath's Cool Drinks" and the stall serves chilled fruit juice and iced tea.
\item Wizards of the Wide, a tent bursting with dozens of arcane foci and Spell Scroll, including scrolls of comprehend languages, detect magic, feather fall, find familiar, mage armor, magic missile, shield, and unseen servant (25 gp each).
\end{itemize}

\subsection{Amberdune Books}
...
\subparagraph{Speaking with the Manager}
...
\subparagraph{Tailing the Jackalweres}
...
\begin{itemize}
\item Avani, a middle-aged jackalwere who considers it her duty to keep the rest of her pack from doing anything to attract attention from the Watch
\item Inbar, a quiet, reserved jackalwere who wears spectacles in his human and hybrid forms
\item Marliza, a petite jackalwere whose wide eyes and long braids belie her cunning
\item Ramah, Inbar's outspoken brother, who prefers to spend his shift at Amberdune Books loudly orating from a tome to entice potential customers
\item Theryn, a young jackalwere with deft hands, good for repairing damaged books or liberating a few coins from wealthy pockets
\item Zan, the oldest pack member, who hums quietly while they organize the books
\end{itemize}

\subsubsection{Roleplaying the Jackalweres}
...
\subparagraph{Personality Trait}
...
\begin{itemize}
\item Once Amberdune Books is packed up for the day, and all the jackalweres have returned to the hideout, the whole pack shares a meal together in area A1.
\item The jackalweres spend their evenings as they wish, before going to sleep in area A3. Korvala sleeps in area A4.
\item They all sleep for eight hours. Korvala and the two jackalweres on first shift wake up just before dawn so they can set up the stall.
\end{itemize}
...
The Amberdune Pack cooks meals in this kitchen before eating in the common room (area A1). There are currently two Jackalwere in the room, Marliza and Theryn (see "Amberdune Pack" earlier in the adventure for more information on the pack members). Theryn, in his humanoid form, chops vegetables for a soup with a cleaver (which functions as a scimitar), while Marliza leans against a wall in hybrid form. They are happily chatting together. Noise in area A1 prompts Marliza to investigate.

\subsubsection{A3. Corridor Dormitory}
\begin{DndReadAloud}{}
...
\subsubsection{A4. Korvala's Office}
\begin{DndReadAloud}{}
...
The decorative swords on the wall are actually two Gingwatzim (see the stat block) that assume their true forms and attack intruders unless Korvala is present. If she is attacked in this room, the gingwatzims defend her. In addition to appearing as swords, these gingwatzims can turn into bats.
...
\begin{itemize}
\item Using a ritual taught to her by Nidalia, Korvala can create creatures known as gingwatzims. (Korvala claims to be under the effect of a geas spell cast by Nidalia that prevents her from sharing this knowledge. This is a lie. Regardless, Korvala will not divulge the ritual.)
\item Korvala can empower a newly formed gingwatzim to assume two other forms, allowing it to duplicate a specific object and a tiny beast. As an object, a gingwatzim can hide in plain sight. As a common beast, it can move about without attracting too much attention.
\item A gingwatzim isn't particularly bright, but it obeys the orders of its creator. The ones Korvala creates are instructed to remain in book form, but a gingwatzim must occasionally feed on the energy of the living to survive.
\item Korvala has created eight gingwatzims so far, six disguised as books and two more to guard her office.
\item Korvala never intended her gingwatzims to show up in Candlekeep. As reparations, she's willing to surrender the original versions of Mazfroth's Mighty Digressions, The Dark Hunger, and Fallen Tethyamar so that the characters can deliver them to Candlekeep. (Korvala keeps these books along with three others in area A6.) 
\end{itemize}

\subparagraph{Trapdoor}
A trapdoor leading down into the hidden vault (area A6) is concealed beneath the bed.

\subsubsection{A5. Storage Room}
\begin{DndReadAloud}{}
...
\subparagraph{False Storage Trunk}
...
\subparagraph{True Storage Trunk}
...
\subsection{Resolving the Mystery}
...
\begin{itemize}
\item There are keys on Korvala's person. This means that there must be locks somewhere.
\item The hideout is square. If there are any secret nooks between the walls, they would be very shallow. It is unlikely anything would be kept there.
\item Two gingwatzims defend Korvala's office. Were they guarding something else as well?
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Nidalia}
...
\begin{itemize}
\item The Vistani and other planar travelers
\item Possible routes into and out of the Shadowfell
\end{itemize}
...
\subsection{Tale of Vistani Kindness}
...
\begin{itemize}
\item The Vistani are planar travelers often encountered in the Shadowfell, and they seem to be immune to the despair that besets all other visitors to that plane. They travel in horse-drawn, barrel-shaped wagons and have no permanent home.
\item The Vistani display their wealth openly as a sign of prosperity, sharing their good fortune with friends and strangers alike. Vistani resolve disagreements through contests that end with reconciliatory singing, dancing, and storytelling.
\item Vistani families can be big or small, but each family is a gerontocracy, with the oldest member ruling the roost. This elder has most of the responsibility for enforcing traditions, settling disputes, setting the course for the group's travels, and preserving the Vistani way of life.
\item The Vistani have the power—some say gift—to travel through the mists that lead to forlorn realms within the Shadowfell known as the Domains of Dread, where creatures born in darkness dwell. This "gift" was thrust upon them by mysterious entities called the Dark Powers, as a boon for their kindness toward strangers.
\item The Vistani believe that ravens carry lost souls within them. Hence, killing a raven is considered bad luck in Vistani culture.
\end{itemize}

\section{Map of Mystery}
...
As the characters will discover, these birds are actually Wereraven (see the end of the adventure for their stat block). Wereravens live and travel in groups called kindnesses, and this particular kindness is called the Scarlet Sash.
...
\subsubsection{Madrina Natterask}
...
\subsubsection{Taspar Hatchhill}
...
\subsubsection{Roleplaying the Wereravens}
...
\begin{DndTable}[header=Wereraven Mimicry]{cX}
...
\subsubsection{Joining the Scarlet Sash}
...
\begin{itemize}
\item The character must be a wereraven.
\item The character needs endorsements from at least three members of the kindness.
\end{itemize}
...
\subsection{Cellar (C1-C3)}
\subsubsection{C1. Storage Cellar}
...
\subsubsection{C2. Servants' Quarters}
...
\subsection{Ground Floor (C4-C9)}
\subsubsection{C4. Cloakroom}
...
\subparagraph{Using the Shadow Crossing}
...
\subsection{Second Floor (C10-C14)}
\subsubsection{C10. Guest Room}
...
\begin{itemize}
\item Baron Brantifax was an avid hunter and often invited guests to the chalet to hunt with him. The baroness admired his generous nature and his vigor.
\item The baron loved his trusty mastiff, Brorn, as much as he did his wife and children. The baroness disliked it when the baron fed the hound scraps from the dining table.
\item The baroness felt too isolated at the chalet. She much preferred the trappings of civilization and city life.
...
\item Heluthe, the younger daughter of the baron and baroness, was a tomboy—more like her father than her mother. Heluthe was slain on her ninth birthday, killed by a wolf while out hunting with her father. The baroness doesn't blame her husband for Heluthe's death, but neither does she absolve him of his guilt.
\item Both daughters were buried in the chalet's graveyard, at the baron's insistence. In her final journal entry, the baroness speaks of "evil whispers" in the graveyard and makes plans to leave Chalet Brantifax, vowing never to return.
\end{itemize}

\subsubsection{C13. Master Bedroom}
\begin{DndReadAloud}{}
...
\subsubsection{C14. Baron's Loft}
...
\subparagraph{Scarlet Sash Conference}
...
\begin{DndSidebar}[float=!b]{Orcus Figurine}
...
\subsection{Third Floor (C15-C17)}
\subsubsection{C15. Attic Nursery}
\begin{DndReadAloud}{}
...
\subsubsection{C16. Servants' Attic}
...
\subsubsection{C17. Storage Attic}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item Two Gargoyle roost atop a stone mausoleum located 30 feet north of the shadow crossing. The gargoyles have an unobstructed view of the entire necropolis and keep a close eye on the shadow crossing.
\item If the gargoyles are destroyed or if the characters move more than 30 feet from the shadow crossing, twelve Ghoul hiding in open graves converge on the characters in four groups of three, each group approaching from a different cardinal direction. They hunger for flesh.
\item A wight named Drovath Harrn inhabits the mausoleum atop which the gargoyles perch. Drovath emerges from his crypt to join the ghouls in battle. On his right hand, Drovath wears a ring of jumping that he uses to leap onto the rooftops of the mausoleums, from where he can pick off enemies with his longbow.
\end{itemize}
...
\subsection{Back to the Material Plane}
...
\subparagraph{Wereraven Lycanthropy}
...
\begin{itemize}
\item Local history, legends, and lore
\item The mining industry
\item Unexplained disappearances of individuals and entire settlements
\end{itemize}
...
\subsection{Tale of Tragedy and Terror}
...
\subsubsection{Truth Behind the Tale}
...
\begin{DndSidebar}[float=!b]{A Stake in the Mine}
...
\subsection{The Road to Vermeillon}
...
\subsection{Lurking Danger}
A nest of meenlocks lives in the mine outside the village. Though most of the creatures returned to the Feywild once the village was empty, six Meenlock (see the end of the adventure for their stat block) remained to prey on lost travelers. When the characters arrive in the village, these meenlocks become aware of their presence and stalk them from a distance, staying hidden in the shadows.
...
\begin{itemize}
\item Characters see movement out of the corner of their eyes, but when they turn to look, nothing is there.
\item A voice whispers indistinct words in their ears.
\item A terrified shriek splits the air.
\item Shadows follow the characters, stretching out abnormally across the floor to reach for them.
\item Characters who view themselves in a reflection momentarily see the face of a lost loved one or a hated enemy instead of their own.
\item The hair on their arms and neck stands up, and the space between their shoulder blades itches. They can't shake the feeling of being watched.
\end{itemize}

\begin{DndSidebar}[float=!b]{Running the Meenlocks}
...
\subsubsection{V1. The Wand and Hammer}
...
\subsubsection{V2. Stonemason's Workshop}
...
\begin{DndSidebar}[float=!b]{Adalyn Creen}
May you alw
...
\subsubsection{V3. Mayor's House}
\begin{DndReadAloud}{}
...
\begin{DndSidebar}[float=!b]{Lorna Grosvenor}
...
\subsubsection{V6. Merchant's Cart}
\begin{DndReadAloud}{}
...
\begin{DndSidebar}[float=!b]{Tragic Transformation}
...
\subsection{Mayor Duvezin's House}
...
\subsubsection{H2. Assembly Room}
\begin{DndReadAloud}{}
...
\subsubsection{H6. Upstairs Landing}
\begin{DndReadAloud}{}
...
\subsubsection{H7. Daughter's Bedroom}
\begin{DndReadAloud}{}
...
\subsubsection{H8. Master Bedroom}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item Meenlocks are corrupted fey creatures that spontaneously manifest in response to fear in places where the border with the Feywild is thin.
\item Meenlocks create more of their kind by transforming humanoids through a process of psychic torment that takes hours or days.
\item Meenlocks live in subterranean nests.
\item Meenlocks are sensitive to bright light and can sense shadows and darkness.
\end{itemize}
...
\subsubsection{H10. Guest Bedroom}
\begin{DndReadAloud}{}
...
\subsubsection{H11. Son's Bedroom}
\begin{DndReadAloud}{}
...
\subsubsection{M2. Southern Wing}
\begin{DndReadAloud}{}
...
\subsubsection{M3. Northern Wing}
\begin{DndReadAloud}{}
...
\subsubsection{M5. Entrance to the Meenlock Lair}
\begin{DndReadAloud}{}
...
\subsubsection{M6. Chamber of Weeping}
\begin{DndReadAloud}{}
...
\subsubsection{M9. Transformation Chamber}
\begin{DndReadAloud}{}
...
\begin{DndSidebar}[float=!b]{Passage into the Feywild}
...
\subparagraph{Telepathic Tormentors}
...
\begin{DndSidebar}[float=!b]{Telepathic Torment}
...
\section{Player Handout: Shemshime's Rhyme}
\begin{DndSidebar}[float=!b]{See a Mother Scything Wheat Forgotten Husband Sleeping near with One Swing She Took His Feet with Another Took His Ear}
...
\begin{itemize}
\item A mother chops off the feet and ear of her husband with a scythe.
\item The family dog bites off the mother's hand.
\item The son drowns in a river while washing clothes.
\item The final scene—which doesn't play out until the music box is repaired—shows the daughter defeating the shadow by crushing it under a millstone.
\end{itemize}
...
\subsubsection{A Kenku's Curiosity}
...
\begin{DndReadAloud}{See a Daughter Grinding Grain}
...
\subsubsection{Resisting the Rhyme}
...
\begin{itemize}
\item Varnyr speaks Common and Elvish, and she has darkvision out to a range of 60 feet. She has advantage on saving throws against being charmed, and magic can't put her to sleep.
\item Instead of a rapier, Varnyr wields a cane and can use an action to make two melee weapon attacks with it: +3 to hit, reach 5 ft., one target. Hit: 2 (1d4) bludgeoning damage.
\end{itemize}
...
\begin{itemize}
\item K'Tulah speaks Common and Druidic, and she has darkvision out to a range of 60 feet.
\item When K'Tulah moves on her turn in combat, she can double her speed until the end of the turn. Once she uses this ability, she can't use it again until she moves 0 feet on one of her turns.
\item As an action, K'Tulah can make a melee weapon attack with her claws: +2 to hit, reach 5 ft., one target. Hit: 2 (1d4) slashing damage.
\end{itemize}
...
\subsection{Event 1: Quarantined}
\begin{DndReadAloud}{}
...
\begin{DndTable}[header=Shemshime's Influence]{cX}
...
\subsection{Event 2: Ebder's Outburst}
...
\subsubsection{Haunting Occurrences}
...
\subsection{Event 3: Singing Skull}
...
\subsection{Event 4: Escape Attempt}
...
\subsubsection{Repairing the Music Box}
...
\subsubsection{Destroying the Book}
...
\subsubsection{Defeating Shemshime}
...
\begin{itemize}
\item If the book is intact, Shemshime is yanked back into the book. It slams shut, silencing the music box and ending the curse.
\item If the book has been destroyed, Shemshime is pulled into the nearest closed book, ending the curse. That book transforms into a copy of Shemshime's Bedtime Rhyme, destroying the book's original content in the process.
\end{itemize}
...
\subparagraph{Reward}
The Avowed give the characters a bag of holding as a reward for defeating Shemshime.

\begin{DndSidebar}[float=!b]{Troubleshooting}
...
\subsection{Encounter Locations F1-F7}
...
\subsubsection{F1. The Stacks, Balcony}
\begin{DndReadAloud}{}
...
\subparagraph{Flying Book Sculpture}
...
\subparagraph{Writing on the Wall}
...
\subparagraph{Writing on the Floor}
A successful DC 12 Wisdom (Perception) check reveals words scratched into the floorboards. In manic script, the words read, "FINISH THE RHYME."

\subparagraph{Secret Compartment}
...
\subsubsection{F6. The Worm Tunnel}
...
\subsection{Encounter Locations F8-F14}
\subsubsection{F8. Avowed Quarters}
\begin{DndReadAloud}{}
...
\subsubsection{F9. Gailby's Room}
The door to this room is open.
...
\subsubsection{F10. Ebder's Room}
\begin{DndReadAloud}{}
...
\subsubsection{F11. Crinkle's Room}
...
\subsubsection{F12. Avowed Quarters}
\begin{DndReadAloud}{}
...
\subsubsection{F13. K'Tulah's Room}
\begin{DndReadAloud}{}
...
\subsubsection{F14. Varnyr's Room}
\begin{DndReadAloud}{}
...
\chapter{The Price of Beauty}

\begin{itemize}
\item An Adventure for 5th-level Characters
\item Developed \& Edited by Scott Fitzgerald Gray
\item Written by Mark Hulmes
\end{itemize}

\DndDropCapLine{I}{}n this adventure, the characters learn the secret of the unique magic bound into a book of tips for channeling self-love and inner beauty, and they break up the sinister plots of a coven of hags.
...
\begin{itemize}
\item Falthrax is a dear friend who has been troubled of late by depression; he talked of feeling as though his life is passing him by.
\item The dwarf's mood had improved in the last tenday after he discovered a book in the Candlekeep stacks—The Price of Beauty. Already a worshiper of Sune, god of beauty, Falthrax talked of how the book spoke to him, and how its advice on meditation and self-worth was helping him.
\item The last time Lorris saw Falthrax, the dwarf was in a sad mood and said that he was going to spend time with the book. Falthrax didn't return to his quarters that night and hasn't been seen since. He was noticed entering the stacks where The Price of Beauty is kept, but no one saw him leave.
\end{itemize}
...
\section{Temple of the Restful Lily}
...
\subsubsection{Auntie Greenbones}
...
\begin{DndSidebar}[float=!b]{Coven Spells}
...
\begin{itemize}
\item Saeth, a cambion, was recruited by Dread Morgan in exchange for a gift of unusual components and secret rituals that he intends to put toward his own evil and ambitious plans one day. Saeth specifically wants to learn the secrets of the cursed paintings, and he is happy to betray his employers to obtain them. He carries a master key that opens all the locks in the bathhouse and the tower except the door to the tower studio (area T15). He also carries the coven's hag eye, which is disguised as a cat's-eye pin on his jacket. For more information on the hag eye, see the "Hags" section in the Monster Manual.
\item Morty, a hell hound, belongs to Auntie Greenbones and is her loyal pet. The fiend never leaves her side and fights to the death to defend her. Vile Sazha hates Morty almost as much as she hates dwarves, and would love to see him dead.
\item Six Scarecrow were created by the hags to replace the acolytes of Sune who ran the bathhouse with Sylvarie, and whom the hags murdered when they took over. The scarecrows are disguised as attractive humanoids. They don't speak in their roles as bathhouse staff, but they nod and smile if spoken to.
\item Two Gargoyle act as the guardians for the coven's lair in the tower beyond the bathhouse, disguised as statues of other kinds.
\end{itemize}

\subsubsection{Roleplaying the Hags}
...
\subsection{Dark Bargains and Cursed Paintings}
...
\subsubsection{Magic Treatments}
...
\item[Ability Enhancement]
If engaging in a bargain to enhance physical or mental acuity, the character chooses one ability. The score for that ability increases by 2, as does the character's maximum for that score.
\item[Physical Transformation]
A character bargaining with the hags can choose to change their race, sex, or appearance in any way they desire. The character retains their ability scores and class features, but changes their racial traits if applicable.
\item[Youth]
A character who bargains for youth has their age reduced to one year older than the standard for adulthood (as noted in the traits for the character's race).
\end{description}
...
\subsubsection{Destroying the Paintings}
...
\subsection{Guests of the Temple}
...
\begin{DndTable}[header=Temple Guests]{cX}
...
\subsection{Arriving at the Temple}
...
\begin{DndSidebar}[float=!b]{Relaxing at the Restful Lily}
...
\begin{itemize}
\item Entry to the bathhouse costs 5 gp per person and includes the use of the enchanted baths, a comfortable robe, and a private changing room with a lockable trunk to store weapons and equipment.
\item Lodging for visitors who want to stay overnight at the temple is available at a cost of 4 gp per person. Meals cost 5 sp, and the lounge offers a wide range of beverages.
\item Characters can enjoy a haircut, a shave, or a waxing for 2 gp, 1 gp, or 10 gp, respectively.
\item Massages can be booked for 20 gp and last for an hour.
\item A manicure and pedicure costs 2 sp. The pedicure might incur an additional fee depending on the cleanliness of the customer's feet.
\end{itemize}
...
The bathhouse and the tower are luxuriously appointed, with walls and floors of polished stone. The stonework in the abandoned shrine is crumbling and caked with grime.
\item[Doors]
Inside the bathhouse and the tower, wooden doors are carved with images of water lilies. Doors in the bathhouse are normally unlocked, but they can be locked by anyone who has a master key. Doors in the tower are normally locked. Unless otherwise noted, a locked door can be opened with a successful DC 15 Dexterity check using thieves' tools, broken in with a successful DC 15 Strength (Athletics) check, or attacked. A door has AC 15, 18 hit points, and immunity to poison and psychic damage.
\item[Windows]
Within the bathhouse and the tower, finely made windows display abstract designs in stained glass. A window can be broken through with a successful DC 12 Strength (Athletics) check or attacked; each one has AC 13, 3 hit points, and immunity to poison and psychic damage.
\item[Light]
All areas of the bathhouse and the tower are filled with bright light during the day and evening, either from sunlight or lanterns. After midnight, these areas are dark unless characters are using a light source. The ground floor of the shrine (area T11) is unlit, while its basement is lit by a magic pool (see area T12 for details).
\end{description}

\subsection{Temple Locations T1-T9}
...
\subsubsection{T2. Changing Rooms}
\begin{DndReadAloud}{}
...
The lounge is watched over by two members of the staff, who serve drinks to the guests and perform other mundane tasks asked of them. Both are disguised Scarecrow (see "Coven Minions" earlier in the adventure). The music is a permanent auditory illusion.
...
\subparagraph{Azirssa's Workouts}
...
\subsubsection{T5. Bath and Hot Spring}
\begin{DndReadAloud}{}
...
\subsubsection{T7. Treatment Rooms}
\begin{DndReadAloud}{}
...
Ilmar has seen through the illusions covering the hags and their minions, and he shares that knowledge if he trusts the characters. He suspects that information about Sylvarie's fate can be found in the shrine or the tower, but has so far been unable to investigate those areas because the coven's minions keep a close eye on him. (The two disguised Scarecrow from area T9 lurk around the guest rooms at night, and the gargoyle above the tower entrance of area T13 watches the grounds north of the bathhouse for any sign of Ilmar skulking around.)
...
During the day, two disguised Scarecrow (see "Coven Minions" earlier in the adventure) clean any unoccupied rooms. If the characters are staying here, the hags might instruct the scarecrows to "misplace" (steal) any potions, weapons, or other valuable items left in the characters' rooms.

\subparagraph{Working Late}
...
\subsection{Temple Locations T10-T18}
\subsubsection{T10. Ilmar's Room}
\begin{DndReadAloud}{}
...
\subsubsection{T11. Abandoned Shrine}
...
\subparagraph{Inside the Shrine}
...
\subsubsection{T14. Saeth's Room}
...
\subsubsection{T15. Tower Studio}
...
\subparagraph{Tools and Supplies}
...
\subsubsection{T16. Tower Kitchen}
\begin{DndReadAloud}{}
...
\subsubsection{T17. Victims' Quarters}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item A brawny, female, golden-scaled dragonborn warrior engaged in battle (Gorba Daardenrian)
\item A tall male tiefling with sparkling violet eyes wearing many fine jewels (Glitter)
\item A youthful male shield dwarf dancing at a feast (Falthrax Loderr)
\item A radiant female moon elf gazing upon her own reflection (Sylvarie)
\end{itemize}
...
\subsection{Sylvarie's Decision}
...
\begin{itemize}
\item Before communications with the grippli tapered off, people who returned to Candlekeep from a trip to the grippli trading post reported that a small band of yuan-ti had taken up residence at an old temple site where the grippli village used to be located. These serpentfolk, unlike others of their kind, are friendly toward the grippli, and the frogfolk are helping them excavate the location.
\item One of the last people from Candlekeep to depart from the grippli trading post reports that the place has been overrun by frogfolk fleeing their village, which was invaded by a second group of yuan-ti. These monsters are vicious and cruel, the exact opposite of the earlier visitors.
\end{itemize}

\section{Northward Ho!}
...
\subsubsection{Pond Mother Speaks}
...
\subsubsection{Running the Crab Maze}
...
As the characters move, they must make a successful DC 20 Dexterity (Stealth) group check every 100 feet to avoid attracting giant crabs. If any group check fails, 1d4 + 2 Giant Crab claw their way out of their cages and attack the characters.
...
\subsubsection{Passing the Breakwater}
...
The dozen or so Grippli Warrior (see the end of the adventure for their stat block) remaining in the village are there only to do the yuan-ti's bidding; they all show signs of abuse from their treatment. Some are in a state of mourning, after being forced to watch the yuan-ti consume their eggs.
...
\subsubsection{Pond Mother's Home}
...
\subsubsection{Homes and Storage}
\begin{DndReadAloud}{}
...
\subsection{Old Village and Temple}
...
\subsubsection{Serpent Scale Armor}
Armor (scale mail), uncommon

This suit of magic armor is made from shimmering scales. While wearing it, you can apply your full Dexterity modifier (instead of a maximum of +2) when determining your Armor Class. In addition, this armor does not impose disadvantage on your Dexterity (Stealth) checks.

\subsubsection{Serpent's Fang}
...
\chapter{Sarah of Yellowcrest Manor}

\begin{itemize}
\item An Adventure for 7th-level Characters
\item Developed \& Edited by Scott Fitzgerald Gray
\item Written by Derek Ruiz
\end{itemize}

\DndDropCapLine{I}{}n this adventure, the characters are caught up in an unsolved mass killing in the city of Waterdeep—after the ghost of one of the victims seeks them out.
...
\subsubsection{A Glimpse of Darkness}
...
\begin{itemize}
\item Yellowcrest Manor stands on Delzorin Street in Waterdeep's North Ward.
\item Lord Viallis and Lady Maria had two sons, Malik and Janus, and one daughter, Tianna.
\item The family owned several tanneries and shoemaking shops in Waterdeep, but most of its wealth was inherited on Maria's side.
\item Lord Viallis's closest business associate was an elf named Faerl, who visited Lord Viallis twice a tenday.
\item Sarah had a romantic relationship with a young squire named Vecken, who lived close to the manor on Immar Street.
\end{itemize}
...
\begin{itemize}
\item Lord Yellowcrest was away from Waterdeep on business, then returned to find his wife, his sons and daughter, and the manor's four servants brutally murdered. Shocked into a deep depression by the tragedy, Lord Yellowcrest left Waterdeep to be alone with his grief.
\item Rumors seemingly spread by members of the City Guard after investigating the murders hinted at some sort of cult activity, but details of the killings were never revealed. No suspects were ever identified or charged.
\item The Yellowcrest family had a good reputation, with no hint of personal or public impropriety. No one ever accused the grieving Lord Yellowcrest of having any connection to the murders.
\end{itemize}

\section{Grieving Ghost}
...
\begin{itemize}
\item Lord Viallis Yellowcrest was responsible for the murders of his wife, his children, Sarah, and three other servants, all of whom were killed as part of a dark ritual. (The trauma Sarah suffered has occluded her memories of the details of the ritual and of her own death.)
\item The book that Sarah observed Viallis reading was the source of the ritual, and a work of evil.
\item The souls of Lady Maria, Malik, Janus, and Tianna have not moved on since their deaths. All four are trapped in the mortal realm until their physical remains can be buried in hallowed ground.
\item The remains of those victims are missing. Sarah doesn't know what happened to them, but she is certain that Lord Viallis has something to do with it.
\end{itemize}
...
\subsection{Lord Viallis's Tome}
...
\begin{itemize}
\item The manor was previously owned by the Yellowcrest family, most of whom were killed one night.
\item Though full details of the event were never made public, rumor holds that Lady Maria, her three children, and four servants were all stabbed to death, then had their tongues removed.
\item The sole survivor of the family was Lord Viallis, who was allegedly away from the city that day.
\item After the murders, Viallis sold the manor and all his family's possessions, then moved to a small village in the countryside.
\item A few tanneries, leatherworkers' shops, and cobblers' shops in the Trades Ward reportedly still belong to Lord Viallis, but if he has ever returned to Waterdeep, Arnulf doesn't know about it.
\end{itemize}

\subsection{Yellowcrest Businesses}
...
\begin{itemize}
\item He speaks Common and Elvish.
\item He has advantage on saving throws against being charmed, and magic can't put him to sleep.
\end{itemize}
...
\subsubsection{Speaking of the Past}
...
\begin{itemize}
\item Faerl met Lord Viallis in Waterdeep years ago and became his business partner. Faerl lives in the village of Greenfast southeast of Waterdeep, where Lord Viallis also lives now.
\item The profits from the Yellowcrest businesses generate a tidy sum that funds Viallis's retirement.
\item The bodyguards were to accompany Faerl back to Greenfast that evening with the latest profits from the Yellowcrest businesses, then make their way back to Waterdeep after being paid.
\end{itemize}
...
\subsection{Sir Vecken of the Broken Horn}
...
\begin{itemize}
\item After the murders, the remains of Sarah and the other three servants were interred in the public cemetery, Waterdeep's City of the Dead. The remains of Lady Maria and her children were not.
\item Vecken remembers talk of Lord Viallis wanting his wife and children to be interred near his new home, so that he need never return to Waterdeep to visit them.
\end{itemize}
...
\subsubsection{Vecken's Retribution}
...
\subsection{Greenfast Locations}
The following locations are keyed to the map of Greenfast.

\subsubsection{G1. Mayor's House}
...
\subsubsection{G2. The Bulging Cauldron}
...
\subparagraph{Old Fargo's Suspicions}
...
\subsubsection{G3. Lord Viallis's House}
...
\subsubsection{G4. Faerl's House}
...
\begin{itemize}
\item Lord Viallis is the leader of what he calls the Burnt Tongue Cult, and he has made Greenfast the center of the cult's activities.
\item Viallis worships a dark entity called Gaernoo, whose power he channels by sacrificing prisoners. This otherworldly patron provides Lord Viallis with aberrant creatures to command.
\item Lord Viallis took over an old ruin outside the village, wanting to turn it into an estate. The work at the site is a ruse for opening up and rebuilding a series of subterranean chambers, which now constitute the cult's temple. With the temple completed, Lord Viallis has ordered the cult's activities to be stepped up.
\end{itemize}
...
\section{Temple of the Burnt Tongue Cult}
...
\subparagraph{West Door}
The door into area B2 is locked. Lord Viallis carries the key. As an action, a character can try to pick the lock using thieves' tools, doing so with a successful DC 14 Dexterity check, or force open the door with a successful DC 17 Strength (Athletics) check.

\subparagraph{South Doors}
This double door is unlocked.

\subsubsection{B2. Arcane Study}
\begin{DndReadAloud}{}
...
\subsubsection{B3. Dungeon Access}
\begin{DndReadAloud}{}
...
\subsubsection{B5. Symbol Workshop}
\begin{DndReadAloud}{}
...
\subsubsection{B7. Dark Chapel}
If Lord Viallis has been alerted to the characters' presence, three Cult Fanatic are at the bottom of the north stairs watching for anyone approaching from area B4. These cultists hide along the walls as the characters descend the stairs, attacking as soon as they enter the chapel.
...
If the characters reached this area without making an undue amount of noise (and if the guard in area B3 did not come here to warn of the characters' intrusion), three Cult Fanatic lurk behind the statue—the same three who watch the north stairs if Lord Viallis is expecting trouble. They join the fray.
...
\begin{DndSidebar}[float=!b]{Lord Viallis}
...
\subparagraph{Personality Trait}
"I am superior. Those lesser than I do not deserve my attention."



\subparagraph{Ideal}
"Gaernoo gifts us with insight. The knowledge from beyond the veil will open our eyes."



\subparagraph{Bond}
"My soul belongs to Gaernoo."



\subparagraph{Flaw}
"I must think about things, then think again. Decisions cannot be made quickly."
...
\subparagraph{Treasure}
In addition to his robe of scintillating colors and spell scroll of teleport, Lord Viallis carries the keys to area B2 and the cells in area B11. A number of objects are arranged around the altar as offerings, including five gold bracelets (worth 150 gp each) amid various worthless trinkets.
...
\subparagraph{Treasure}
Both chests are unlocked, and they hold valuables the prisoners in area B11 had on them when they were taken: a longsword, two Dagger, a pair of jeweled earrings worth 150 gp, and 115 gp. If the characters are captured by the cultists and moved to either cell, their belongings end up here as well.

\subsubsection{B9. Secret Library}
\begin{DndReadAloud}{}
...
\subsection{Lower Level B10-B13}
\subsubsection{B10. Ossuary}
\begin{DndReadAloud}{}
...
\subsubsection{B13. Sacrificial Remains}
...
\subsection{Aftermath in Greenfast}
...
\subsection{Fate of Lord Viallis}
...
\subsection{Retribution of the Ancients}
...
\begin{itemize}
\item Assisting one of the Great Readers of Candlekeep by helping them sort a pile of books that need to be reshelved
\item Talking to a scholar about books that describe ancient conflicts between deities
\item Examining the History of Faerûn section of the library
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Lurue's Origins}
...
\subsection{The Book's Demiplane}
...
\begin{itemize}
\item Often over the past tenday, several cracks of thunder have sounded, even when there appears to be no storm brewing. At night, in places where the canopy of trees thins to provide a clear enough view, occasional bolts of red lightning can be seen in the distance.
\item Strange tribesfolk, foreign to the area, have been wandering the forest, killing any animal they see on sight.
\item There's a community of pixies and sprites near the Polvarth Plateau called Dewlight. Tragor is friends with a jovial sprite there, Wheeldoli, who might know more about recent happenings.
\end{itemize}
...
\begin{DndTable}[header=Demiplane Encounters]{cX}
...
\subsubsection{H3. Hag's Menagerie}
...
\subsubsection{Cult of Malar Campsite}
...
\subsection{The Corrupted Avatar}
...
\chapter{Kandlekeep Dekonstruktion}

\begin{itemize}
\item An Adventure for 9th-level Characters
\item Edited by Scott Fitzgerald Gray
\item Developed by Christopher Perkins
\item Written by Amy Vorpahl
\end{itemize}

\DndDropCapLine{I}{}n this adventure, the characters fight against a ticking clock to stop a misguided cult from launching one of Candlekeep's towers into space, along with a small trove of valuable tomes. One of the cultists has a change of heart and tries to thwart the whole enterprise by stealing one of the books, hoping to delay the launch. This book ends up in the characters' possession after the cultist dies while carrying it.
...
\subsubsection{Secrets of the Barn Door}
...
\subsubsection{Barn Door Inquiries}
If the characters ask about the Barn Door, any friendly member of the Avowed can share what little information they know:


\begin{itemize}
\item The Barn Door is one of many towers in Candlekeep's Inner Ward. Like everything else in the Inner Ward, it's off limits to most visitors.
\item The tower has been condemned for years, though the reason has become obscure. No effort has been made to tear it down or repair it.
\item There have been a few recent reports of strange noises coming from the tower, but nothing to warrant great concern.
\end{itemize}

\subsubsection{Speaking with the Dead}
...
\begin{itemize}
\item Buron, a custodial engineer, was a member of a secret Candlekeep cult called the Livestock. In the cult, the dwarf was known as Rooster Muffin.
\item The leader of the Livestock is a gnome visionary and Avowed zealot named Stonky J. Noptopper. He aims to keep Candlekeep's most valuable tomes from falling into the hands of the unworthy (anyone who is not an Avowed).
\item After reading Kandlekeep Dekonstruktion, Stonky realized that one of Candlekeep's towers—the Barn Door—is actually a flying vehicle powered by arcane devices called rockets.
\item With the help of several constructs, Stonky has spent months secretly repairing the Barn Door with the goal of launching it into space. The gnome plans to take a choice selection of the library's books with him.
\item Once he realized that Stonky was insane, Buron stole Kandlekeep Dekonstruktion, hoping to delay the launch of the tower long enough for someone to thwart Stonky's mad scheme.
\end{itemize}
...
\subsection{Investigating the Quake}
...
\subsubsection{Heading to the Barn Door}
...
\begin{DndTable}[header=Livestock Cult Members]{XcX}
...
\subsection{Barn Door Features}
The tower has the following features.


\begin{description}[nolistsep]
\item[Ceilings]
Ceilings throughout are 10 feet high and have murals painted on them depicting humanoids with the heads of farm animals.
\item[Cleanliness]
The interior is cleaned daily by the cultists and is free of dirt, dust, and cobwebs.
\item[Doors and Windows]
Doors are made of iron and fitted with iron fittings and handles. The tower's windows, which are made of a transparent metal called glassteel, can't be opened or smashed by any mundane means.
\end{description}

\subparagraph{Light}
All areas of the tower are lit by lanterns holding wax candles.

\subsection{Barn Door Locations}
The following locations are keyed to the map of the Barn Door.

\subsubsection{B1. Library}
...
\subparagraph{Credenza and Chair}
...
\begin{itemize}
\item Stonky is planning to launch the Barn Door and all its books into space. The countdown has begun. (The cultists don't know precisely when the launch is set to occur.)
\item Stonky and three senior members of the Livestock (Pig Wheat, Ram Sugar, and Sheep Sweet Corn) are in the underlevel, making final preparations before launch.
\item A secret door hidden in a library bookcase (see area B1) conceals the only route to the tower's underlevel.
\item The Barn Door will be launched into space by arcane devices called rockets, which are attached to the bottom of the tower.
\end{itemize}

\subsubsection{B3. Stonky's Study}
...
\begin{description}[nolistsep]
\item[Coop]
The launch is aborted when the countdown timer reaches zero. The engines under the tower shut down and remain inoperable for 24 hours.
\item[Shed]
The countdown is paused and the Barn Door's launch is delayed for as long as the lever remains in this position.
\item[Stable]
The Barn Door blasts off when the countdown timer reaches zero.
\end{description}

\subparagraph{Steering Wheel}
...
\subsection{Underlevel Features}
...
\item[Debris]
The floor in all areas was once littered with scraps of metal, most of which have been swept out of the way and piled near the walls.
\item[Doors]
Doors are made of thick iron and fitted with iron fittings and handles.
\item[Light]
The underlevel is lit by oil-burning lanterns that hang from iron hooks embedded in the walls.
\end{description}

\subsection{Underlevel Locations}
The following locations are keyed to the map of the underlevel.

\subsubsection{U1. Descending Staircase}
...
\subsubsection{U2. Rocket Boosters}
...
\subparagraph{Kiddywidget Nests}
The fallen sections of wall collapsed when the Barn Door's rockets were test-fired, exposing cavities behind the walls. Characters who investigate find one kiddywidget (see the end of the adventure for its stat block) in each cavity. These offspring of the skitterwidgets chirp loudly if disturbed by anyone other than their parents.
...
\subsubsection{U3. Unlit Hallway}
\begin{DndReadAloud}{}
...
\subsubsection{U5. Stonky's Missing Ring}
\begin{DndReadAloud}{}
...
The insectoid creatures are three Skitterwidget (see the end of the adventure for their stat block). They are programmed to attack intruders on sight. A character attuned to Stonky's ring (see area U5) can issue commands to these skitterwidgets, which follow those commands to the best of their ability.
...
\begin{DndSidebar}[float=!b]{}
\subparagraph{Breath Weapon (Recharges after a Short or Long Rest)}
Ram Sugar exhales fire in a 30-foot-long line that is 5 feet wide. Any creature in the line must make a DC 11 Dexterity saving throw, taking 7 (2d6) fire damage on a failed save, or half as much damage on a successful one.
...
\begin{DndSidebar}[float=!b]{Stonky Noptopper}
...
\subparagraph{Personality Trait}
"I don't like most people, which is why I relish the thought of spending the rest of my life in the cold darkness of space, surrounded by books and skitterwidgets."



\subparagraph{Ideal}
"Knowledge is power, and most people are undeserving of it. Not me, though. I am knowledge incarnate!"



\subparagraph{Bond}
"Won't someone please think of the books?!"



\subparagraph{Flaw}
"I am burdened with the curse of being right all the time."



\end{DndSidebar}

\subsubsection{U7. Stonky's Command Center}
...
\subsection{Launch Delayed or Aborted}
...
\subsection{Skitterwidget Problem}
...
Stonky's ring allows a character to control his original seven Skitterwidget (the four in area U2 and the three in area U6). No others, including the offspring of the original skitterwidgets, can be controlled using the ring. The Avowed permit skitterwidgets under the characters' control to remain in Candlekeep, but not in the Inner Ward. Stray skitterwidgets are eventually hunted down and destroyed.
...
\subparagraph{Protective Parents}
...
\begin{itemize}
\item Denizens of the Inner Planes, especially the Wind Dukes of Aaqa (powerful beings of elemental air) and djinn
\item Extraplanar travel
\item Magic fortresses
\end{itemize}
...
\section{Gazre-Azam's Predicament}
...
\subsubsection{L3. Tidal Chamber}
...
\subsubsection{L4. Zikran's Quarters}
\begin{DndReadAloud}{}
...
\subsubsection{L5. Laboratory and Lair}
...
\subparagraph{Roleplaying Ashgarlyth}
...
\begin{itemize}
\item They can appeal to his good nature by urging him to help save Gazre-Azam and bring Zikran to justice.
\item They can offer a valuable or beautiful treasure in exchange for being allowed to carefully peruse Zikran's old laboratory.
\item A character familiar with bronze dragons can bring up their famous love of ships and the sea in an attempt to bond with Ashgarlyth.
\end{itemize}
...
\subparagraph{Searching the Laboratory}
...
\begin{itemize}
\item An old diary tells the tale of a paranoid and lonely man. In this diary, Zikran writes about a rival named Laffa, who sought the location of this laboratory. Fear of discovery prompted Zikran to pack up and leave in a hurry. (Gazre-Azam reveals that Laffa was an adventuring wizard. Laffa and his companions were the ones who found Zikran's Zephyrean Tome and used it to gain entry into Candlekeep.)
\item A stray map describes a route to a mountain range farther south, labeled the Cloud Peaks. A particular mountain is circled in ink with the word "Here?" written beside it. (Gazre-Azam can tell the party that the Cloud Peaks were home to a clan of cloud giants centuries ago. The giants occupied a keep near the top of the mountain circled on the map. Perhaps its ruins are still there. The djinni knows Zikran was interested in this possibility.)
\item Diagrams show the structure and inner workings of a magical cannon powered by elemental air. Though its function as a cannon is obvious, only characters who succeed on a DC 25 Intelligence (Arcana) check can understand the images well enough to operate such a cannon if they find one. A character who gets a 20 or higher on this check knows that the device can be operated manually or by a command word, but there's no command word written on the diagrams.
\end{itemize}

\section{The Cloud Peaks}
...
\subsubsection{C2. Entrance Hall}
...
\subsubsection{C6. Second Floor Bedroom}
\begin{DndReadAloud}{}
...
\subsubsection{C7. Zikran's Basement Workshop}
...
\begin{itemize}
\item Zikran speaks Aquan, Common, Primordial, Sahuagin, and Undercommon. He has 144 hit points, resistance to acid damage, a swimming speed of 30 feet, and the ability to breathe air and water.
\item He has prepared the conjure elemental spell in addition to his other spells.
\item While in the basement, he gains a special action option (see "Elemental Cannon" below).
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Who Are the Harpers?}
...
\subsection{Constructed Commoners}
...
\begin{DndTable}[header=Wisteria Vale Events]{cX}
...
\subsection{Unexpected Visitors}
...
\subsection{Locations in Wisteria Vale}
...
\subsubsection{W1. Vyridian Forest}
...
\subsubsection{W3. Blossom's Rest}
...
\subsubsection{W4. Silks and Soles}
...
\begin{DndTable}[header=Manor Encounters]{cX}
...
\subsubsection{Arrant Quill and the Fake Quill}
...
\subsubsection{Renekor the Beholder}
...
\begin{itemize}
\item Quill has been researching beholders, particularly their ability to warp reality and bring to life things from their imagination.
\item Renekor dreamed itself into Wisteria Vale from the Underdark. The beholder believes that the village and its residents are its own creations. The beholder's appearance has caused weird events to happen in Wisteria Vale, and these strange occurrences are becoming increasingly common (see "Aberrant Events" earlier in the adventure).
\item Quill thinks that if he can get close enough to Renekor, he can charm the beholder into revealing information on how to escape Wisteria Vale, or manipulate the beholder's reality-warping magic to create an exit from the demiplane.
\item The last note Quill made was about his fear that Renekor suspects his schemes. The ink is smeared as if he had been interrupted in the middle of writing it.
\end{itemize}

\subsubsection{M8. Master Bedroom}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item Quill used to write frequently during the first few months of his captivity, with the entries becoming more sporadic until the arrival of Renekor.
\item Quill believes that a year has passed in Wisteria Vale, when it really has been three years on the Material Plane. (Quill is unaware of this fact.)
\item Quill knows that he can't be harmed in Wisteria Vale unless he gives his consent.
\item Quill believes that the Harpers were lying when they said they were going to find a way to cure him, and he is worried that the Harpers are just biding their time until they can kill him.
\item Quill notes that the beholder might be his key to escaping Wisteria Vale.
\end{itemize}

\subsubsection{M9. Guest Bedroom}
\begin{DndReadAloud}{}
...
\subsubsection{M10. Guest Bathroom}
...
\begin{DndTable}[header=Forest Painting's Chamber]{cX}
...
\begin{DndTable}[header=Banquet Painting's Chamber]{cX}
...
\begin{DndTable}[header=Quill's Prison Chamber]{cX}
...
\begin{DndTable}[header=Roc Painting's Chamber]{cX}
...
\begin{description}[nolistsep]
\item[Candied Yams]
Any creature that eats from the plate of candied yams is targeted by a faerie fire spell (save DC 15) that affects only it and lasts for 1 hour or until dispelled.
\item[Cheese-Stuffed Peppers]
Any creature with 75 hit points or fewer that eats a whole cheese-stuffed pepper must succeed on a DC 15 Constitution saving throw or instantly drop to 0 hit points and explode, leaving behind a mess plus whatever it was carrying and wearing.
\item[Jerk Frog Legs]
Any creature that eats from the plate of jerk frog legs gains the benefit of a jump spell that lasts for 1 hour or until dispelled.
\item[Salted Cockatrice Eggs]
Any creature that eats a whole salted cockatrice egg gains immunity to the petrified condition for 1 hour.
\item[Stirge Burgers]
Any creature that eats a whole stirge burger gains 10 temporary hit points.
\item[Veggie Kabobs]
Any creature that eats from the plate of veggie kabobs must make a DC 15 Constitution saving throw, taking 22 (4d10) poison damage on a failed save, or half as much damage on a successful one.
\end{description}

\subsubsection{Quill's Prison Chamber}
...
\subparagraph{Escaping Quill's Prison}
...
\subsection{Administering the Cure}
...
\begin{itemize}
\item The nature of ki and its uses in hand-to-hand combat and healing
\item Legends pertaining to immortality
\item Monastic traditions, especially the Way of the Open Hand
\item The crafting of magic weapons
\end{itemize}
...
\subsection{Esoteric Martial Arts}
...
\subsection{Inner Alchemy}
Characters who read from The Book of Inner Alchemy learn the following information about ki:


\begin{itemize}
\item Though commonly thought of by those outside the monastic orders as mystical energy, ki has strong ties to elemental air, for breath is what connects one's soul to one's essence (body).
\item Ki is a vital force present in all living things. Medical techniques and training can be used to control the flow of ki.
\item All living beings are made up of two "lives," physical and spiritual. When these aspects are in harmony, great power can be attained. 
\end{itemize}
...
\subsection{Attack on the Great Library}
...
\subsubsection{Scene of the Crime}
...
\begin{itemize}
\item A character who succeeds on a DC 14 Wisdom (Medicine) check can tell that the Avowed acolytes slain during the attack were killed using martial arts. Their bruises and broken bones are evidence of powerful unarmed strikes.
\item Speak with dead spells cast on the slain acolytes yield descriptions of the two killers: a dark-haired woman in her late thirties or early forties, her face marred by a thin scar, and an attractive silver-haired man in his thirties. Both killers wore simple, fitted black clothing under white, flowing robes.
...
\section{Order of the Immortal Lotus}
...
\subsection{Disposing of Evidence}
...
The white-robed figures are two Immortal Lotus Monk (see their stat block later in the adventure). Their wheelbarrow contains four bodies—the remains of two adult humans (monks) who were killed in training exercises, and the remains of two forest gnomes who were caught stealing from the temple's garden. If the characters do nothing but watch, the monks dump the bodies within 5 feet of the tree trunk. As the bodies tumble out of the wheelbarrow, the puddings seep out of the tree and begin consuming the remains. Each black pudding can devour one gnome corpse in 2 rounds or one human corpse in 4 rounds. The puddings ignore creatures that leave them alone.
...
\subparagraph{Treasure}
The dryads are grateful to the characters for ridding their forest of the black puddings. Each dryad presents the party with a reward: a wooden vial containing a single dose of sweet sap that functions like a Potion of Superior Healing.
...
\section{Temple of the Immortal Lotus}
...
As the characters make their way through the Stele Forest, they encounter one of Bak Mei's most senior students, Steel Crane, and four Immortal Lotus Monk (see the accompanying stat blocks). They are on the lookout for trouble and spoiling for a fight. When the characters approach, read:
...
\subparagraph{Red Key}
Steel Crane carries a red wooden key that unlocks the door to area L3.

\subsection{L2. Living Quarters}
...
\subsection{L3. Hall of Knowledge}
\begin{DndReadAloud}{}
...
\subsubsection{Tormented Captive}
...
\begin{itemize}
\item Kharbek speaks Common and Dwarvish.
\item They have 1 hit point and 5 levels of exhaustion.
\item They have darkvision out to a range of 60 feet, resistance to poison damage, and advantage on saving throws against being poisoned.
\end{itemize}
...
\subsection{L4. Training Grounds}
\begin{DndReadAloud}{}
...
Jade Tigress (see the accompanying stat block) and four Immortal Lotus Monk (see their stat block earlier in the adventure) are training in this area. When the fighting starts, read:
...
\subparagraph{Red Key}
Jade Tigress carries a red wooden key that unlocks the door to area L3.

\subsection{L5. Jagged Sanctum}
\begin{DndReadAloud}{}
...
Bak Mei is joined by four Immortal Lotus Monk (see their stat block earlier in the adventure). To increase the difficulty of this encounter, add more monks who have just come back from foraging. They arrive in the middle of combat.
...
\begin{itemize}
\item What happened to the original masters of the Open Hand?
\item Will the monastic orders in Bak Mei's homeland east of Faerûn want to know his fate?
\item Considering the knowledge contained in The Book of Inner Alchemy, is it safe in Candlekeep? Should it be destroyed—and if so, how?
\item Who else might know the secrets of this book?
\item What should happen to the now-abandoned Temple of the Immortal Lotus? Are there surviving members of the order who will try to avenge Bak Mei's death?
\item The last breaths (souls) of three individuals—one of great intellect, one of strong body, and one of a pure heart—are required to craft gloves of soul catching. How can this be accomplished?
\end{itemize}
...
\subsection{New Magic Item}
The Book of Inner Alchemy contains instructions for crafting Gloves of Soul Catching that grant the wearer the ability to siphon vitality from other creatures. The authors note, however, that this item is theoretical and has never been created.
...
\chapter{The Canopic Being}

\begin{itemize}
\item An Adventure for 13th-level Characters
\item Developed \& Edited by Scott Fitzgerald Gray \& Christopher Perkins
\item Written by Jennifer Kretchmer
\end{itemize}

\DndDropCapLine{I}{}n this adventure, the player characters investigate the disappearance of a Candlekeep sage and disrupt the plans of a mad oracle bent on domination.


The Canopic Beingarrived at Candlekeep nine months ago, wrapped in yellow cloth embroidered with the image of an eye. It was delivered with a handwritten note reading, "As fate wills it," signed by Xemru Thaal, a high priest of Savras, god of divination and fate. As preservers of the teachings of Alaundo the Seer, the Avowed of Candlekeep were keen to study what they expected to be a book exploring the divinatory arts. When its horrific contents were revealed, The Canopic Beingwas relocated to the library's vaults, where it currently resides.
...
\subsubsection{Named by an Oracle}
...
\begin{itemize}
\item Alessia Baseer, Valin Sarnaster's longtime attendant (and the unwitting custodian of Valin's heart)
\item Xemru Thaal, the high priest who sent the book to Candlekeep (now a golem serving Valin)
\item Zeren Zoradius, a human mage (who now serves Valin as a golem)
\item Okuzor, a tiefling gladiator (and another of Valin's golem servants)
\item Mayastan Sadaar, the dragonborn sage
\item Each of the characters, using whatever names they are best known by
\end{itemize}

The sections that follow have more information on Valin Sarnaster's servants.

\section{Player Handout: Xemru's Note}
\begin{DndSidebar}[float=!b]{Author's Note}
...
\subsection{House of the All-Seeing Orb}
...
\subsubsection{Entering the Temple}
...
\begin{itemize}
\item Mayastan arrived yesterday, intending to speak with the oracle Valin Sarnaster. The sage was taken to Valin's sanctum and has not returned.
\item Valin Sarnaster is known to all who serve Savras, and her works have long been an inspiration. She has lived alone for decades now, so that the influence of the outside world will have no effect on her divinatory abilities.
...
\item If the characters ask to see Xemru, Shir says that the high priest went through the portal to visit Valin eight months ago and has not come back. Messages received from him through Valin's attendant, Alessia, say that he continues to study with Valin and plans to remain with her for the foreseeable future. (Xemru accepted the future in which he saw himself becoming Valin's servant. But a sense of misgiving caused him to send The Canopic Being to Candlekeep as evidence of what Valin had become—as Valin had already foreseen.)
\item Valin lives in a secret sanctum, since she would otherwise be sought out by too many people seeking her wisdom and counsel. A portal hidden in the temple complex is the only means of reaching her. The oracle sends her attendant, Alessia, through the portal regularly to convey and receive messages.
\item Three other people have traveled through the portal to seek Valin's guidance within the past three months: Zeren Zoradius, a human mage; Okuzor, a tiefling gladiator; and Mayastan Sadaar, the Candlekeep sage. As with Xemru Thaal, none of the other visitors have yet returned.
\end{itemize}

\subsubsection{The Oracle's Portal}
...
\begin{DndSidebar}[float=!b]{What Is and What's to Come}
...
\begin{DndSidebar}[float=!b]{Valin's Victims}
...
\begin{DndTable}[header=Organ Recipients]{cc}
...
\subparagraph{Power of Disbelief}
...
\subsubsection{T2. Alessia's Quarters}
...
\subparagraph{Personality Trait}
"I serve my masters in faith willingly, and I let fate and faith command me."



\subparagraph{Ideal}
"I yearn to see the best of all possible futures, so that I can help those futures come to pass."



\subparagraph{Bond}
"I faithfully serve Valin Sarnaster, the living embodiment of the divine will and power of Savras."
...
\subsubsection{T3. Mirrors of Fortune}
\begin{DndReadAloud}{}
...
\subsubsection{T4. Testing Chamber}
\begin{DndReadAloud}{}
...
The crystalline figures guarding the pit are two Canopic Golem (see the accompanying stat block) who were once the high priest Xemru Thaal and the mage Zeren Zoradius. Zeren came to Valin hoping to become a master of divination. Instead, she showed him a very different future.
...
\begin{DndTable}[header=Canopic Jars]{cc}
...
\subsubsection{T7. Meditation Room}
\begin{DndReadAloud}{}
...
\subsubsection{T9. Observatory of Fate}
Valin Sarnaster sanctum is a gravity-free chamber whose magic focuses her oracular sight. Having watched the characters progress through her lair, the mummy lord (see the "Valin Sarnaster" sidebar for changes to her statistics and roleplaying notes) is fully prepared to face them for a final showdown—but the characters might find fighting in this strange environment to be a challenge.
...
\begin{DndSidebar}[float=!b]{Valin Sarnaster}
...
\begin{itemize}
\item She has the clairvoyance, dimension door, and scrying spells prepared instead of animate dead, guardian of faith, and insect plague.
\item While her heart remains in Alessia's body, Valin's Rejuvenation trait causes her to re-form inside the sarcophagus in area T6.
\item Valin can use her lair actions in any area of the tomb.
\end{itemize}



\subparagraph{Personality Trait}
"I have seen the future. Therefore, nothing surprises me."



\subparagraph{Ideal}
"To know all things is the goal of the most powerful oracles. And I will be the most powerful oracle of all."



\subparagraph{Bond}
"This temple was made for me. It has come to me. It is part of me."



\subparagraph{Flaw}
"Each future that allows a chance for my failure to occur must be tracked, must be focused on, and must be destroyed."



\end{DndSidebar}

\subparagraph{Fate's Boon}
...
\subsubsection{T10. Treasure Room}
...
\subsubsection{T11. Observatory of History}
\begin{DndReadAloud}{}
...
\subparagraph{Visions of the Past}
...
\chapter{The Scrivener's Tale}

\begin{itemize}
\item An Adventure for 14th-level Characters
\item Edited by Scott Fitzgerald Gray
\item Developed by Christopher Perkins
\item Written by Brandes Stoddard
\end{itemize}

\DndDropCapLine{A}{}n evil archfey is bound within the tome known as The Scrivener's Tale. When the characters run afoul of the book's magic, they must find a way to defeat the archfey before they succumb to her power.
...
\begin{DndTable}[header=Scrivener's Mark Effects]{cX}
...
\begin{itemize}
\item Any character who has proficiency in the Arcana skill and inspects the writing confirms that spells such as dispel magic, greater restoration, and remove curse aren't powerful enough to remove it.
\item With a successful DC 18 Intelligence (Arcana) check, a character determines that the affliction is progressive but double-edged, granting benefits as well as negative effects. (The characters would be correct to assume that the drawbacks outweigh the benefits, but there's no way to know until the benefits and drawbacks are bestowed.)
\end{itemize}

\subsection{Inquiries in Candlekeep}
...
\begin{DndSidebar}[float=!b]{Seeking Higher Knowledge}
...
\subparagraph{The Scrivener's Tale}
Questions asked about the book with commune or divination spells yield only the information given earlier in the adventure. The legend lore spell returns only the following response: "The shackle that is the key, the prison built by a prisoner." That cryptic clue refers to the manner in which the book binds the Princess of the Shadow Glass, even as it allows her to magically mark the book's readers and others near and dear to them.



\subparagraph{Princess of the Shadow Glass}
Commune and divination spells reveal nothing about the Princess of the Shadow Glass, who has magically hidden her history under other names. If the characters learn the names "Nintra Siotta" or "Lady of Dread Omens" later in the adventure and use those names in their inquiries, such magic returns the hoped-for results.
...
\subsection{Voice of the Princess}
...
\subsubsection{Charm of the Shadow Glass}
...
\subsubsection{What Yvandre Knows}
...
\subsubsection{Machil's Remaining Possessions}
...
\begin{itemize}
\item A vellum map labeled "Delimbiyran and Environs" shows a few locations in the aboveground ruins of the city. A note written on the map in Elvish identifies one site as "Haven of the Red Quill." The handwriting matches that seen in The Scrivener's Tale.
\item A folio torn from an unknown tome details the history of Delimbiyran and Phalorm. Also called the Realm of Three Crowns, Phalorm was one of the many kingdoms of old in the North. When the Realm of Three Crowns fell, the kingdom of Delimbiyran rose after it.
\item Tucked into the folio is a sheaf of notes written by Machil. The notes talk of the adventurer seeking "the shadow glass," which he expected to be a great treasure.
\item Within a stack of old bills marked "Past Due," the characters find an unsigned and apparently unsent letter from Machil, which reads: "To my family. Forgive me the vanity that took me from you, and must soon claim my life or soul. You know how ambition corrupted my love for you. I pray that someone avenges the evils done by Nintra Siotta, Princess of the Shadow Glass, Lady of Dread Omens, Seeker of the Three Crowns. But spend not your own lives against it. The scrivener bound her in his haven, and only there can I be free of her. But it is too late for me." (Machil wrote the letter when he knew he was being pursued by agents of the Gloaming Court but was killed before he could send it.)
\item A piece of parchment is shot through with dry rot and crumbles when handled. What remains of the parchment afterward displays writing in Machil's hand, which reads: "... stairs among the surface ruins of Delimbiyran and descended deep to the Haven of the Red Quill. The guardians almost finished us before the door was opened. Gods, how I wish..."
\end{itemize}
...
\subsubsection{Crimes against House Rillyn}
...
\section{Haven of the Red Quill}
...
\subsection{Exploring Delimbiyran}
...
\subsubsection{Dark Manipulation}
...
\subsection{Haven Features}
The library ruins have the following features:


\begin{description}[nolistsep]
\item[Floors, Walls, and Ceilings]
All areas of the ruins except the cavern (area H7) are worked stone. Ceilings are 30 feet high, except in area H8, which has a domed ceiling 50 feet high.
\item[Light]
Unless otherwise noted, all areas are unlit.
\item[Golems and Mummies]
Each section of wall marked "G" or "M" on the map indicates the location of a hidden stone golem (G) or mummy (M) in stasis. A detect magic spell reveals an aura of conjuration magic emanating from that section of wall. When called for in the text, the golems and mummies phase out of the walls and materialize in the dungeon. Until then, they are hidden and can't be harmed.
\end{description}

\subsection{Haven Locations}
The following locations are keyed to the map of the Haven of the Red Quill.

\subsubsection{H1. Deep Stairwell}
...
\subsubsection{H2. Collapsing Room}
\begin{DndReadAloud}{}
...
\subsubsection{H3. Central Chamber}
\begin{DndReadAloud}{}
...
\subparagraph{Zyrian the Scrivener}
...
\subsubsection{H5. Dragon Fresco}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item The dragon is as big as one would expect an adult black dragon to be, and it clutches a small chest in one of its foreclaws. This chest, like the dragon, is a flat image rendered as part of the fresco, but it has a deep, half-inch-diameter hole bored into it.
\item The wizards, like the dragon, are life-sized. One of them appears to hold a 1-foot-long black wand. This wand is not part of the fresco; it's an actual iron wand embedded in the wall, and it looks like it can be removed.
\end{itemize}
...
\subsubsection{H8. Great Library}
\begin{DndReadAloud}{}
...
\subparagraph{Scrivener's Marks}
...
\subsection{Favor of the Gloaming Court}
...
\subsection{A Little Light Reading}
...
\section{Nintra Siotta, Princess of the Shadow Glass}
...
Nintra's eyes burn with green fire, and she speaks in a high, musical voice. Deception comes naturally to her, but imprisonment in The Scrivener's Talehas made her impatient and prone to telepathic outbursts that betray her cruel nature.
...
The Avowed in Candlekeep could bring Alkazaar's Appendix to the characters' attention and approach the characters (especially if the party has visited Candlekeep before) in hopes that they can complete Alkazaar's unfinished quest and perhaps procure for the library the fabled Nether Scroll of Azumar that Alkazaar believed the golem once guarded.
...
\begin{itemize}
\item Alkazaar was searching for a Nether Scroll of Azumar. This was to be his last adventure before retiring.
\item In the Anauroch desert, he came across a wandering stone golem. Alkazaar believed this golem was the legendary Sapphire Sentinel, rumored to have been created by Netherese wizards to protect one of the fabled Nether Scrolls under the control of Prince Hamukai.
\item The golem recognized its master's name, Hamukai, when Alkazaar mentioned it. From that point on the golem followed him, obeying his commands.
\item The golem communicated through sign language. It seemed lost and sad.
\item Alkazaar met Bedine nomads who said they knew of a place that held clues about the golem, but it was in purple worm territory. He followed the Bedine guides until a sandstorm obscured the route. The camels ran off, and, after losing his guides and his transportation, Alkazaar called an end to the expedition.
\item Before he left the desert, Alkazaar inscribed a magical tracer on the golem in the hope that he could find it again.
\item He begs the reader to go to Anauroch and find the lost golem, which might lead to the discovery of a Nether Scroll.
\item On the final page of the story, cryptic symbols surround an illustration of the golem. If deciphered, this code reveals the magic words to activate the picture portal.
\end{itemize}

\subsection{The Picture Portal}
...
\item[Flaw]
"Sometimes I put curiosity before caution."
\end{description}

\subsubsection{Shamir}
...
\begin{description}[nolistsep]
\item[Personality Trait]
"I know much about the ancient history of Netheril."
\item[Ideal]
"I want to know what my ancestors knew."
\item[Bond]
"My grandson, Pesh, is my life."
\item[Flaw]
"I think magic is a road that leads to ruin."
\end{description}

\subsection{The Golem}
...
\begin{itemize}
\item The golem understands Common but can't speak.
\item It can open the sealed vault where the prince rests (see area V3).
\item The golem remains a noncombatant unless it is directly attacked.
\end{itemize}

\subsubsection{The Sapphire}
...
\subsubsection{What Pesh and Shamir Think}
...
\subsubsection{Roleplaying the Golem}
...
\subsubsection{Keeping the Golem Alive}
For story purposes, the golem or its sapphire must reach area V3 for the vault to be opened. On seeing the golem restored, Zikzokrishka can't contain her glee. She tries to destroy the golem so she can use the sapphire to open the vault and steal the Nether Scroll of Azumar. If the dracolich is defeated, the golem goes to be reunited with its master and complete its mission to deliver Hamukai's body and the Nether Scroll of Azumar to Elysium.
...
\begin{itemize}
\item The characters encounter three Cyclops who are bickering at each other while looking for food. They have Bedine prisoners tied up in their lair—a cavernous crack inside a granite escarpment that juts out from the sands.
\item Two Rakshasa masquerading as Bedine nomads named Imura and Sikkat offer to guide the party to a magic oasis. The rakshasas attack the characters as soon as they let down their guard.
\end{itemize}

\subsubsection{Stone Androsphinx}
...
\subsubsection{Voices of Netheril}
...
\begin{DndTable}[header=Worm Dung Treasure]{cX}
...
\subsubsection{Purple Worm Attack}
...
\subsection{H3. Hall of Rainbows}
\begin{DndReadAloud}{}
...
\section{Travel to the Necropolis}
...
\subsubsection{Ogruhl the Dragon Tortoise}
...
The tiny creatures are desert-dwelling Chwinga (see their stat block at the end of the adventure) that live in tiny caves built up on the shell of a giant dragon tortoise. If the characters approach the escarpment, the earth rumbles as the dragon tortoise raises its massive head out of the sand, addresses them, and asks their intentions.

For the dragon tortoise, use the dragon turtle stat block with the following changes:


\begin{itemize}
\item It speaks Draconic and Terran.
\item It lacks a swimming speed and the Amphibious trait.
\item Its breath weapon is a 60-foot cone of abrasive sand instead of steam that deals slashing damage instead of fire damage.
\end{itemize}
...
\subsection{Exploring the Necropolis}
...
\subsubsection{Hands of the Dead}
...
\subsubsection{Consortium of Three}
...
\begin{itemize}
\item Any creature that enters the sandstorm for the first time on a turn or starts its turn in the storm takes 55 (10d10) slashing damage.
\item Creatures in the sandstorm are blinded.
\end{itemize}
...
\subsection{V3. Dracolich's Antechamber}
\begin{DndReadAloud}{}
...
\subsubsection{Playing the Dragon}
...
\begin{description}[nolistsep]
\subparagraph{Treasure Hoard A}
\item 4,450 gp 370 pp Spell scroll of wish Wand of polymorph
\end{description}
...
\begin{description}[nolistsep]
\subparagraph{Treasure Hoard B}
\item 1,240 ep Staff of withering +2 longbow A petrified chwinga (see the end of the adventure for its stat block) that reverts to flesh when touched and uses its Magical Gift action to reward its liberator
\end{description}
...
\begin{itemize}
\item The Nether Scroll of Azumar (see the item's description below) inside a 24-inch-long, 5-inch diameter cylinder made of wood and encased in a sheet of gold (500 gp); the scroll is a thin sheet of hammered copper etched with Draconic writing
\item Gold funerary items wrapped into the prince's shroud (2,500 gp)
\item A platinum death mask (5,000 gp)
\item The sapphire shard from the prince's right palm (250 gp)
\item The prince's memoirs, which explain the story and the dangers of the Nether Scrollof Azumar
\end{itemize}
...
\subsection{Zikzokrishka Obtains the Nether Scroll}
...
\subsection{Zikzokrishka's Phylactery}
...
\subparagraph{Humanoid Fascination}
...
\subparagraph{Charm of the Mirage}
...
\subparagraph{Charm of the Water Bearer}
...
\subsection{The Saprophytic Plague}
...
\begin{itemize}
\item Xanthoria was a druid of Silvanus (god of wild nature) whose forest home was threatened by undead. By researching fungi and lichen, Xanthoria hoped to create a weapon that could protect her forest against undead invaders.
\item At some point, Xanthoria's research became more geared toward creating a ward against death itself, then finally toward achieving lichdom.
\item According to the book, Xanthoria never discovered the source of the undead incursion that prompted her initial research.
\end{itemize}
...
\subsubsection{Joining of Two Worlds}
...
\begin{itemize}
\item Xanthoria was fearful of a surge in undead invading the forest near her home in the Lykortha Expanse, a cave complex. She was seeking a way to stop their spread and preserve what she viewed as the natural order of things.
\item Most of the book discusses healthy symbiotic relationships in nature.
\item The author spent time researching undead in the hope of gaining insight into their actions and ascertaining where they could be coming from.
\item As the author sinks into madness, the writing turns into almost incomprehensible fragments, many alluding to her desire to combine natural life and the undead.
\item The end of the book records several failed attempts by Xanthoria to extend her life through a process similar to becoming a lich. There are various drawings of dissected animals and humanoids alongside musings on the viability of experimenting on fey creatures.
\item The sketches and margin notes get progressively darker the farther one reads. The terms "Mycorji? Shedaklah?" and "Lady of Lichen" appear several times each. Furthermore, the number 222 appears frequently throughout the latter half of the book devoid of explanation.
\end{itemize}
...
\begin{description}[nolistsep]
\item[Light]
The complex is dimly lit by bioluminescent fungi growing in patches on the walls.
\item[Fungus]
The ceilings, walls, and floors are coated in fungal growth.
\item[Passages]
The caves and tunnels are made of unworked stone. Ceilings throughout are 20 feet high unless otherwise noted.
\end{description}

\subsubsection{Madness of Zuggtmoy}
...
\begin{DndTable}[header=Madness of Zuggtmoy]{cX}
...
\begin{itemize}
\item She used to live here with her friends, Xanthoria and Bunny Blossom. Xanthoria is a druid of Silvanus, and Bunny Blossom is a yellow faerie dragon.
\item Xanthoria subjected her to some terrible experiment. It hurt badly, but she managed to escape somehow. She flitted about in the darkness until reaching the cave mouth. She's been sitting here feeling sad and missing Bunny Blossom ever since.
\item Thunderwing has no sense of direction and no sense of time. Any questions relating to such topics just confuse her.
\end{itemize}
...
\subsubsection{L2. Alchemist's Alcove}
\begin{DndReadAloud}{}
...
\subparagraph{Treasure}
Though most of the bottles in this room have been ruined, a few are in fairly good shape. A thorough search yields a Potion of Superior Healing and a mildewed notebook containing instructions for concocting a potion of longevity out of fungi and a pint of blood from an archfey, all harvested within the past 24 hours. The handwriting in this notebook matches the handwriting in Xanthoria.
...
\subsubsection{L3. Cavern of Souls}
\begin{DndReadAloud}{}
...
\subparagraph{Suspended Subjects}
...
\subparagraph{Attacking the Mycelium}
...
\begin{DndTable}[header=Mycelium Effects]{cX}
...
5–6 & Psychic energy fills a 20-foot-radius sphere centered on a point in the cavern chosen by the DM. Each creature in the area must succeed on a DC 16 Intelligence saving throw or take 31 (4d12 + 5) psychic damage and be stunned for 1 minute. A target can repeat the saving throw at the end of each of its turns, ending the stunned condition on itself on a success.\\
\end{DndTable}
...
\subsubsection{L4. Moldy Bedroom}
...
\subsubsection{L6. Flooded Cavern}
\begin{DndReadAloud}{}
...
\subsubsection{L9. Cove of Experimentation}
...
\begin{itemize}
\item The rotting corpse of what looks like a displacer beast, but one with far too many tentacles and limbs.
\item The yellowed skeleton of a tiny dragon with a second head, all its flesh rotted away. Its body is curled up in an unnatural position, and its wings are outstretched oddly as if it were suffering some unknown agony. These are the remains of the yellow faerie dragon Bunny Blossom.
\item The skeletal remains of a sprite dressed in brightly colored but tattered clothing. Its translucent wings are shriveled and crumble at the lightest touch.
\item The rotting and mutilated remains of four goblins and two wood elves.
\end{itemize}
...
\subparagraph{Treasure}
Once the undead behirs are dealt with, characters who search the cave thoroughly find Xanthoria's staff of the woodlands leaning against a wall in the eastern alcove. The staff is fully charged.

\subsubsection{L10. Charnel Pit}
\begin{DndReadAloud}{}
...
\begin{DndTable}[header=Charnel Worm Effects]{cX}
...
\subsubsection{L11. Xanthoria's Grove of Horrors}
...
Xanthoria should be well prepared for the adventurers by the time they arrive at her warped druid grove and laboratory. She has called a nalfeshnee named Danjak to her service. Danjak is an emissary of Zuggtmoy, and the demon's form is crusted and interwoven with a riotous blend of molds, lichen, and fungi. He lurks at the back of the cave, awaiting Xanthoria's command before stepping out of the shadows. Additionally, nearby lurks the rotting husk of an infected treant ready to defend its master. The treant can't use its Animate Trees action here, since there are no other trees in the vicinity. In addition to the treant, four invisible Will-o'-Wisp flit about the grove, ready to use Consume Life on adventurers who fall in battle.

\subparagraph{Environmental Factors}
...
\begin{itemize}
\item Promising to raise her friend, Bunny Blossom the faerie dragon, from the dead.
\item Promising to complete Xanthoria's original mission to rid the surrounding forest of undead.
\item Destroying Xanthoria's notes so that the process of creating a lichen lich can never be duplicated by anyone else.
\end{itemize}
...
\begin{itemize}
\item Poisonous spores fill a 10-foot cube that the lich can see within 120 feet of it. Any creature that enters the cloud for the first time on a turn or starts its turn there must succeed on a DC 19 Constitution saving throw or be poisoned until the end of its next turn. The cloud lasts for 1 minute or until it is dispersed by a strong wind.
\item The lich commands the might of its diseased grove, creating a shambling mound. The shambling mound appears in an unoccupied space within 30 feet of the lich, acts on its own initiative count, and obeys the lich's commands. The shambling mound dies after 1 hour or when the lich uses this lair action again.
\item Rotten roots and vines magically erupt in a 20-foot radius centered on a point on the ground that the lich can see within 120 feet of it. the lich is unaffected by the roots and vines. For all other creatures, the area becomes difficult terrain, and each creature in the area must succeed on a DC 19 Strength saving throw or be restrained by the roots. As an action, a creature can try to free itself or another creature within its reach, doing so with a successful DC 19 Strength (Athletics) check. The roots and vines wilt away when the lich uses this lair action again or when the lich dies.
\end{itemize}
...
\begin{description}[nolistsep]
\item[Project Lead]
\DndDropCapLine{C}{}hristopher Perkins
...
\item[Rules Development]
Jeremy Crawford, Dan Dillon, Ben Petrisor, Taymoor Rehman

\item[Editing]
Michele Carter, Scott Fitzgerald Gray, Kim Mohan, Christopher Perkins, Hannah Rose
...
Dan Dillon, Adam Lee, Ari Levitch, Ben Petrisor, F. Wesley Schneider, James Wyatt

\item[Art Team Manager]
Richard Whitters

\item[Art Department]
Trystan Falcone, Kate Irwin, Emi Kuioka, Shawn Wood, Trish Yochum

\item[Senior Producer]
Dan Tovar

\item[Producers]
Bill Benham, Robert Hawkey, Lea Heliotis
...
\item The map of Candlekeep was inspired by a map design by Marco Bernardini.
\item Special thanks to our hundreds of playtesters!
\end{multicols}
