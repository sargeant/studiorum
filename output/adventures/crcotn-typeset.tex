...
\chapter*{Introduction \textendash{} Answering the Call}

\addcontentsline{toc}{chapter}{Introduction \textendash{} Answering the Call}
\markboth{INTRODUCTION \textendash{} ANSWERING THE CALL}{INTRODUCTION \textendash{} ANSWERING THE CALL}
...
\begin{tikzpicture}
  \node[inner sep=0, anchor=north east, align=right]{
...
\subsubsection{Underwater Visibility}
...
\begin{DndTable}[header=Underwater Encounter Distance]{lc}
...
\begin{figure*}[t]
\includegraphics[width=\textwidth]{images/adventure/CRCotN/007-00-008.xhorhas-adventurers.png}
\end{figure*}
...
\onecolumn
\begin{DndTable}[header=Pronunciations]{llX}
...
\paragraph{Treasure}
Each winner of this contest receives a tin medal of the meat pie (see appendix B) shaped like—you guessed it—a meat pie.

Win or lose, a character can't compete in this contest again until they complete a long rest.

\begin{figure*}[t]
\includegraphics[width=\textwidth]{images/adventure/CRCotN/011-01-002.agathe-silverspoon.png}
\end{figure*}
...
The way to win is to study the maze from the outside, and then follow the only correct path to the exit in one shot. If a creature reaches a dead end, the judge—a lawful neutral aarakocra named Sharpwatch—swoops down and plucks them from the maze.

Maggie Keeneyes (tier 1), whose stat block appears in appendix A, has figured out the solution to the maze, but the ogre's size keeps her from entering the maze. She wants her friend, a goblin named Dermot Wurder (tier 1), whose stat block also appears in appendix A, to go in her place. Dermot, however, is convinced that even with her instructions, he will come to a dead end.
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/012-01-003.medal-of-the-maze.png}
...
\paragraph{Treasure}
Characters who complete the maze are awarded a medal of the maze (see appendix B) made of smooth driftwood, hung on a piece of rough twine. A labyrinthine pattern has been carved into the front of the medal.
...
The game is refereed by an impassive, lawful neutral goblin named Omo.

The blue-skinned individual is a water genasi named Ayo Jabe (tier 1), whose stat block appears in appendix A. After breaking up the argument on the docks, she returns to her companion, an elegant drow in wizard's robes. This is Galsariad Ardyth (tier 1), whose stat block also appears in appendix A.

Ayo and Galsariad exchange a few terse words before Ayo motions toward the pier. A character who eavesdrops on them can make a DC 14 Wisdom (Perception) check. On a success, the character learns that the drow offered to cast a longstrider spell on the genasi, but she declined; she wants to win on her own.
...
Other than Ayo, the contestants are a lanky male orc scout, a broad-shouldered female human thug, and a surly male goblin. These nonplayer characters have the following modifiers to their Strength (Athletics) checks, which come into play during the swimming contest:
...
On Omo's mark, the contestants plunge into the water and begin swimming. Competitors roll initiative when they dive into the water, with all participants expected to use the Dash action every round. Any contestant who moves more than 30 feet on their turn must make a DC 13 Strength (Athletics) check at the end of that turn. On a failed check, the contestant gains 1 level of exhaustion and is pushed 15 feet downstream as they are pummeled by the current.
...
\paragraph{Treasure}
Omo awards the winner a medal of the conch (see appendix B) made of sea glass that has been magically crafted into the shape of a conch shell.
...
The victor in this contest, and the defending champion of the event, is Maryl Bronzefang, a lawful neutral, orc gladiator. A native of Jigow serving in Bazzoxan's Aurora Watch, she was given leave to return home for the festival. She is flanked by two compatriots, both female drow Veteran clad in chitinous splint armor. A quiet male goblin commoner—Vars, the owner of the butcher shop—sits off to the side, managing the wagers made by onlookers.
...
\begin{description}[nolistsep]
\item[Maggie Keeneyes:]
+4
\item[Maryl Bronzefang:]
+4
\item[Female Drow:]
+3
\end{description}
...
\paragraph{Treasure}
Vars hands anyone who bests Maryl and Maggie a medal of muscle (see appendix B) made of ebony and shaped like a flexing arm. If one stares at it for long enough, the muscles appear to bulge.
...
This event is managed by two neutral good Goblin named Beetle and Zag. Their farm is jointly run by the Gakthash and Uvuroh goblin clans, and every year, the goblin couple uses the festival competitions as a labor-saving way to harvest their crops.
...
\paragraph{Treasure}
Beetle and Zag award each member of the winning team a copper medal of the wetlands (see appendix B) engraved with a sheaf of rice, hung on a necklace woven of reeds.
...
If a tortoise is charmed by an animal friendship spell or a similar effect, Wisdom (Animal Handling) checks to guide it are made with advantage, and it won't buck its handler on a failed check.

\paragraph{Treasure}
Once a tortoise reaches its destination, Adan awards its rider a medal of the horizonback (see appendix B).
...
\begin{description}[nolistsep]
\item[Bottle 1.]
This purple bottle is filled with berry juice.
\item[Bottle 2.]
This green bottle is filled with blight brew. A character who sips from this bottle must succeed on a DC 10 Constitution saving throw or become poisoned for 1 minute, spending the time retching.
\item[Bottle 3.]
This sky-blue bottle is filled with berry juice.
\item[Bottle 4.]
This white bottle is filled with overwhelmingly spicy pepper oil. A character who sips from this bottle must succeed on a DC 10 Constitution saving throw or take 1 fire damage from the spice.
\item[Bottle 5.]
This purple bottle is filled with a liquid known in Jigow as glow potion. A character who drinks from this bottle feels warmth settle in their stomach as their skin emits dim silvery light out to a range of 5 feet for 1 minute.
\item[Bottle 6.]
This green bottle is filled with blight brew, just like bottle 2.
\item[Bottle 7.]
This red bottle is filled with apple juice.
\end{description}
...
A detect magic spell or similar effect also reveals the fifth bottle to be the only one containing magical liquid.
...
\paragraph{Treasure}
If a character answers at least two of the riddles correctly, Elder Colbu Kaz awards that character a medal of wit (see appendix B), which is sculpted and painted to look like the head of a fox.
...
The temple is maintained by Belana Zolaed, a neutral good drow priest who also conducts worship ceremonies.
...
The characters and their rivals follow the elders as they wade through the shallows, from one island to another. When they reach the smallest island, Elder Colbu Kaz places several Potion of Water Breathing in front of the contestants—one for each of them. "Their magic lasts for one hour," he says.

Then, Elder Ushru halts the crowd and raises his arms to address all assembled:

\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/013-01-004.potion-of-water-breathing.png}
\begin{DndReadAloud}{}
...
\begin{figure*}
\includegraphics[width=\textwidth]{images/adventure/CRCotN/014-map-1.2-Emerald-Grotto.png}
\end{figure*}
...
\begin{description}[nolistsep]
\item[Ceilings.]
Chambers are 15 feet high, and tunnels are 5 feet high.
\item[Light.]
Unless otherwise specified, there is no natural light.
\item[Water.]
Most of the Emerald Grotto is underwater (see "Underwater Adventuring" in the introduction).
\end{description}
...
This is the first fully submerged chamber of the grotto. The characters must make a DC 13 Strength (Athletics) group check as they try to swim through the mass of kelp (see the Player's Handbook for the rules on group checks). The result of this check determines the time it takes them to move through the chamber.
...
A character who explores this cave discovers a vial containing a potion of healing and a soggy but usable spell scroll of thunderwave.
...
\begin{figure*}[b]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/016-01-005.giant-octopus.png}
\end{figure*}
...
A giant octopus dwells at the bottom of the pit and attacks anyone who enters it. A character who enters the pit and succeeds on a DC 17 Wisdom (Perception) check notices the octopus at the bottom and is not Surprise when it attacks. If reduced to 13 hit points or fewer, it uses Ink Cloud and moves 10 feet away, hoping the characters leave it alone.

\paragraph{Treasure}
Once the octopus is defeated, a character who searches the bottom of the pit finds 57 sp and a pouch containing dust of dryness in the form of eight marble-sized pellets that have absorbed hundreds of gallons of water. When a pellet is smashed, the act releases a 15-foot cube of water.
...
\paragraph{Tablet}
A detect magic spell reveals that the tablet radiates an aura of evocation magic. The tablet has AC 15, 10 hit points, and immunity to poison and psychic damage. Destroying the tablet causes the current to subside, allowing creatures to travel through the tunnel without resistance.
...
A character who searches this cave finds three Potion of Healing, likely stashed here by a hopeful contestant planning to gain an advantage in this race.
...
\begin{description}[nolistsep]
\item[Fast Pace (10 or Fewer Rounds).]
The characters outpaced the rivals. The rivals don't appear until after the encounter with the shark is resolved.
\item[Moderate Pace (Between 11 and 15 Rounds).]
The characters beat the rivals to the chamber, but not by much. The rivals enter the chamber on the third round of combat and roll initiative. Unless the rivals are hostile toward the characters, they aid the characters in the fight against the shark; otherwise, they focus on acquiring the amulet or try to sabotage the characters (though these attempts are never intentionally lethal).
\item[Slow Pace (16 or More Rounds).]
The rivals get to the chamber ahead of the characters. When the characters arrive, the rivals have reduced the shark to 75 hit points. The characters roll initiative when they enter the chamber.
\end{description}

\paragraph{Emerald Eye}
A druid of Jigow cast animal friendship on the shark earlier today and tied the Emerald Eye around its body, then made a speedy getaway. A character can cut the amulet free by attacking the rope around the shark instead of the shark itself. The rope has AC 17 and 5 hit points. It can be removed as an action if the shark is killed or incapacitated. The amulet, which is made of gold and emeralds, is worth 500 gp—though no one in Jigow will buy it, since it must be returned the town elders once the contest is completed.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/017-01-006.spectral-figure.png}
\end{figure*}
...
The object on the crystal pedestal glitters like the sunrise. This is the Jewel of Three Prayers, a Vestige of Divergence that will drive the course of the adventure from now on. The Jewel of Three Prayers (Dormant) is currently in its Dormant State (see appendix B for the description of this magic item).
...
If the rivals are present, they can hear the distorted, disembodied voice of Alyxian as if he were speaking underwater. When the vision ends, the characters fall unconscious for 1 minute.
...
The characters awaken to find the rivals attempting to rouse them. Though they didn't see the vision, the rivals sensed a surge of energy erupting from the jewel, then found the characters unconscious in the cavern. If the characters retrieved the Emerald Eye, the rivals concede the competition to them. Otherwise, the rivals proudly hold up the amulet, claiming it as theirs, but congratulate the characters on a race well run.
\item[Hostile Rivals.]
The characters awaken to discover that the rivals have absconded with both the Emerald Eye and the Jewel of Three Prayers.
\end{description}

\paragraph{Disputing Destiny}
If Ayo or another one of the rivals touched the Jewel of Three Prayers, they are the recipients of the vision instead. The rivals fall unconscious for 1 minute, and it is up to the characters to decide what to do with them. In this scenario, which is examined further in chapter 2, the rivals are the "heroes" of the story, and the characters must decide if they want to aid their rivals or take back the jewel and claim their own heroic destiny.
...
Unless the characters take steps to conceal the Jewel of Three Prayers, Elder Ushru takes notice of the item. Even if they do keep it from his view, Ushru senses a change in the characters' demeanor—something happened to them in the grotto, something no one in Jigow could have expected. This suspicion prompts him to speak to the characters in the morning—leading into the events of chapter 2.

\clearpage
\tikz[remember picture, overlay] \node[inner sep=0pt] at (current page.center){\includegraphics[height=\paperheight]{ images/adventure/CRCotN/018-02-001.intro-splash.png}};
\thispagestyle{empty}
\newpage

\chapter{The Leave-Taking}
\DndDropCapLine{I}{n this chapter, the characters learn} more about the events that occurred in the Emerald Grotto and the mythic significance of the Jewel of Three Prayers. Following this discovery, the characters depart Jigow and travel across Xhorhas toward Bazzoxan, a bleak military outpost guarding a fortress of evil.
...
\begin{description}[nolistsep]
\item[Heroic Quest.]
In the Emerald Grotto, the characters obtained the Jewel of Three Prayers and experienced the vision from the Apotheon. In this scenario, they are approached by Elder Ushru, who senses that the Jewel of Three Prayers is a powerful magic item and suggests the characters undertake a journey to learn more about it.
\item[Ours by Right.]
...
\item[Warring Destinies.]
If the characters got the jewel but grievously insulted the rivals (or even killed one or more of them), the rivals try to steal the jewel in the middle of the night and begin the journey to Bazzoxan themselves.
\end{description}
...
Ayo Jabe (Tier 1) doesn't mince words; she wants to know what they found in the grotto. If she gets the sense that the characters have stumbled onto something big, her eyes grow wide. She decides that she and her group want a piece of the action and proposes that they travel with the characters, saying that there's safety in numbers. A character who makes a successful DC 13 Wisdom (Insight) check realizes that she isn't hiding anything and wants nothing more than to be a part of a grand adventure.

The other rivals have their own opinions:


\begin{itemize}
\item Dermot Wurder (Tier 1) is genuinely concerned for the characters' well-being. He mentions that he heard what sounded like a voice in the grotto and wants to know if the characters heard it too.
\item Galsariad Ardyth (Tier 1) is curious about what the characters learned in their vision and is eager for the characters to share any magical secrets they might have discovered.
\item Irvan Wastewalker (Tier 1) has no interest in what happened in the grotto, but he is interested in learning what the jewel can do.
\item Maggie Keeneyes (Tier 1) agrees with anyone who expresses concern for the characters but doesn't say much on her own. She has her suspicions that more happened than what they have related during the event in the grotto, but she won't push them if they don't want to reveal the full truth.
\end{itemize}

\subsection{Ours by Right}
If the rivals acquired the Jewel of Three Prayers and experienced the vision of Alyxian, they are the ones approached by Elder Ushru in the morning, and they are the ones who are encouraged to travel to Bazzoxan. In this case, read the following to the players:
...
\begin{DndSidebar}[float=!b]{Refusing the Call}
...
If the characters won the Festival of Merit but made enemies of the rival party, either by insulting them or by injuring or killing one or more of them, the rivals try to get revenge by stealing the Jewel of Three Prayers from the characters while they sleep.
...
\begin{description}[nolistsep]
\item[Caught Sleeping.]
If none of the characters has a passive Wisdom (Perception) score of 15 or higher, the thief escapes with the jewel. The rival party heads to Rosohna. Along the way, they receive a vision from Alyxian that directs them to Bazzoxan.
\item[Slow to Act.]
...
\begin{figure*}
\includegraphics[width=\textwidth]{images/adventure/CRCotN/019-map-2.1-The-Emerald-Gulch.png}
\end{figure*}
...
\begin{description}[nolistsep]
\item[Normal Pace.]
The journey takes 12 days, and the characters have six random encounters: four encounters prior to reaching the Emerald Loop Caravan Stop (where they arrive at the end of the eighth day) followed by two more encounters.
\item[Fast Pace.]
The journey takes 9 days, and the characters have four random encounters: three encounters prior to reaching the Emerald Loop Caravan Stop (where they arrive at the end of the sixth day) followed by one more encounter.
\item[Slow Pace.]
The journey takes 15 days, and the characters have eight random encounters: five encounters prior to reaching the Emerald Loop Caravan Stop (where they arrive at the end of the tenth day) followed by three more encounters.
\end{description}
...
\begin{description}[nolistsep]
\item[Rivals' Reunion.]
This encounter occurs if the rivals left Jigow ahead of the characters and the characters travel at a fast pace to catch up with them on the way to Bazzoxan.
\item[Emerald Loop Caravan Stop.]
This encounter occurs at the point where the Emerald Loop meets the Hallowed Path—unless the characters choose not to rest at the caravan stop.
\end{description}
...
Just off the road ahead, the characters spot the corpse of a gloomstalker (see appendix A). Even in death, its corpse is covered in roiling, wispy shadows. The grass around the creature has been trampled flat.
...
\begin{description}[nolistsep]
\item[Patrol at Rest.]
The characters come across six lawful neutral Aurora Watch Veteran (a mix of lawful good drow, humans, and orcs) who are resting at a campsite just off the road. Clearly in good spirits, they invite the characters to join them. Traveling with this patrol is a lawful good, drow scout who also serves as a cook. If the characters take a long rest with the patrol, the food they were given the night before grants them 1d10 temporary hit points when they awaken the next day.
\item[Patrol in Battle.]
The characters see six lawful neutral Aurora Watch Veteran (a mix of lawful good drow, humans, and orcs) fighting a hezrou. If the characters help the Aurora Watch slay the demon, the soldiers thank them, give them a total of 50 gp as a reward, and promise to commend them to Taskhand Verin Thelyss when the patrol returns to Bazzoxan. If the characters do nothing to help, the soldiers slay the demon, but only after one soldier is killed and two others are reduced to 0 hit points (one stable, the other dying).
\item[Lost Patrol.]
On the road in front of the characters are the bodies of six Aurora Watch soldiers near the corpse of a hezrou that is slowly dissolving into black ichor. Two Shadow Demon and two Quasit lurk beneath the soldiers' corpses, waiting for more prey to arrive. They fight to the death.
\end{description}
...
The carrion bird is a vrock that has been feeding on the mortal flesh strewn about the battlefield. It swoops down to attack characters who disturb any of the corpses. In addition, three Quasit hide in the udaak's fur and attack non-demons that come within 10 feet of the udaak's melting corpse.
...
\paragraph{Treasure}
A character who investigates the carnage for at least 10 minutes can make a DC 13 Intelligence (Investigation) check. On a success, they find a +1 dagger embedded in the hide of the udaak. The dagger is inscribed with the name of its owner, Kierchaly Wastewalker. The characters might later learn that this warrior is among the dead, but his daughter and son survived, and they are now at the caravan stop.

\subsubsection{Feast for the Eyes}
The characters see a gloomstalker (see appendix A) antagonizing 1d3 Mammoth that are moving slowly across the wastes, minding their own business. The creatures are 3d6 × 100 feet away from the characters when the encounter begins.
...
Each time the gloomstalker uses Shriek during the battle against the characters, 1d6 Skeleton of dead human soldiers burst up out of the ground within 30 feet of the characters and attack them, acting on their own initiative count. Skeletons that aren't reduced to 0 hit points collapse into inanimate piles of bones after 10 minutes or when the gloomstalker is slain.
...
The characters hear a wild yell. In the distance, they see a lawful neutral, tiefling scout named Justice on the back of a moorbounder (see appendix A) and hanging on for dear life as the creature snarls and bucks about. Two Bristled Moorbounder (see appendix A) are circling the imperiled tiefling. Justice can hang on for another minute at most, and the moment he touches the ground, the bristled moorbounders intend to tear him limb from limb.
...
On a rare sunny day in the wastes, characters who have a passive Wisdom (Perception) score of 15 or higher see a cloud of dust being kicked up about half a mile down the road—and it continues to head toward them. A few minutes later, the characters are surrounded by human bandits mounted on bedraggled horses. These bandits call themselves the Road Raiders. Their leader, a grizzled man named Postraeck, is a neutral evil bandit captain who rides an imposing black warhorse. Postraeck is better known as Six-Knives because of the six daggers he carries on his person at all times, each of which has a name (Boneshaver, Gleam, Grudge, Jabby, Pierce, and Tickles). His fellow riders are ten Bandit (lawful evil humans) mounted on Riding Horse.
...
Future occurrences of this encounter are with Six-Knives at the head of the group—or, if he's dead, one of his protégés, now a bandit captain—hoping to plunder more coin from the characters' pockets or exacting revenge for their earlier losses.
\begin{figure*}[t]
\includegraphics[width=\textwidth]{images/adventure/CRCotN/022-02-003.spires-barbed-fields.png}
\end{figure*}
...
\begin{description}[nolistsep]
\item[Jewel Theft.]
If the characters intend to take the Jewel of Three Prayers from the rivals, this will likely be a combat encounter or an attempted infiltration.
\item[No Quarrel.]
If the characters aren't looking to quarrel, this encounter is a roleplaying opportunity during which the characters can interact with the rivals.
\end{description}
...
\begin{figure*}
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/023-map-2.2-Emerald-Loop-Caravan-Stop.png}
\end{figure*}
...
Big Yuyo is an adult horizonback tortoise (see appendix A)—known as a "kinespaji" in Goblin—that is the home of the Kruzkrenner goblin family. The tortoise is named after a Xhorhasian vegetable called a yuyo—an ochre cucumber that grows in Rosohna's underground gardens.
...
Papa Drazagorr (lawful neutral, goblin veteran) served in the Aurora Watch when he was younger and still has an appreciation for military discipline. These days, he doesn't wear armor or carry weapons, except for a dagger.

Pops Kelbadurn (neutral good, goblin guard) served in the Asarius Town Guard and still has his old chain mail, spear, and shield stored in the command post (area L2f). He's easygoing and artistic.

Auntie Jaller (chaotic neutral, hobgoblin druid) is old and elegant-looking, thanks to her long silver hair and deep green robes. She calls herself an "old witch" and spends much of her time brewing potions and inventing new tea blends.
...
\begin{description}[nolistsep]
\item[L2a: Upladder.]
This ladder leads up at the rear of Big Yuyo's shell to the platforms on the tortoise's back. Little Chespa yells, "Halt! Who goes there?" to anyone she doesn't know who tries to board Big Yuyo.
\item[L2b: Rear Hut.]
The rear platform supports a hut where Auntie Jaller and the two kids sleep. It's filled with homemade straw dolls and other toys.
\item[L2c: Central Platform.]
This central platform supports a 30-foot-tall watchtower.
\item[L2d: Archery Tower.]
This elevated platform is designed to give an archer a clear view of the surroundings.
\item[L2e: Starboard Gazebo.]
This platform holds a gazebo, where the family can relax.
\item[L2f:]
Command Post. The command post holds Drazagorr and Kelbadurn's bed and their belongings, which include a set of goblin-sized chain mail, a spear, a shield, two Shortbow, two Quiver containing 20 Arrows (20) apiece, and a wooden chest that holds 100 gp (the family's savings) and a collection of sentimental keepsakes.
\end{description}
...
\begin{itemize}
\item Tyvak and Moghra (chaotic good, human Berserker) survived the battle with the udaak that the characters saw the aftermath of in the Demonic Carrion encounter. They are the daughter and son of Kierchaly Wastewalker and belong to the same clan as Irvan Wastewalker. If Tyvak sees that one of the characters has retrieved her father's +1 dagger from that site, she offers to trade her +1 battleaxe for it and thanks the characters with all her heart if the dagger is turned over.
\item Justice (lawful neutral, tiefling scout) and his moorbounder mount, Rice Pudding, are here if they survived the Moorbounder Mayhem encounter. If the characters helped him during that encounter, Justice gives them a pair of goggles of night that the caravan he's working for had a hard time selling at their last stop.
\item The Acorn Sisters, Lanata and Robur, are Dryad. As the caretakers of this forest, they're fine with bonfires as long as only dead wood is burned. It's customary to share food, drink, and song with them in appreciation for their hospitality. Characters who show them great respect by making an offering directly to them awaken in the morning with a charm of vitality (see the rules for supernatural gifts in the Dungeon Master's Guide).
\end{itemize}

\paragraph{Shopping}
The caravanners parked around the bonfire—including Justice's employers, if he is present—have merchandise for sale. Two neutral Bugbear Chief guard the wagons, and six lawful neutral Aurora Watch Veteran (a mix of drow, humans, and orcs) resting at the camp are prepared to apprehend any thieves and drag them to Bazzoxan in chains.
...
\begin{DndTable}[header=Merchants' Wares]{lrr}

Item & Price & Number\\
Backpack & 2 gp & 1d6\\
Blanket & 5 sp & 2d6\\
Healer's Kit & 5 gp & 1d6\\
Hunting Trap & 5 gp & 1d6\\
Oil (flask) & 1 sp & 2d6\\
Parchment (One Sheet) & 1 sp & 6d6\\
Potion of Healing & 50 gp & 1d4\\
Rations (1 Day) & 5 sp & 10d6\\
Hempen Rope (50 feet) & 1 gp & 1d6\\
Quiver of 20 Arrows (20) & 2 gp & 1d4\\
Quiver of 20 Crossbow Bolts (20) & 2 gp & 1d4\\
Sack & 1 cp & 2d6\\
Two-Person Tent & 2 gp & 1d4\\
\end{DndTable}
...
\section{Running This Chapter}
The first part of this chapter is an exploration sequence in which the characters interact with locals and visit locations in Bazzoxan to learn more about their vision in the Emerald Grotto and the Jewel of Three Prayers. This section and the dungeon exploration that follows are intentionally open-ended and designed to reward inquisitive characters.
...
If the characters get stuck or frustrated, you can use friendly nonplayer characters such as Verin Thelyss and the faction agents to give them hints about how they could learn more. Ultimately, the characters need to find the prayer site inside the Betrayers' Rise.

Starting in this chapter, the characters' rivals use their tier 2 stat blocks (see appendix A).

\subsection{Who Has the Jewel?}
The path to the prayer site can be opened only by using the Jewel of Three Prayers. Doing so allows access to a segment of the Betrayers' Rise that has never been explored by the Aurora Watch. If the characters don't have the jewel, they might need to take it from the rivals—by stealth, by force, or by barter—as described in area B7, later in the chapter.
...
This chapter begins as two Aurora Watch Guard guide the characters from the gate of Bazzoxan toward the Gatehold Barracks. Read or paraphrase the following as the characters enter the town:
...
\end{DndReadAloud}
\begin{figure*}[t]
\includegraphics[width=\textwidth]{images/adventure/CRCotN/026-03-002.gibbering-mouther-threat.png}
\end{figure*}

Five Gibbering Mouther have sneaked into Bazzoxan and are intent on consuming anyone in their path. Opposing them are members of the Aurora Watch led by Taskhand Verin Thelyss (see the accompanying stat block).
...
\subsection{Fight!}
If the characters choose to help the Aurora Watch, everyone rolls initiative. Verin Thelyss and two orc Guard of the Aurora Watch stay with the party, while the rest of the soldiers leave to secure other parts of the city.
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/027-637828636927085942.png}
...
\begin{figure*}[t]
\includegraphics[width=\textwidth]{images/adventure/CRCotN/028-03-003.bazzoxan-scene.png}
\end{figure*}
...
d10 & Encounter\\
1 & A chaotic neutral, orc berserker tends a garden of root vegetables in one of the ruined buildings, aggressively pulling up weeds.\\
2 & A weary drow mother (neutral good commoner) sits in the marketplace, instructing her children on what to do if she dies.\\
3 & A tired drow merchant (neutral commoner) attempts to sell what's left of his inventory.\\
4 & An Aurora Watch soldier (lawful good drow elite warrior) breaks up a fight between two sobbing citizens (lawful good Commoner).\\
5 & Ten Aurora Watch Guard (lawful good drow, humans, and orcs) jog in formation, keeping tempo by singing about the ways they'll die.\\
6 & A neutral good bugbear fixes the wheelchair of a lawful neutral, drow veteran who has lost a leg.\\
7 & A teenage, lawful neutral, dwarf acolyte sits in a dark corner, weeping as she clutches a helm to her chest.\\
8 & A red-faced human (chaotic neutral commoner) rambles drunkenly about how the demons are coming to kill them all.\\
9 & Two members of the Aurora Watch, a lawful neutral drow elite warrior and a chaotic neutral ogre, bicker over which of them should take on a dangerous assignment.\\
10 & An old tiefling (lawful good veteran) sobs as he carries a small casket toward the crematorium (area B2).\\
\end{DndTable}
...
\begin{figure*}
\includegraphics[width=\textwidth]{images/adventure/CRCotN/029-map-3.1-Bazzoxan.png}
\end{figure*}
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/031-03-004.aloysia-prolix.png}
...
Lacking experience with dead bodies, Prolix turns to the characters for assistance. A character who wants to extract the contents of the vrock's stomach must first cleave through the vrock's hide. To do so, the character must succeed on a DC 15 Wisdom (Survival) check. A failed check triggers an eruption of spores from the vrock's corpse that fill a 10-foot-radius sphere centered on the corpse. All creatures in that area must succeed on a DC 14 Constitution saving throw or become poisoned. A creature poisoned in this way takes 5 (1d10) poison damage at the start of each of its turns. It can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

\paragraph{Treasure}
The vrock's gullet contains a pair of gold-trimmed eyes of the eagle, three gaudy rings worth 2 gp each, and a cube-shaped puzzle box made of onyx and measuring 3 inches on a side. A detect magic spell reveals an aura of abjuration magic around the box, which is locked. Prolix grabs it before anyone else can do so, leaving the other items for the characters. As soon as the puzzle box is removed from the dead vrock's gullet, the enchantment on the vrock fades, and it begins to dissolve into a puddle of reeking ichor.
...
When she sees the characters, the priest leaves her patient's side to greet them, introducing herself as Bautha Dyrr. She then asks them about their health. A character who succeeds on a DC 15 Intelligence (Religion) check identifies a pin in the shape of a black wing attached to Bautha's cloak as the holy symbol of Xalicas, a legendary solar who served as the right hand of Corellon the Arch Heart before falling in the Calamity. As a follower of Xalicas, Bautha disapproves of the reclamation efforts in Bazzoxan; though she supports the effort to hold back the forces of the Abyss, she believes the Kryn Dynasty's military presence here is creating needless casualties with little to show for it. Nevertheless, Bautha strives to heal and protect those in Bazzoxan, and she casts cure wounds or lesser restoration on victims for free, as long as she has spell slots to spare.

Bautha also has a spell scroll of greater restoration. She must succeed on a DC 15 Wisdom check to cast the spell from the scroll; otherwise, the scroll is destroyed with no effect. She will sell it to the characters for 500 gp.

Bautha is familiar with Prolix Yusaf and Aloysia Telfan, since both individuals have visited the infirmary for care in the past week. She sees them as reckless and naive, and she thinks that their obsession with researching the Betrayers' Rise can lead to no good end. A character who succeeds on a DC 13 Charisma (Persuasion) check gets her to reveal that Aloysia was injured when she tried to delve into the Betrayers' Rise alone—and now she's looking for mercenaries to explore it on her behalf.

\paragraph{Bautha and the Jewel}
If the characters show Bautha the Jewel of Three Prayers, identify it by name, and ask her about it, she doesn't recognize it, but something about the name reminds her of an old tale. She thinks for a moment, then says:
...
A neutral good, firbolg priest named Foghome moves through the temple at all hours of the day. For more information on firbolgs, see the accompanying "Firbolgs of Exandria" sidebar.
...
\begin{itemize}
\item No vegetation survives for long in Bazzoxan. Foghome thinks this is the result of the corrupting influence of the Betrayers' Rise.
...
\vspace*{2em}
\includegraphics[width=0.45\textwidth]{images/adventure/CRCotN/032-03-005.foghome-the-firbolg.png}
...
If asked about the Jewel of Three Prayers, Foghome has no recollection of an item bearing that name. If he examines the jewel, he correctly senses three fragments of divine power within it, one awake and two slumbering. He also tells the characters that one of the fragments in the jewel is similar to the presence he felt within the earth while he was meditating.

Foghome invites the characters to visit him at the temple any time. He mentions that he meditates to commune with the Wild Mother in the evenings, and he would be happy to reach out to her for more answers on the characters' behalf if they decide to join him one night.
...
Kalym returns to duty after imparting his gifts. He has no useful information about the Betrayers' Rise, the Jewel of Three Prayers, or the comings and goings of faction agents in Bazzoxan.
...
Question, a chaotic neutral, tiefling monastic operative (see appendix A), can be found lounging around the Ready Room at all hours. Unlike most others in Bazzoxan, Question almost always has a smile on her face.
...
\item A rough drawing of what appears to be a more elaborate version of the Jewel of Three Prayers. It is larger and has three delicate spires inlaid with stones.
...
If asked about the Jewel of Three Prayers, Question speaks of it with reverent awe, calling it a "lost Vestige." Though she doesn't know the relic's true nature, she believes the jewel was an ordinary amulet until it was filled with divine power during the Calamity.
...
During their conversation with Question, characters who have a passive Wisdom (Perception) score of 12 or higher notice a gaunt figure in scarlet robes nearby, eavesdropping. This figure, Aloysia Telfan, is a lawful evil, elf occult initiate (see appendix A) who thirsts for knowledge and power. She approaches the characters, if they don't accost her first, and greets them politely.
...
\item The hero wore a pendant that contained the power of three gods. This pendant is the key to acquiring the ruidium her organization seeks. (Partially true. The Jewel of Three Prayers holds the power of three gods and, in its Exalted State, can be used to open the rift to the Netherdeep in Cael Morrow, as described in chapter 5.)
\end{itemize}
...
The escaped creatures are two Gloomstalker (see appendix A). The soldiers stationed outside can assist the characters in battling the gloomstalkers, or you can have them rush inside to help three gravely injured Aurora Watch soldiers (lawful good, orc Knight) in area R1.
...
\begin{description}[nolistsep]
\item[Black Stone.]
Unless otherwise noted, all surfaces in the Betrayers' Rise are made of smooth, shiny black stone. The power that pervades the place prevents the architecture from being affected by magic such as stone shape.
\item[Ceilings.]
Unless otherwise noted, the vaulted ceilings of the temple's chambers are 50 feet high, and its hallways are 20 feet high.
\item[Light.]
The interior of the Betrayers' Rise contains no light sources unless otherwise noted.
\item[Shifting Halls.]
The interior of the Betrayers' Rise is different for each group that enters. The chaotic magic of the Abyss warps the configuration to stymie explorers and baffle cartographers. The characters experience a particular version of the temple—the one shown on the Betrayers' Rise map. If Aurora Watch soldiers or the rivals enter, they experience a different configuration.
\end{description}
...
d10 & Encounter\\
1 & The characters enter a room lined with flickering candles, only to discover that their shadows have detached from them and transformed into Shadow Demon (one per character).\\
2 & Four Ochre Jelly burble along the walls of a hallway, looking for prey to devour.\\
3 & A yochlol in giant spider form skitters around in an antechamber draped in spider webs.\\
4 & A yochlol in drow form wears the insectile armor of the Aurora Watch. Claiming to be a lost Aurora Watch soldier, the demon tries to lure the characters into greater danger.\\
5 & Two invisible Barlgura ambush the characters.\\
6 & A passageway opens into what was once a coliseum and now contains three enraged Nightmare.\\
7 & A gurgling, acidic river cuts through a cavern where three Roper stealthily await.\\
8 & Three Chasme emerge from their hive, which has overtaken what was once a chandelier.\\
9 & A glabrezu tempts all who come into its chamber with promises of riches. Anyone it can't bribe into serving it is attacked.\\
10 & Orange light emanates from the depths of a chasm, where a balor sleeps in molten lava. If it is attacked, the demon wakes. The characters, who have no chance of defeating this powerful demon in combat, must flee or die.\\
\end{DndTable}
...
d6 & Encounter\\
1 & 1d6 Quasit nesting in the corpses of the area's previous inhabitants or crawling on the walls in centipede form\\
2 & 1 chasme clinging to the ceiling\\
3 & 1 invisible barlgura standing guard\\
4 & 1d4 Shadow Demon lurking in the darkness\\
5 & 3d6 manes looking for a more powerful demon to lead them\\
6 & 1 gloomstalker (see appendix A) feeding on the corpse of a giant rat and hungry for more food\\
\end{DndTable}

\subsection{Locations in the Betrayers' Rise}
The following locations are keyed to the Betrayers' Rise map.

\begin{figure*}
\includegraphics[width=\textwidth]{images/adventure/CRCotN/033-map-3.2-Betrayers-Rise.png}
\end{figure*}
...
No check is needed to identify the source of the snoring sound: it comes from the walls. Close examination reveals that the walls have scores of 1-inch-diameter holes drilled into them. As the characters move along the corridor, eyeballs, teeth, and liquid flesh begin to ooze from the holes, pooling on the floor. After 1 round, this grotesque slurry forms into three Gibbering Mouther that attack the characters. One mouther appears at each end of the hall, and the third appears in the middle of the hallway to the west.

\paragraph{Escape Route}
The double door leading to area R1 closes behind the characters unless it is held or wedged open. It glows red when the Jewel of Three Prayers is within 20 feet of it. While the double door is glowing, it opens with a touch; otherwise, it can't be opened.
...
\begin{description}[nolistsep]
\item[Benefit.]
The character has advantage on saving throws against being frightened for the next 24 hours.
\item[Drawback.]
The character has disadvantage on death saving throws for the next 24 hours.
\end{description}
\end{DndComment}
...
Characters are deafened while in this corridor. The only sound any of them can hear is the beating of their own heart.

\paragraph{One-Way Secret Door}
The wall that lies between area R4 and area R3 is a featureless surface when viewed from this side, offering no way of returning to area R3. This one-way passage can't be navigated, except with a passwall spell or similar magic.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/035-03-006.lingering-flameskulls.png}  
\end{figure*}

\subsubsection{R6: Cloister of Penitence}
Opening the door to this room releases three hostile Flameskull—the remains of torturers who served the Betrayer Gods long ago.
...
The two Drider are former drow warriors of the Aurora Watch mutated by the demonic magic of Lolth the Spider Queen. The two Giant Spider in this area have also been tainted, changing their type to Fiend.
...
\paragraph{Treasure}
The corpses are the remains of an Aurora Watch expedition that was trapped in the Betrayers' Rise. A character who searches the bodies finds an onyx-hilted longsword that has become a Longsword of Vengeance haunted by the spirit of its former wielder.
...
\vspace*{1em}
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/036-03-007.stain-glass-mosaic.png}
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/037-03-008.giant-wailing-statue.png}  
\end{figure*}
...
When one or more characters enter the hallway to the south, they hear a loud grinding noise. This is the sound of a stone slab rising from the floor to block the entrance to area R14. This slab has no handle or keyhole. Defeating the fiendish orcs in area R14 or using a knock spell or similar magic causes the slab to sink back into the floor; it can't be moved or breached otherwise.
...
When the characters enter the labyrinth, they're faced with a choice of three paths: one lit by violet continual flame spells, one by red continual flame spells, and one shrouded in impenetrable magical darkness. Following any of the paths leads them to another three-way fork with the same choices available, and then another. The way to get through the labyrinth most quickly is always to take the fork shrouded in darkness.

After choosing three paths, the characters emerge at one of the entrances. If they chose the darkened path all three times, they emerge at the opposite side from where they entered. If they chose any of the illuminated paths, they emerge at the same place where they entered, and each character must succeed on a DC 15 Constitution saving throw or gain 1 level of exhaustion as the endlessly zigzagging pathways drain their resolve.
...
The Fiendish Orc are two Orc War Chief that were once valiant soldiers of the Aurora Watch. Both have been corrupted by demonic magic and have the following changes to their statistics:
...
\begin{itemize}
\item Stone slabs rise from the floor to block the north and south exits (unless both slabs were already closed). A knock spell or similar magic can force a slab to sink back into the floor.
...
A short hallway connects area R14 with the chasm south of it. The archway at the south end of the corridor is carved to resemble the open-mouthed, fanged visage of Gruumsh the Ruiner when seen from inside the chasm. Fire fills one of the visage's eye sockets, courtesy of a continual flame spell.
...
When a creature passes through the gaping mouth of the stone-carved face, a planar rift opens in the floor on the east side of the chasm (see "Abyssal Rift" below), and a hostile vrock flies out of it. The vrock begins searching the chasm for food, attacking the characters on sight.
...
\paragraph{Treasure}
A character who inspects the remains of the two Cobalt Soul explorers finds a cloak of protection and a cracked driftglobe. In its damaged state, the Cracked Driftglobe can be used only to cast the light spell.
...
If a character who has the Jewel of Three Prayers reaches the bottom of the crater, the jewel tugs the character in the direction of the altar, as if it wants to be placed there. If the jewel is placed on the altar, all the characters in this chamber experience the following vision:
...
The next time the characters look at the Jewel of Three Prayers, they find it has transformed into its Jewel of Three Prayers (Awakened) (as described in appendix B). The transformed jewel can be removed from the altar safely.
...
Aloysia is determined to claim the Jewel of Three Prayers. The rival adventurers stand arrayed behind her with their hands on their weapons.
...
Ayo Jabe congratulates the characters for reaching the prayer site and awakening the Jewel of Three Prayers. The rivals not only allow the characters to keep the jewel but also offer to help them return to Bazzoxan. Aloysia is shocked by the rivals' betrayal.
\item[Indifferent Rivals.]
The rivals try to knock the characters unconscious, take the jewel, and give it to Aloysia.
\item[Hostile Rivals.]
Ayo strides to the edge of the crater and snarls, "I guess this is the end of your hunt, huh?" The rivals attack with intent to kill.
\end{description}

\subsubsection{Aloysia's Next Move}
Aloysia carries a satchel that holds three Teleportation Tablet (see appendix B), all connected to the same teleportation circle in Ank'Harel (see chapter 4). Her next actions are determined by who winds up with the Jewel of Three Prayers.

\paragraph{Aloysia Gets the Jewel}
If Aloysia gets the jewel, she uses a teleportation tablet to transport herself to Ank'Harel. She invites the rivals to follow her, assuming they didn't betray her; any creature that enters the circle before the start of Aloysia's next turn is also teleported.

\paragraph{Aloysia Doesn't Get the Jewel}
If the characters retain possession of the jewel, Aloysia loses her temper and begins ranting on her next turn. Midway through her rant, she pulls a scroll from her belt. The scroll is a spell scroll of earthquake, which she casts (choosing the Structures option) as an action on her turn. Aloysia then flees up the passageway, accidentally dropping two Teleportation Tablet while she rummages through her satchel. A huge chunk of stone falls from the ceiling behind her, separating her from the characters and blocking their only exit. On her next turn, she uses her third and final teleportation tablet to escape to Ank'Harel.

Each creature in the prayer site when Aloysia casts earthquake must make a DC 13 Dexterity saving throw, taking 17 (5d6) bludgeoning damage from falling rubble on a failed save, or half as much damage on a successful one.
...
\item[Faction Story Tracks.]
Each of the three major factions that the characters can join has an episodic story track that details how the characters can advance the cause of that faction. These sections consist of "What Lies Beneath" (for the Allegiance of Allsight), "Vermilion Gambits" (for the Consortium of the Vermilion Dream), and "Knowledge Is Power" (for the Library of the Cobalt Soul).
\end{description}
...
The following descriptions of the rivals' actions during this chapter assume that the rivals came to Ank'Harel by means of a teleportation tablet (see appendix B):


\begin{description}[nolistsep]
\item[Friendly Rivals.]
If the rivals are predominantly friendly toward the characters, they cordially part ways after the "Arrival in Ank'Harel" scenario. The rivals find an inn that they make their semi-permanent residence, and a few days later Galsariad shares the address with the characters using a spell scroll of sending.
\item[Indifferent Rivals.]
If the rivals are predominantly indifferent toward the characters, they say farewell after the "Arrival in Ank'Harel" scenario and make no attempt to contact the characters thereafter. Rivals who are friendly with one character might still send an invitation to have lunch with that character from time to time.
\item[Hostile Rivals.]
If the rivals are predominantly hostile toward the characters, they part company with the characters as soon as they are able. Rivals who are still friendly with one character might sheepishly, secretively try to meet that character in the dark of night to swap stories.
\end{description}
...
Characters who use one of Aloysia Telfan's Teleportation Tablet to travel to Ank'Harel arrive on a rooftop overlooking the Suncut Bazaar (see area T8 on the Streets of the Suncut Bazaar map). Read:
...
Aloysia leads the characters inside the storeroom, then asks them to wait while she goes to get someone. After a few minutes, she returns with one of the Consortium's leaders: Vrill the Moth, a lawful evil, elf occult silvertongue (see appendix A).
...
Vrill immediately asks the characters to show her the Jewel of Three Prayers (Awakened), and she returns the jewel to the characters after examining it. She correctly identifies the jewel as a Vestige of Divergence in its Awakened State and asks how the characters acquired it.
...
If Prolix used his teleportation tablet to transport himself and the characters to Ank'Harel, the group arrives inside the Teleportation Atrium of the Crystal Chateau (area S2 on the Streets of the Sigil District map). If Question the tiefling is with them, she arrives here as well. Read:
...
The more charitable of the Allegiance of Allsight's two leaders is Alakritos, a neutral good, goblin scholarly mastermind (see appendix A). The headmaster is pleased to see that Prolix has returned from Bazzoxan safely and offers tea as he listens to Prolix and the characters talk.

Prolix asks the characters to recount their experiences with Aloysia in Bazzoxan. Alakritos listens to them quietly, pondering what the Jewel of Three Prayers must mean to the Consortium if it was willing to go to such lengths to obtain it.
...
\begin{figure*}
\tikz[transform shape,rotate=90] \node{ %[inner sep=0pt] at (current page.center)
\includegraphics[height=\textwidth]{images/adventure/CRCotN/040-map-4.1-Ank_Harel.png}};  
\end{figure*}

\subsection{Lodging}
The Ank'Harel Lodgings table gives examples of lodgings that are available in the city.

\begin{DndTable}[header=Ank'Harel Lodgings]{Xrr}
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/042-04-002.headmasters-allsight.png}
...
\begin{description}[nolistsep]
\item[Leader.]
At 29 years old, Jamil A'alithiya, a chaotic good human, is the youngest monastic high curator (see appendix A) in the history of the Cobalt Soul. He is often underestimated by his contemporaries and uses that fact to his advantage.
\item[Allies.]
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/043-04-003.high-curator-jamil.png}
...
\item[Leader.]
Ironhand Sem, a lawful good minotaur, commands the Hands of Ord and oversees all military operations in Ank'Harel.
\item[Allies.]
...
\item[Leader.]
Once a mercenary in his own right, Quartermaster Croog Lynn, a chaotic neutral, goliath gladiator, has now taken to running the guild in his later years (see the accompanying "Goliaths of Exandria" sidebar).
\item[Allies.]
None.
\item[Opponents.]
None.
...
\item[Leader.]
Watcher Trast, a neutral, elf priest and a former cleric of Ioun, founded the Sentinels of Memory and maintains command over the faction to this day.
\item[Allies.]
...
None.
\item[Leader.]
Twenty-year-old Ilena Hapayhari, a chaotic evil, human assassin and ruthless pirate from the western coast of Marquet, recently disposed of the Veil's old leadership. She now rules the Veil from the shadows, though only high-ranking members are privy to this knowledge.
\item[Allies.]
None.
\item[Opponents.]
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/044-04-005.alluvium-district.png}
\end{figure*}
...
\begin{tikzpicture}[remember picture]
  \node[anchor=north east, align=right, inner sep=0] at (current page.north east){
      \includegraphics[width=0.9\linewidth]{images/adventure/CRCotN/045-04-004.goliaths-of-exandria.png}};
\end{tikzpicture}
  
\begin{DndSidebar}[float=!b]{Goliaths of Exandria}
...
The quarry is run by a gruff, middle-aged miner named Zala Keencutter, a neutral, tiefling thug. Though he puts up an abrasive facade, Zala has a shy and empathetic soul, and he wants dearly to work up the courage to read his prose writings at the Opalite Forum some evening.
...
The shop is run by Bas and Kovra Lyrean, twin sisters who are neutral evil, half-elf Bandit. Originally alchemists by trade, they use their knowledge to brew magic potions deemed by the Hands of Ord to be too dangerous for public consumption.
...
The Allegiance of Allsight scholar Carliale Kroogan, a neutral good, gnome scholarly excavator (see appendix A), is currently the chief supervisor for the Life Dome. Lonely and a bit of a chatterbox, Carliale is always ready to chat about arcane theory with any individual who comes his way.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/047-04-007.sigil-district.png}
\end{figure*}
...
\begin{figure*}
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/048-map-4.2-Streets-of-the-Sigil-District.png}
\end{figure*}
...
Jor Raashid, a lawful neutral, halfling scholarly agent (see appendix A), is the gatekeeper for the Crystal Chateau. Suspicious and condescending, Jor sternly prohibits nonmembers from entering the Chateau.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/050-04-009.suncut-bazaar.png}
\end{figure*}
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/051-map-4.3-Streets-of-the-Suncut-Bazaar.png}
\end{figure*}[t]
...
\item[T2: Battlements.]
The walls of the Suncut Bazaar are made of sandstone and patrolled day and night by Hands of Ord Guard and Veteran.
...
The Bone Garden is run by Rerosha, a chaotic good, human acolyte who's a nonverbal young woman with a brazen attitude toward life. She uses facial expressions, gestures, and a sassy gray parrot named Akil to communicate.
...
First Eclipse is owned and operated by Satzrak Runestrider, a neutral evil, blue dragonborn occult extollant (see appendix A). He is a loyal member of the faction, and he longs to keep the Consortium headquartered at his place permanently; the group has already used the tavern for three months longer than originally planned, so his hopes are up.
...
The casino is owned and run by Adima Shemsilver, a chaotic neutral, halfling noble who walks with the confidence of someone twice his height. Adima secretly uses half of the casino's earnings to fund the Veil, as his family has done for generations.
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/053-04-008.ruidium-elephant.png}

\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/054-04-010.corrupted-ruidium-figurine.png}
\end{figure*}
...
When a character tries to retrieve the figurine, it reacts as if it had been activated, transforming into a crystalline version of the creature it was meant to become (use the ruidium elephant stat block earlier in the chapter). This creature can't be controlled.
...
If the characters keep the elephant figurine for themselves, the elephant it creates uses the ruidium elephant stat block (see earlier in the chapter) and can't be controlled.

If the characters slay or redeem the Apotheon (see chapter 7), the figurine is rid of its ruidium corruption and functions like a normal Figurine of Wondrous Power, Marble Elephant.
...
\subsubsection{Getting the Mission}
Early one morning, Prolix Yusaf meets with the characters:
...
When they see that the characters survived the surge, two Invisible Stalker move in for the kill. The Invisible Stalker were summoned by Professor Lymmle Wist and infiltrated the Life Dome a short time ago without Carliale's knowledge, slipping through the entrance as the gnome arrived for work. The Invisible Stalker focus their attacks on the characters, ignoring Carliale.

After the battle, Carliale suspects that the invisible stalkers' summoner is associated with either the Consortium of the Vermilion Dream or the Sentinels of Memory. He describes these factions to the characters if they ask about them (see "City Factions" earlier in the chapter).

Characters who encountered the invisible stalker at Mystic Pursuits (described earlier in the chapter) might assume that Amkezne, the owner of that shop, is behind the Life Dome incident. Amkezne denies any involvement and is telling the truth. If the characters use magical coercion or threaten to report her to the Hands of Ord, Amkezne tells them that she learned how to summon Invisible Stalker in her final year at the Crystal Chateau and that the professor who taught her the arcane ritual was Lymmle Wist (see mission 3 of this story track).
...
If this mission is successful, Prolix recommends the characters to Headmaster Gryz Alakritos as potential new members. Within a week, Alakritos presents each character with a formal invitation to join the faction's ranks. Membership comes with the following benefits:
...
Lymmle previously owned a ring of red fury (see appendix B), which was given to her by the Consortium as a reward for her services. She has decided to use the ring as part of a grander scheme. Recently, with the Allegiance of Allsight on high alert after the attack at the Life Dome, Lymmle planted the ring on Prolix Yusaf and plans to falsely accuse the tiefling of being a traitor. Her contact with the ruidium in the ring has left its mark on her skin.

\subsubsection{Getting the Mission}
The characters notice a dark figure clumsily following them as they stroll through Ank'Harel one night. Confronting the figure reveals it to be a harried and distressed Prolix Yusaf, who immediately asks if they can talk in private.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/055-04-011.maw-of-cael-morrow.png}
\end{figure*}[t]

\begin{description}[nolistsep]
\item[Expeditions to Cael Morrow.]
The records contain only one mention of a ring: in the inventory of an expedition from two months ago, which was staffed by agents Anbara Flintbreaker and Idris Lornen and led by Professor Lymmle Wist. The log indicates that the group was accosted by a thief on its way back to the surface, but mention of what was stolen is missing from the record.
\item[Sentinels of Memory.]
Allegiance documents confirm that the Sentinels of Memory are a new faction, established at around the time the project to explore the sunken ruins began. The documents assert that the Sentinels of Memory believe the so-called "Under-Temple" is a prison, meant to be kept sealed and forgotten.
\item[Ruidium.]
The name coined by the Consortium of the Vermilion Dream to identify the reddish mineral found in the ruins of Cael Morrow has entered the academic lexicon. The extent of its properties has yet to be known, but early reports say that the mineral produces red crystalline veins in other substances—inorganic and organic alike—that remain in prolonged contact with it.
\end{description}
...
Anbara and Idris (lawful neutral, human Acolyte), the two agents from the expedition that recovered the ring, vaguely recall being attacked during their work, but they can't provide any details. A character who succeeds on a DC 15 Intelligence (Arcana) or Wisdom (Insight) check discerns that this claim of ignorance is not a lie—Anbara and Idris have had their memories of the incident tampered with. Restoring their memories with a remove curse spell or similar magic causes them to recall that Professor Wist led the group through a wrong turn, to an area where they were accosted by an armed ruffian. They were knocked out in the ensuing scuffle, but they can't identify who cast the spell or wielded the weapon that incapacitated them.

If Lymmle Wist (a neutral evil, human mage) is questioned, she deftly addresses the characters' inquiries, and her responses conform to the expedition records. A character who succeeds on a DC 16 Wisdom (Insight) check notices a guarded expression in her eyes and a terse undertone in her voice, indicating her discomfort. Characters who have a passive Wisdom (Perception) score of 15 or higher notice thin, elevated red veins encircling the base of her right ring finger—the result of her exposure to the ring of red fury before she planted it on Prolix.

\subsubsection{Infiltrator Exposed}
The characters can present their findings to Headmaster Gryz Alakritos (see "City Factions" earlier in the chapter) and make a DC 18 Charisma (Persuasion) check. The DC drops to 13 if Anbara and Idris are with the characters and at least one of them has had their memory restored. On a successful check, the headmaster immediately dispatches agents to apprehend Lymmle.

The characters can confront Lymmle directly by going to her office in the Crystal Chateau. Lymmle initially denies the accusation, then tries to turn the tables on the characters by accusing them of having ulterior motives. When it becomes clear to her that the characters are insistent, she casts fly on herself and tries to escape by smashing through the window behind her desk. If she's unable to escape, Lymmle fights to the death.
...
In gratitude, Prolix lets the characters keep the ring of red fury (see appendix B) as long as they promise to share anything they learn about the ring's properties.

\subsection{Allegiance Mission 4: The Double Agent}
Seven days after their previous mission for the Allegiance of Allsight, the characters are summoned to meet with Headmasters James Cryon and Gryz Alakritos in Cryon's office at the Crystal Chateau. The headmasters want the characters to find a double agent who is undermining the Allegiance's activities in the ruins of Cael Morrow.
...
James Cryon is a condescending elitist, while Gryz Alakritos is less abrasive and more down-to-earth. Each, in his own way, has the best interests of the Allegiance of Allsight at heart. They brief the characters on the following details that Allegiance spies have uncovered:
...
The number of workers in the Cael Morrow archaeological expedition has dwindled recently. Currently, only Professor Insight Acuere, a kenku named Scribble, and a goliath named Xot are there. None of them is the double agent.

If the characters ask Professor Acuere about other members of the expedition, she mentions that many excavators have been lost. She seems most interested in learning the fate of her friend Galeokaerda, an adjunct professor of ancient literature at the Crystal Chateau. Unknown to Professor Acuere, Galeokaerda is the Consortium spy.
...
\begin{description}[nolistsep]
\item[Maw of Cael Morrow.]
This location is the entrance to the Drowned City (see the "Maw of Cael Morrow" section earlier in the chapter).
\end{description}

\paragraph{Allegiance Base Camp (Chapter 5, Area M3)}
This site is the center of Allegiance operations in Cael Morrow. Professor Insight Acuere runs the show from here.

\paragraph{Hall of the Royal Library (Chapter 5, Area M7a)}
Here is where the spy, Galeokaerda, can be found. She is trying to find the so-called Key to the Netherdeep. If seven days pass before the characters reach this location, she is gone.

\paragraph{Cliffside Villa (Chapter 5, Area M13)}
This site is where the characters can find the Key to the Netherdeep that Galeokaerda is searching for. If seven days pass and the characters haven't defeated Galeokaerda, the key is gone.

\subsubsection{Returning to the Chateau}
If the characters defeat Galeokaerda, the headmasters give them the 1,000 gp reward as promised, and Alakritos tells them to expect their next mission in a week's time. If the characters bring back the ruidium greataxe (the Key to the Netherdeep), they are awarded an additional 1,000 gp.
...
If the characters acquired the Key to the Netherdeep in the previous mission, they have already accomplished their first goal. In that case, Cryon gives the greataxe to them so they can use it to open the rift. He also offers each character a potion of water breathing, in case they have no other way to navigate the water-filled areas of Cael Morrow.
...
\begin{description}[nolistsep]
\item[Maw of Cael Morrow.]
This location is the main entrance to the Drowned City (see the "Maw of Cael Morrow" section earlier in the chapter).
\end{description}
...
This structure is Alyxian's final prayer site. If the characters haven't acquired the Key to the Netherdeep, advancing the Jewel of Three Prayers to its Jewel of Three Prayers (Exalted) at this prayer site will enable them to enter the rift.
...
If the party agrees to undertake the mission, the headmasters equip each character with a ruidium dagger. The headmasters' reward for completion of this mission is a promotion to the upper ranks of the Allegiance of Allsight and 5,000 gp each.
...
\begin{DndSidebar}[float=!b]{Which Faction Should the Rivals Join?}
...
If the characters enter First Eclipse (see the "Suncut Bazaar" section earlier in the chapter), they are greeted by the bartender, Satzrak Runestrider, a neutral evil, blue dragonborn occult extollant (see appendix A). If they ask him about the Consortium, he gives each of them a drink on the house and tells them to keep quiet. When they finish their drinks, Satzrak hisses, "Go home and wait for a letter."
...
The "ghost" is Shira, a shy, anxious 15-year-old human with innate spellcasting ability. Fearing for the safety of those around her as she learns to control her powers, Shira has taken to using the shrine as a nighttime hiding place. She mimics the behavior of a spirit to frighten away others.

Shira is a chaotic good, human commoner, with the following additional action option:

\begin{DndComment}{}
\subparagraph{Spellcasting}
Shira casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 10, +2 to hit with spell attacks):

At will: \textit{chill touch}

1/day each: \textit{blindness/deafness, ray of sickness}

\end{DndComment}

Shira uses her spells to drive away intruders. A character can use an action to try to force her to surrender, doing so with a successful DC 14 Charisma (Intimidation or Persuasion) check, whereupon Shira breaks down into tears and ceases her attacks. Only then can she be convinced to try to find another place in the city to sleep. She will grudgingly accept being taken in by a foster parent, if the characters offer to help her with this solution.

\subsubsection{A Home for Shira}
If the characters want to find a safe home for Shira and bring her to First Eclipse for that purpose, Satzrak the bartender shows a soft side of his persona and offers her a small, private room in the tavern, along with free room and board if she's willing to perform simple chores and "not make trouble." Satzrak is inwardly happy to be a kind, loving father figure to Shira.

\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/056-04-012.koris-flees.png}  
\end{figure*}
...
Inside the Consortium's hidden storeroom in the back of the tavern, the characters find Aloysia Telfan. If Aloysia died earlier in the adventure, replace her with another occult initiate (see appendix A), and modify the following text accordingly:
...
When the characters get to Luck's Run, Security Captain Nedosi Anay, a neutral, half-orc veteran, brusquely briefs them. She relays the following information:
...
Nedosi wants two characters to station themselves right outside the coin vault while the rest patrol the casino's ground floor with her. If the characters don't have the ability to communicate with each other from a distance, she gives each of them a fully charged earring of message (see appendix B) to use for the night before ordering them to their posts. She demands that the characters use force only if necessary, and only of the nonlethal variety.

\paragraph{Casino Floor}
At night the casino is crowded, as people filter in after work has finished for the day to try their hand at one of the casino's games. Each floor of the casino is patrolled by four Guard; in addition, the ground floor is staffed by ten Commoner. A pair of finely upholstered spiral staircases in the back of the building connects the three floors. Each staircase is magical and functions like an escalator—one has stairs that carry patrons upward, while the other has stairs that move downward.
...
The vault is 10 feet in diameter and rises 20 feet to the apex of the casino's domed ceiling. It appears to have no door, but a character who examines the vault and succeeds on a successful DC 20 Intelligence (Investigation) check finds a thin keyhole near its base. The vault's lock can be opened by using a master key, which only Nedosi and Adima possess, by a character who makes a successful DC 21 Dexterity check using thieves' tools, or by magic. Nedosi has her copy of the master key on her person.

\paragraph{Vault Trap}
If the vault is opened by any means other than using the master key, the vault's magical trap is triggered. Each creature within 5 feet of the vault must make a DC 16 Wisdom saving throw. On a failed saving throw, a creature takes 36 (8d8) psychic damage and is stunned for 1 minute. On a successful save, a creature takes half as much damage and isn't stunned.

The trap can't be disarmed, but successfully casting dispel magic (DC 15) on the lock before an attempt is made to open it suppresses the trap for 1 minute, allowing the lock to be manipulated without negative consequences.
...
\begin{itemize}
\item Ena (neutral, human berserker) masquerades as a casino patron.
\item Duskwood (chaotic neutral, half-elf spy), like Ena, masquerades as a casino patron and wears a hat of disguise.
\item Koris (lawful neutral, tiefling assassin), the crew's leader, works at one of the casino's card tables—a job she has held for about a month. She carries a potion of gaseous form, a tiny packet containing dust of disappearance, and a bag of holding.
\end{itemize}

If any of the thieves are confronted before they can pull off the heist, they try to flee the casino and foil any pursuers by running through the streets. Resolve such a chase using the chase rules and the Urban Chase Complications table in the Dungeon Master's Guide.
...
\begin{description}[nolistsep]
\item[Stage 1:]
Lead-Up. Ena, Duskwood, and Koris begin on the ground floor of the casino. A character who scans the crowd and succeeds on a DC 11 Wisdom (Insight) check notices Ena's disinterest in the dice game she's standing at. Shortly thereafter, Duskwood begins chatting with one of the guards near Nedosi, and a character who succeeds on a DC 15 Wisdom (Insight) check notices the half-elf watching someone over the shoulder of the guard.
\item[Stage 2:]
Infiltration. Characters on floor duty who know thieves' cant or have a passive Wisdom (Perception) score of 15 or higher notice the three thieves flashing quick hand signals to each other. Koris abruptly excuses herself from the game she's running and heads toward the employee area; a character who succeeds on a DC 13 Dexterity (Stealth) check can follow her without being noticed. If she is detained, Koris explains that she's on the way to collect winnings for one of her patrons, but a character who succeeds on a DC 13 Wisdom (Insight) check sees through the lie. If she is not prevented from doing so, Koris imbibes a potion of gaseous form and enters one of the coin chutes that connect with the vault.
\item[Stage 3:]
Coin with Two Heads. When Koris has entered the coin chute, Ena stands up from her seat and starts berating the guard whom Duskwood is chatting with. As Nedosi tries to break up the fight, Duskwood lifts the casino master key from her pocket, an act that a character on floor duty can spot with a successful DC 14 Wisdom (Perception) check. Duskwood then ascends the spiral staircase and uses their hat of disguise to assume Nedosi's visage before arriving on the third floor. A character who succeeds on a DC 13 Intelligence (Investigation) check sees through Duskwood's trick as the thief approaches the vault.
...
Aradrine wants the characters to retrieve a Figurine of Wondrous Power, Marble Elephant in the shape of an elephant that has been affected by ruidium. She believes the figurine is being kept inside the Crystal Chateau. She asks the characters to press the Crystal Chateau's gatekeeper, Jor Raashid, for information.
...
\paragraph{Treasure}
A short flight of stairs descends into the main chamber of the vault. Square alcoves line the walls, and inside one of them is the Figurine of Wondrous Power, Marble Elephant.

Most of the other alcoves are empty, but a thorough search of the vault also yields a set of Nolzur's marvelous pigments and a wand of wonder.

\subsubsection{Hasty Getaway}
If the characters aroused Kareema's suspicions or activated the trap in the basement vault, they are intercepted as they exit the hall by Headmaster James Cryon, a lawful neutral, elf scholarly mastermind, and two lawful neutral Scholarly Excavator serving as bodyguards (see appendix A for their stat blocks). Headmaster Cryon is willing to talk as long as the characters seem willing to relinquish the figurine, but if any character tries to escape with it, Headmaster Cryon and his bodyguards attack.
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/057-04-013.master-aradrine-the-owl.png}

\subsubsection{Returning with the Elephant}
Master Aradrine is delighted if the characters deliver the elephant figurine to her, and she allows them to keep any plunder they gained from their mission. In addition, she makes arrangements to have one ruidium weapon or a suit of ruidium armor of their choice (see appendix B) delivered to them within 1d6 days.

\subsubsection{Keeping the Figurine}
The characters can keep the elephant figurine, but they would be wise not to use it, for the elephant it creates uses the ruidium elephant stat block (see earlier in the chapter) and can't be controlled.

If the characters slay or redeem the Apotheon (see chapter 7), the figurine is rid of its ruidium corruption and functions like a normal Figurine of Wondrous Power, Marble Elephant.

\subsubsection{Mission Failed}
If the characters return to Aradrine without the figurine, the goliath beholds them coolly and snarls, "I have precious little sympathy for failures. Get out of my sight." Characters who beg for Aradrine's forgiveness only anger her further. If they refuse to leave, she calls in six Occult Initiate (see appendix A) to remove them.

After a week of silence, the characters receive a letter from Aloysia Telfan. If Aloysia died earlier in the adventure, the letter is sent by another Consortium agent (modify the following text accordingly):
...
\begin{itemize}
\item A Consortium agent named Galeokaerda has infiltrated the archaeological site in Cael Morrow by posing as a member of the Allegiance of Allsight and befriending some Allegiance excavators.
\item Galeokaerda reports that a rift has been opened in Cael Morrow, but no one can enter it without the proper key. Diviners hired by the Consortium claim that an object known as the Key to the Netherdeep, a greataxe encrusted with ruidium, lies somewhere in Cael Morrow.
\item Aradrine fears that the Allegiance might be suspicious of Galeokaerda and doesn't want to risk losing the key.
\end{itemize}
...
\item Rendezvous with Galeokaerda, who says she will be waiting inside Cael Morrow's Royal Library (area M7a in chapter 5).
\item Secure the Key to the Netherdeep. (Unknown to Aradrine at this time, any ruidium weapon can be used as the key.)
\end{itemize}
...
Galeokaerda is here, searching for the Key to the Netherdeep. If three days pass before the characters reach this area, Galeokaerda has been found and killed by the characters' rivals, who are in league with the Allegiance of Allsight.

\paragraph{Cliffside Villa (Chapter 5, Area M13)}
This site holds the Key to the Netherdeep: a ruidium greataxe. If three days pass before the characters reach this location, the key has already been removed by the characters' rivals.
...
The Alyxian Aboleth lairs here, though the characters might encounter it elsewhere.
...
\begin{itemize}
\item To open Cael Morrow's rift to the Netherdeep, one needs a ruidium weapon (see appendix B). The Consortium has determined that any such weapon functions as a Key to the Netherdeep.
...
\begin{itemize}
\item Enter the Netherdeep. If the characters don't have at least one ruidium weapon in their possession to serve as a Key to the Netherdeep, Aradrine gives them the ruidium greataxe they retrieved in mission 4, assuming that mission was successful. (In its Exalted State, the Jewel of Three Prayers also enables travel through the rift.)
...
\subsubsection{Getting the Mission}
If the characters arrived in Ank'Harel with Question, the tiefling scholar they met in Bazzoxan in chapter 3, she greets them at their lodgings the morning after their arrival. Question knocks on the characters' door and cheerfully states that her superior, Iwo Zalarre (a chaotic good, half-orc monastic operative; see appendix A), wants to speak with them. If the characters accept the meeting, Question takes them to the Temple of the Mentor, the headquarters of the Cobalt Soul in Ank'Harel (see "Temple of the Mentor" earlier in the chapter).
...
The person of interest is a chaotic evil half-elf named Laurin Ophidas. He uses the cult fanatic stat block, with these changes:


\begin{itemize}
\item He has immunity to poison damage and the poisoned condition.
\item He wields a staff of the adder and is attuned to it as though he were a cleric.
\end{itemize}

\subsubsection{Ophidas's Motives}
Laurin Ophidas is a disgraced member of the Cerberus Assembly, an organization of spellcasters in the Dwendalian Empire in Wildemount. He fled from that organization after stealing a staff of the adder from a superior. Convinced that the assembly's assassins are pursuing him, Ophidas is trying to locate other Zehir cultists in the city who will protect him. His search is not going well.
...
If the characters accost Ophidas in public, he hollers for the Hands of Ord. Five Hands of Ord Knight arrive 3 rounds later. If the characters are still nearby when the Hands arrive, the guards try to arrest them and hold them overnight. If they don't resist, the characters are detained in a Sigil District jail, then released the next morning and assessed a fine of 50 gp each for disturbing the peace. While the characters are cooling their heels in jail, Ophidas (who is questioned by the Hands of Ord but not arrested) collects his belongings and disappears. The characters have no chance of finding him again.

\paragraph{Success}
If the characters report back to Iwo with the truth about Ophidas's motives, Iwo assures the characters that they'll be called upon again in a few days' time and gives them one stone from a pair of sending stones for future communication.
...
\subsubsection{Getting the Mission}
Seven days after the characters successfully finish their first mission, Iwo Zalarre sends one of them a message via Sending Stones. Whichever character has the matching stone receives the message, which is as follows:
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/058-map-4.4-River-District-Canal.png}
\end{figure*}
...
\begin{description}[nolistsep]
\item[Q1: Old Man Kruuk's.]
This establishment is described in the "Bakery by the Canal" section below.
\item[Q2: Trees.]
Several giant cedar trees grow in this district.
\item[Q3: Canal.]
This 5-foot-deep, 20-foot-wide canal is one of many such watercourses in the River District. The canals have ropes or bridges over them to make pedestrian travel through the district easier.
\end{description}
...
The front door is unlocked, and a small silver bell on the door jingles as it's opened. Unsold items are still sitting in their display cases. Old Man Kruuk, a neutral, half-orc bandit captain, sits behind the counter, counting the day's proceeds.
...
In the center of Kruuk's property is a grass-covered courtyard. It has wooden doors leading to all four rooms surrounding it. These doors are locked, but any of them can be opened by using a key Kruuk keeps on his person. A lock can be picked by a character who makes a successful DC 16 Dexterity check using thieves' tools. A door can be broken down by a character who makes a successful DC 11 Strength (Athletics) check.

\paragraph{Q1e: Back Room}
The exterior door on the west wall is locked. The lock can be picked by a character who makes a successful DC 15 Dexterity check using thieves' tools. The door can be broken down by a character who succeeds on a DC 11 Strength (Athletics) check, but the noise alerts anyone in the building.
...
A character who makes a successful DC 15 Intelligence (Investigation) check locates a metal lockbox stowed underneath an upside-down crate in a corner of the room. The lockbox can be opened by a character who makes a successful DC 21 Dexterity check using thieves' tools. It can also be pried open with a successful DC 16 Strength (Athletics) check. If the box is forced open, poison gas sprays outward, and the character who opened it must succeed on a DC 15 Constitution saving throw or take 22 (4d10) poison damage and be poisoned for 1 hour.

The lockbox holds the ruidium shortsword that Kruuk plans to sell (see "A Deal Goes Down" below). If the characters have gained Kruuk's trust, he opens the lockbox to show them the sword, then explains its magical properties (see appendix B).
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/060-04-014.ashann.png}  
...
If Ashann has been taken out of the equation, a character can convince Kruuk to sell the shortsword for 500 gp by succeeding on a DC 14 Charisma (Intimidation or Persuasion) check, either by threatening his life or by convincing him that the characters are interested in being repeat customers.

\paragraph{Urban Chase}
The characters can wait to snatch the ruidium shortsword from Ashann after her deal with Kruuk is done, in which case Ashann tries to flee with the sword rather than fight, resulting in a chase (use the chase rules and the Urban Chase Complications table in the Dungeon Master's Guide). If Ashann is caught, she fights to keep the ruidium shortsword but surrenders it if she is reduced to 10 hit points or fewer.

\subsubsection{Returning to the Temple}
Iwo is happy to receive the ruidium shortsword and hands over the agreed-upon reward in exchange for it. Iwo is careful not to touch the weapon bare-handed. (After examining the sword carefully for a few days, the monks of the Cobalt Soul destroy it to ensure that it doesn't corrupt anyone.) If the characters seem reluctant to part with the sword, Iwo warns them that the weapon might be dangerous to its wielder. If necessary, Iwo increases the reward to 1,000 gp, hoping the extra coin will convince the characters to part with the weapon.

If the characters have Kruuk, Ashann, or both in their custody, Iwo has the criminals detained until the Hands of Ord can be summoned to take them away.

\subsubsection{Joining the Cobalt Soul}
Seven days after the characters successfully complete this mission, the archivists of the Cobalt Soul deem them worthy and motivated enough to join their organization as full members. The characters receive a brief, congratulatory message from Iwo via Sending Stones. Membership comes with the following benefits:
...
\item New members can buy the following magic items at the Temple of the Mentor: a spell scroll of detect magic (10 gp), a spell scroll of divination (125 gp), a spell scroll of commune (250 gp), and a pair of sending stones (250 gp).
\end{itemize}
...
After the Cobalt Soul receives reports of strange happenings in the Suncut Bazaar, High Curator Jamil A'alithiya surmises that the Consortium of the Vermilion Dream must be making progress researching the crimson substance known as ruidium. Concerned about the potentially destructive repercussions if the Consortium learns how to use it, Jamil sends the characters to infiltrate the Consortium's headquarters.
...
Jamil A'alithiya, a neutral good, human monastic high curator (see appendix A), offers a reward of 1,000 gp for completing the mission.
...
This combat encounter takes place on the Streets of the Suncut Bazaar map. The crystalline creatures are two Ruidium Elephant (see their stat block earlier in the adventure). These elephants are running amok and must be destroyed before they cause any further damage.

The first elephant that drops to 0 hit points turns into a tiny marble elephant Figurine of Wondrous Power, Marble Elephant with thin veins of ruidium running through it.
...
\subsubsection{First Eclipse}
The elephants were released by Khelkur the Gull, a neutral evil, dwarf occult silvertongue who's one of the masters of the Consortium of the Vermilion Dream. He and the bartender, Satzrak Runestrider, a neutral evil, blue dragonborn occult extollant (see appendix A for both stat blocks), are in First Eclipse's taproom, celebrating the success of their experiment. The tavern is otherwise empty.
...
Seven days after they complete the previous mission, the characters are invited to the Temple of the Mentor to meet with High Curator Jamil A'alithiya, who plans to send them on a mission in the Drowned City.
...
\begin{itemize}
\item Enter Cael Morrow and rendezvous with Professor Insight Acuere at the Allegiance of Allsight base camp.
\item Earn Insight Acuere's trust and learn how to access the Netherdeep.
...
The characters can meet Insight Acuere in the Allegiance base camp (area M3 in chapter 5). She tells them that her companions are searching for the writings of an ancient hero who tried to save Cael Morrow from destruction during the Calamity. Earlier expeditions found dozens of stone tablets from the period in question at the south end of the excavation site. Her team, however, no longer has the force of arms to fight the dangerous creatures that lurk in this region. If the characters can find more of these tablets and return them to her, she'll be grateful.

\paragraph{Insight's Reward}
If the characters bring back the tablet from area M10 in chapter 5, Insight Acuere shares the following information:


\begin{itemize}
\item Insight Acuere reveals the location of the rift leading to the Netherdeep (area M17 in chapter 5) and informs the characters that weapons infused with ruidium can open this rift.
\item Insight Acuere believes there might be keys to the rift in Cael Morrow—left behind by agents of the Consortium of the Vermilion Dream.
\end{itemize}
...
This location contains the tablet that Insight Acuere seeks.

\paragraph{Cliffside Villa (Chapter 5, Area M13)}
The "key" to enter the Netherdeep can be any ruidium weapon. Such an item can be found in this sunken villa.
...
\paragraph{Temple of the Arch Heart (Chapter 5, Area M9)}
This location is Alyxian's final prayer site. Accessing it is necessary to unlock the full power of the Jewel of Three Prayers.
...
The Alyxian Aboleth attacks the characters on sight. As an action, a character claiming to be Alyxian's friend or ally can try to persuade the aboleth to leave the party alone, doing so with a successful DC 25 Charisma (Persuasion) check, or DC 15 if that character presents the Jewel of Three Prayers.
...
\item To survive the underwater pressure of the Netherdeep, one needs an item at least partially made of ruidium. (The Jewel of Three Prayers also allows its wearer to withstand the pressure.)
\end{itemize}
...
By the time the characters meet them again in Cael Morrow, the rivals have changed dramatically. They now use their tier 3 stat blocks (see appendix A). The changes the rivals have undergone are as follows:

Ayo Jabe (Tier 3). Ayo's drive to prove herself a hero, and to prove herself superior to the characters, has brought her to this place. She is aware of the trauma that her quest has put her friends through. This feeling has led her to doubt her leadership abilities. Ayo is filled with cold fury toward anything that stands in her way, including her own insecurities.

Dermot Wurder (Tier 3). Dermot's desire to protect his friends is still at the core of his being. But dozens of battles and near-death experiences have turned his uncertainty into steely confidence.

Galsariad Ardyth (Tier 3). Galsariad's haughtiness has drained from his heart—as have all his other emotions. He has witnessed unspeakable horrors in the name of gaining greater magical power and has protected himself from being overcome by fear and self-loathing by suppressing all his feelings.

Irvan Wastewalker (Tier 3). Irvan's cavalier demeanor disappeared when he lost his arm in a battle with a slithering bloodfin in Cael Morrow. His faction allies fitted him with a stylish and functional arcane prosthetic, but this brush with death has made him short-tempered, cautious, and mistrustful. Irvan fears that any further mistake could cost him his life—permanently.

Maggie Keeneyes (Tier 3). A deep melancholy has taken root in Maggie's heart. She continues the mission out of love for Ayo, but she fears that her leader's determination might not be enough to achieve victory. Maggie doesn't trust the Allegiance of Allsight agents in Cael Morrow (even if the rivals have allied with that faction), believing them to be influenced by a malevolent force. She has shared her misgivings about this organization with Ayo on several occasions.
...
The barriers are soundproof, and their edges overlap with walls, doors, ceilings, and floors without harming those features. In places where a barrier overlaps with a stone wall, door, ceiling, or floor, it is invisible and untouchable.
...
\begin{DndTable}[header=Poisoned Emotions]{cXX}
...
d12 & Encounter\\
1 & A swarm of sorrowfish (see appendix A) flocks around the detritus of a shark's corpse, ravenous for more prey.\\
2 & Three Scuttling Serpentmaw (see appendix A) search for food.\\
3 & A giant octopus wrestles with a locked chest. The chest contains 1,000 ep in coins minted long ago in Cael Morrow.\\
4 & Tentacles burst from the darkness as a death embrace (see appendix A) notices the characters.\\
5 & Two Slithering Bloodfin (see appendix A) streak through the water, eager for a meal.\\
6 & Two aboleth spawn (see their stat block later in the chapter) spot the characters and flee to alert the Alyxian Aboleth, which appears 1 minute later.\\
7–12 & No encounter occurs.\\
\end{DndTable}

\begin{figure*}
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/062-map-5.1-Cael-Morrow.png}
\end{figure*}

\subsection{Cael Morrow Locations}
...
The person near the door is a sullen, lawful neutral orc named Gortag Inkdrinker (use the scholarly agent stat block in appendix A). The characters can surprise him if they act quickly. If the characters are members of the Allegiance of Allsight or the Library of the Cobalt Soul, Gortag treats them as allies and invites them to meet with his superior, Professor Insight Acuere, in the Allegiance base camp (area M3). If the characters accept the invitation, he escorts them there.

If one or more characters aren't wearing Allegiance badges or claim to be in league with the Consortium of the Vermilion Dream, Gortag tells them to halt and return up the stairs and does his best to hinder their progress without provoking conflict. If combat breaks out, he opens the door he's guarding, pushes himself through the magical barrier that extends across the doorway (see "Features of Cael Morrow" earlier in the chapter), and alerts the guards in area M2. If he's successful, he runs to area M3 to warn Insight Acuere that enemies have entered the Drowned City. If Gortag is unable to flee, he throws himself on the characters' mercy and can be persuaded to lead the party past the guards in area M2, if only to avoid harm.
...
Two Scholarly Agent (see appendix A) stand outside the door to area M3. One is a lawful neutral human named Kal, and the other is a lawful good halfling named Nadiya.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/064-05-002.allsight-base-camp.png}  
\end{figure*}
...
The Allegiance's base of operations in the ruins is maintained by an adjunct professor of archaeology named Insight Acuere, a lawful good tiefling. Most of her team has been recalled to the Crystal Chateau, but she still has two research technicians helping her: the laconic Scribble, a chaotic neutral kenku, and the rambunctious Xot, a neutral good goliath (see the "Goliaths of Exandria" sidebar in chapter 4). See below for their statistics and roleplaying information.

Nearly inseparable, Scribble and Xot have been working together at the camp for months. They complement each other as friends and scholars. Xot tends to talk ceaselessly about her latest discoveries, and Scribble patiently listens, absorbing many of Xot's excited ramblings into his own speech.

If Insight Acuere, Scribble, and Xot become hostile toward intruders, they fight to kill. On the first turn of combat, Insight Acuere uses a sending stone to contact Headmaster Cryon in the Crystal Chateau and request aid. Twenty minutes later, ten Scholarly Agent and five Scholarly Excavator (see appendix A for both stat blocks) arrive by way of area M1 to secure the base camp.

\paragraph{Insight Acuere}
The Insight Acuere uses the scholarly mastermind stat block (see appendix A), with these changes:
...
Insight Acuere won't cooperate with the Consortium of the Vermilion Dream unless she is tricked or magically compelled into doing so. If the characters are members of the Allegiance of Allsight, Insight Acuere informs them that they have arrived earlier than she expected, but she's nonetheless happy to see them. If they're allied with the Cobalt Soul, she requires them to prove their usefulness before she reveals any information (see "Insight's Quest" in mission 4 of the Cobalt Soul Story Track in chapter 4).

Insight Acuere is the primary archivist for the Cael Morrow archaeological project and would put her life on the line to ensure its success. She is willing to share the results of her research with fellow Allegiance members. Insight Acuere can offer the following information in response to the characters' questions:
...
\item A fourth member of the expedition, Insight Acuere's friend Galeokaerda, a high elf professor of ancient literature, hasn't been seen in three days. Insight Acuere is concerned but hasn't yet considered raising a search party because Galeokaerda has a shield guardian to protect her.
\end{itemize}

\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/065-05-003.professor-insight-acuere.png}

\paragraph{Scribble}
Scribble uses the scholarly agent stat block (see appendix A), with this change:


\begin{itemize}
\item Scribble understands Auran and Common but speaks only through mimicry. He can imitate any sounds he has heard, including voices.
\end{itemize}

Scribble seems pleasant enough, but a character who spends more than 10 minutes with him can tell that the kenku is haunted. While scouring Cael Morrow for relics, he received telepathic threats from the Alyxian Aboleth but lacks the vocabulary to convey the horror of that experience; however, he can repeat any of the phrases listed on the Poisoned Emotions table.

\paragraph{Xot}
This goliath uses the scholarly excavator stat block (see appendix A), with these changes:


\begin{itemize}
\item Xot speaks Common and Giant.
...
If the characters are members of the Allegiance of Allsight or if they succeed on a DC 14 Charisma (Deception or Persuasion) check, Xot shows them the items she and Scribble have stored on the second floor of the building. She explains that these objects were deemed too damaged or insignificant to warrant their transport topside, but she found them too charming to discard entirely.

Xot's collection consists of ancient baubles, rusted spear heads, and worthless bits of jewelry—but a character who makes a successful DC 12 Intelligence (Investigation) check finds a ring of the ram and a sludgy but still potent Potion of Superior Healing. Xot can be convinced to give up these two items from her collection by a character who makes a successful DC 18 Charisma (Persuasion) check.

\paragraph{Double Agent}
Characters who are following the Allegiance Story Track might come to Cael Morrow hoping to expose a double agent in the expedition. A character who speaks with Insight Acuere, Scribble, or Xot can make a DC 15 Wisdom (Insight) check to get a sense of that person's loyalty. On a successful check, it's apparent to the character that the individual is fully dedicated to the expedition and doesn't have any intention of betraying their faction.
...
\paragraph{Treasure}
Any character who spends 10 minutes searching through the rubble can make a DC 20 Intelligence (Investigation) check. On a successful check, the character finds a spell scroll of teleport. Only one such scroll can be found here.
...
If the characters leave the keystone undisturbed, they can pass through the tower safely and continue onward. If any of them return to the tower a second time, the keystone makes a loud popping noise in their presence and cracks in half, bringing down the magical barriers. The shark, which is a corrupted giant shark (see appendix A), attacks characters who now find themselves underwater.
...
Continual flame spells illuminate the interior of this underwater tavern, which is strewn with detritus. A neutral good sea elf named Olara floats behind a granite countertop. If approached, the barkeep cheerfully introduces herself and welcomes the characters to what she calls the Last Willow Tavern. Olara uses the scout stat block, with these changes:
...
\item She has resistance to cold damage and advantage on saving throws to end the charmed condition on herself. Magic can't put her to sleep.
\end{itemize}
...
Decades spent near the Netherdeep and the Alyxian Aboleth have damaged Olara's memories. A few of the Allegiance of Allsight archaeologists have interacted with Olara, to no avail, and since she shows no sign of hostility toward their efforts, they have decided to leave her alone.

\paragraph{Buying Goods from Olara}
Olara treats the characters as she would patrons of her tavern in any normal setting, commenting on the fact that, though the tavern is out of food and spirits, she can still offer some special brews. If the characters humor her, Olara shows off her collection of mundane wines and magic potions—their containers all tightly sealed. Characters can purchase any of these items:


\begin{description}[nolistsep]
\item[Magically Preserved Wine.]
Olara has three bottles of this delicious, pre-Divergence vintage in stock and asks 50 gp per bottle. An Ank'Hareli sommelier will pay up to 1,000 gp for a bottle of this rare vintage.
\item[Potions of Healing.]
Olara has five of Potion of Healing in stock and sells them for 50 gp each.
\item[Potions of Heroism.]
Olara has two Potion of Heroism in stock and sells them for 300 gp each.
\end{description}

\paragraph{Clearing Olara's Mind}
The haze that clouds Olara's mind is magically induced, a result of many years spent near the Alyxian Aboleth and the Netherdeep. Any magic that ends a curse cures Olara's affliction. Killing the aboleth also ends the effect.

If the characters ask Olara about Alyxian after clearing her mind, she fondly recalls serving wine to him on one occasion. She remembers Alyxian as a haunted and tragic figure, but beautiful in a way.

\subsubsection{M7: Hall of the Royal Library}
A dry, air-filled hallway enclosed by magical barriers and illuminated by continual flame spells runs along the south side of a crumbling stone building. The keystone that maintains the hallway's barriers is set above the western door. See the "Features of Cael Morrow" section for more information on the magical barriers and keystones.
...
A neutral evil, high elf occult extollant (see appendix A) named Galeokaerda has set up camp in this room along with Crescent, her shield guardian. Galeokaerda wears the Master's Amulet around her neck but hides it under her shirt.

Modify Galeokaerda stat block as follows:


\begin{itemize}
\item Galeokaerda speaks Celestial, Common, and Elvish.
\item She has darkvision out to a range of 60 feet.
\item She has advantage on saving throws against being charmed, and magic can't put her to sleep.
\end{itemize}

As described in the faction story tracks in chapter 4, Galeokaerda has long posed as a professor of the Allegiance of Allsight and has become Insight Acuere's friend. Now she regrets betraying her friend and secretly hopes that she can convince Insight Acuere to turn against the Allegiance of Allsight when Galeokaerda and the Consortium of the Vermilion Dream take over Cael Morrow.

\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/066-05-004.galeokaerda.png}
...
Galeokaerda is suspicious of anyone she doesn't recognize, even someone affiliated with the Consortium. If the characters are on a mission that involves Galeokaerda and portray themselves as fellow explorers, she demands that they prove their worth by retrieving a clay tablet, which she describes as having a "sigil sequence" inscribed on it, from area M7b. If they do so, she tells them that she has identified the location of the Key to the Netherdeep: a ruined villa on the southern cliffs (area M13).

\paragraph{Double Agent}
At the end of any conversation with Galeokaerda, a character can discern her true intentions and affiliation by making a successful DC 15 Wisdom (Insight) check. Any character who observes Galeokaerda closely can, with a successful DC 15 Wisdom (Perception) check, spot the telltale markings of ruidium corruption on her arms. If a character calls attention to the marks, Galeokaerda hastily tries to explain how she got them in the line of duty; then she realizes that any explanation is fruitless and attacks.

\subsubsection{M7b: Royal Study Chamber}
This damaged, water-filled chamber contains a hungry swarm of sorrowfish (see appendix A).

\paragraph{Treasure}
Lying on the floor in the middle of the room is a teleportation tablet (see appendix B) that was left behind by a member of the Consortium of the Vermilion Dream. This individual was searching the area for relics when a giant shark entered through a hole in the roof. The agent panicked and fled, dropping the tablet on their way back to area M7a. Galeokaerda wants to acquire the tablet, which connects to a teleportation circle on the roof of First Eclipse in Ank'Harel's Suncut Bazaar (see chapter 4).
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/067-05-005.temple-of-corellon.png}
\end{figure*}
...
\begin{DndReadAloud}{}
An image comes into focus. Alyxian is on his knees in this place, his head bent and his expression haggard. He looks old beyond his years. He raises his gaze to the statue of Corellon, his eyes clear despite the exhaustion showing on his face.
...
When the crystal shatters, the character who touched it must make a DC 16 Charisma saving throw. On a failed save, the character takes 33 (6d10) psychic damage and gains 1 level of exhaustion. If the character isn't already suffering from ruidium corruption, the character becomes corrupted when they fail the save. On a successful save, the character takes half as much damage and suffers no other effects.

When a character experiences the second vision, the Alyxian Aboleth loses its ability to poison the emotions of nearby creatures, and the Jewel of Three Prayers (see appendix B) transforms into its Jewel of Three Prayers (Exalted)—both consequences of gaining the blessing of Corellon the Arch Heart.
...
Four Scuttling Serpentmaw (see appendix A) lurk amid the rubble and scuttle across the floor to attack characters who investigate the room. Characters who have a passive Wisdom (Perception) score of 18 or higher notice the serpentmaws and aren't Surprise when they attack.

\paragraph{Clay Tablets}
Characters who spend 10 minutes searching the floor of the building find, among other clay tablets that describe ancient prayers and catechisms of the monks of the temple of Corellon, the particular tablet that Insight Acuere has been seeking (see "Insight's Quest" in mission 4 of the Cobalt Soul Story Track in chapter 4). This tablet is written in Celestial script. It reads:
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/068-05-006.aboleth-spawn-guards.png}  
\end{figure*}
...
Two aboleth spawn (see the accompanying stat block) guard the kelp forest. These tentacled creatures are bound to the Alyxian Aboleth and do its bidding. Their task is to guard the aboleth's treasure (see "Treasure" below).

The kelp forest is the lair of the Alyxian Aboleth (see appendix A). If the aboleth retreated here to take a short rest, it tries to hide from interlopers until its rest is finished before attacking them. If the aboleth is not present but returns to find any of its treasure missing (see below), it scours Cael Morrow in search of the thieves, determined to destroy them.
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/069-637828636788684355.png}
...
Closer examination reveals that the chunks of stone are shaped like the dismembered hands, arms, legs, heads, and torsos of Humanoids. The head-shaped chunks all have screaming faces. These are the petrified remains of the victims of the creature that has taken up residence in the villa (see area M13). A character who succeeds on a DC 12 Intelligence (Arcana) check recognizes the signs of petrification and knows that the bodies are too broken to be restored to life.
...
A death embrace (see appendix A) has made its lair in the ruins of this once magnificent location and attacks anyone who comes within reach of its tentacles. A swarm of sorrowfish (see appendix A) lurks among the tendrils of the death embrace, gaining cover. When the death embrace grapple a creature, the swarm loses its cover and the sorrowfish emerge to feed on the grappled creature.

\paragraph{Treasure}
Embedded in the death embrace's bell is a ruidium greataxe (see appendix B), the so-called Key to the Netherdeep that the Allegiance of Allsight and the Consortium of the Vermilion Dream are after (see chapter 4). The axe can be removed from the death embrace only after the creature is dead.

A character who spends 10 minutes searching the villa and succeeds on a DC 15 Intelligence (Investigation) check finds a locked jewelry box. The jewelry box can be opened by a character who makes either a successful DC 15 Dexterity check using thieves' tools or a successful DC 15 Strength (Athletics) check. Inside are two emerald rings (1,500 gp each), a string of pearls (750 gp), and a ring of shooting stars.
...
The tower is haunted by eight Sword Wraith Warrior under the command of Beltreath, a lawful neutral sword wraith commander. See appendix A for these creatures' stat blocks.

The sword wraiths are former defenders of Cael Morrow who fell during the battle against Gruumsh. They are protecting the ghost of Hadarai, a neutral good, orc priest of Corellon. Hadarai is soft-spoken and kindhearted. He swore a vow of pacifism centuries ago that he has never broken; even after being stripped of his mortal form, he won't fight or use Possession.
...
Hadarai met Alyxian once long ago, while the warrior was praying to Corellon for aid in the hours before Cael Morrow was destroyed. Hadarai is slow to accept that the Apotheon yet lives and can be saved, but a character can convince him of the truth of this claim with a successful DC 15 Charisma (Persuasion) check. If a character shows Hadarai the Jewel of Three Prayers, the check is made with advantage, since the ghost recognizes the jewel and knows its properties.

If combat breaks out and Beltreath is reduced to 50 hit points or fewer, he surrenders and begs the characters not to destroy him, for Hadarai's sake. If the characters show mercy, Hadarai is grateful and offers to assist them in any way he can. For example, the ghost, as a priest of Corellon, can help the characters bypass the magic ward around the temple (area M9) or can warn the characters about the Alyxian Aboleth that haunts the city.
...
A character who searches the opening for traps and succeeds on a DC 17 Intelligence (Investigation) check spots a tiny glyph inscribed along the edge of the opening, in a location that's not visible while the trapdoor is closed. If this glyph is dispelled with a successful casting of dispel magic (DC 17) or defaced using mason's tools or similar equipment, the following trap ceases to function.
...
The burst of light from this trap attracts the Slithering Bloodfin in area M16 and possibly the Alyxian Aboleth (see appendix A for their stat blocks). If the aboleth is in the nearby kelp forest (area M11) when the trap is sprung, it sees the light and immediately moves to investigate it.

\paragraph{Treasure}
The walls of the armory are festooned with longswords, shortswords, spears, longbows, shortbows, arrows in leather quivers, and steel shields—all corroded or rotted beyond usefulness. Among these objects are two magic items, both of which can be located quickly by using a detect magic spell: a sentinel shield and a frost brand longsword. A character must otherwise spend at least 1 minute searching the armory to find these magic items.
...
Unless the characters killed them in area M15, three Slithering Bloodfin (see appendix A) prowl this area in search of prey. The characters spot them—three streaks of crimson darting through the ruins. Unless the characters move away from the ruins immediately, the bloodfins swim toward the intruders and attack.
...
If the characters have yet to defeat the Alyxian Aboleth (see appendix A), it senses their intrusion into this area and arrives 1 minute later, attacking the characters in a rage.

The rift to the Netherdeep is covered with, and protected by, a film of black energy streaked with all the colors of the spectrum, appearing much like an oil slick. Water, liquids, and creatures native to the Netherdeep can pass through this barrier in either direction, but no other creatures or objects can do so unless the barrier is pierced by a ruidium weapon (see below).
...
\begin{itemize}
\item A ruidium weapon, like the one in area M13. Touching the weapon's edge to the barrier opens the rift.
\item The Jewel of Three Prayers (Exalted) in its Exalted State. When a creature brings the amulet within 10 feet of the rift, it glows with holy light that pierces the barrier protecting the rift.
\end{itemize}
...
\clearpage
\tikz[remember picture, overlay] \node[inner sep=0pt] at (current page.center){\includegraphics[height=\paperheight]{ images/adventure/CRCotN/070-06-001.intro-splash.png}};
\thispagestyle{empty}
\newpage
...
\begin{DndTable}[header=Fragments of Suffering]{Xr}
...
\subsubsection{Light}
Locations in the Netherdeep are either engulfed in darkness or dimly lit by ruidium deposits (see "Ruidium" below). All non-ruidium light sources in the Netherdeep shed light half as far as usual. For example, a light spell gives off bright light in a 10-foot radius and dim light for an additional 10 feet.
...
\onecolumn
{\centering \includegraphics[width=\textwidth]{images/adventure/CRCotN/071-map-6.1-The-Netherdeep.png} }
\mbox{}\null
\twocolumn

\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/073-06-002.alyxian-young-man.png}
\end{figure*}
...
11th & Close to sleep, huddled beneath a tree, and cloaked in a ratty blanket, the warrior runs his finger along the edge of the Jewel of Three Prayers, finding some comfort in its familiar shape.\\
...
19th & Standing in front of a mirror, the warrior considers the toll the Calamity has taken on him—the scars, the exhaustion etched into his features, all the result of the endless clash between faith and fear. He clasps the Jewel of Three Prayers, now complete with the addition of the blessing of Corellon the Arch Heart. "Three divine mantles," he whispers. "Let us all be free of this duty."\\
...
\item When the characters arrive at a new location, they find the rivals exiting it, being chased by several creatures snapping hungrily at them. Ayo spots the characters, winks maliciously at them, and casts pass without trace on her party, causing the monsters to lose sight of their quarry and turn their attention to the newcomers.
\item Galsariad uses his telekinesis spell to trigger the partial collapse of a tunnel, blocking the characters' path until they spend 10 minutes clearing the rubble.
\end{itemize}
...
Swimming in the dark water 20 feet above the characters (30 feet above the floor) are two Light Devourer and a slithering bloodfin (see appendix A for their stat blocks) that act as sentries. Characters who find themselves outmatched by the monsters or unable to cope with the water pressure can retreat through the open rift and return to Cael Morrow.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/074-06-003.alyxians-childhood-bedroom.png}
\end{figure*}
...
\paragraph{Raiders}
A group of soldiers—allies of Alyxian in the battle against Torog—have decided that since they saved this village, it is theirs to pillage. Four Sword Wraith Warrior led by a sword wraith commander (see appendix A for their stat blocks) take the shadowy shape of Alyxian's crass allies. They are bullying a group of ten Commoner in the middle of the village. As the characters approach, the commander, a neutral evil human in his mid-twenties named Kalagothe, looks to them as if they were Alyxian and roars, "Commander Alyxian, these people refuse to pay us tribute!"
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/075-06-004.three-ghosts.png}
\end{figure*}
...
When the characters learn all three names, three Ghost rise from the women's corpses and attack the intruders until at least one of the ghosts' names is spoken aloud. The ghosts resemble the three women, but they are not restless spirits. Rather, they are manifestations of Alyxian's rage and regret. The characters can destroy these ghosts by reducing each of them to 0 hit points.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/076-06-005.sword-wraiths-vision.png}
\end{figure*}
...
After the first wave is defeated, the characters have 2 rounds to heal and prepare for the second wave: two \textbf{Moorbounder} (see appendix A) accompanied by five \textbf{Sword Wraith Warrior}. Before the characters can do anything to prevent it, the sword wraiths merge into one creature—a \textbf{slithering bloodfin} (see appendix A) that swims through the air as easily as it normally swims through water. The howling faces of the warriors are visible on the bloodfin's flesh. The bloodfin is not what the Apotheon sought to conjure in this moment; rather, it represents Alyxian's inability to keep the Netherdeep from intruding upon his memories.
...
After the second wave is defeated, the characters have 1 round to heal and prepare for the final wave: a \textbf{sword wraith commander} and four \textbf{Sword Wraith Warrior} on the back of a \textbf{horizonback tortoise} (see appendix A for these creatures' stat blocks). Alyxian shares his thoughts as the tortoise lumbers toward the party:
...
\paragraph{Placating the Apotheon's Regret}
When all three waves of foes are defeated, Alyxian's allies cheer as the enemy is routed. A veteran covered in blood limps toward the characters and says, "You won the day, brave Alyxian. My wounds burn, but if you command it, I will follow you to the end." Alyxian whispers an answer that only the characters can hear: "It never ends." The wounded soldier, named Talmyth, has 1 hit point. If a character heals him, that act has a positive effect on the final battle against Alyxian (see "Emotional Healing" in chapter 7).
...
\paragraph{Treasure}
The wooden chest is closed and unlocked. It contains four stoppered Potion of Greater Healing in red crystal vials and a fully charged wand of secrets. If the rivals reach this area before the characters do, Dermot takes the magic items and doesn't bother closing the chest after emptying it.
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/077-06-006.slithering-bloodfin.png}
...
\item A potion that combines the beneficial effects of a Potion of Superior Healing and a potion of heroism
\end{itemize}
...
The creatures floating in the chamber are two \textbf{Death Embrace} (see appendix A). They are oblivious to what happens around them and attack only if damaged or otherwise disturbed (see "Apotheon's Fury" below). Moving around a death embrace without touching it doesn't disturb it.

\paragraph{Treasure}
In the middle of the chamber, lodged in two vents 10 feet apart, are a ruidium greatsword and a ruidium shield (both described in appendix B). To extract either item from its location, a character must reach into the boiling water, taking 5 (1d10) fire damage. A telekinesis spell or similar magic can be used to dislodge these items safely.

\paragraph{Apotheon's Fury}
If either the ruidium greatsword or the ruidium shield is removed from its resting place, the vents in the floor flare with bright red light and spew forth a flood of boiling-hot water, drastically raising the temperature of the water in the chamber, but only to a height of 30 feet. (The walls climb to a height of 100 feet; see "Features of the Netherdeep" earlier in the chapter.)
...
\begin{figure*}[th]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/078-06-007.ruidium-encrusted-statues.png}  
\end{figure*}
...
Three Scuttling Serpentmaw (see appendix A) hide behind the statues and ruidium spikes in the middle of the area. A character who tries to cross the cavern must succeed on a DC 19 Wisdom (Perception) check to avoid being Surprise when the serpentmaws attack.
...
\paragraph{Bones}
The floor contains the bones of three \textbf{slithering bloodfins}. If the secret door to area N14a is opened, the bones quietly knit themselves back together and attack any other creatures in the cavern. These Skeletal Bloodfin have glowing red eyes and use the slithering bloodfin stat block (see appendix A), with these changes:
...
\begin{figure*}[th]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/079-06-008.apotheons-spear.png}
\end{figure*}
...
\paragraph{Treasure}
Characters who search the area notice a dark recess in the northeast wall, at the back of which is a human skeleton in rusted chain mail. Tendrils of ruidium coil around the remains. The skeleton has a ruidium shortsword (see appendix B) clenched in its bony hand.

\paragraph{Taking the Spear}
The Spear of Warning sticking out of the pile of bones is a replica of Alyxian's spear. It shows no signs of rust, decay, or ruidium corruption, unlike the other weapons found throughout the chamber. It is imbued with the properties of a weapon of warning. If the characters have already confronted Alyxian in the Heart of Despair (see chapter 7), the spear is just another piece of treasure waiting to be claimed, and there are no repercussions for someone who takes it.
...
\textbf{Alyxian the Hunter} uses the stone golem stat block, with these changes:
...
Two \textbf{Corrupted Giant Shark} (see appendix A) orbit the red moon. The sharks don't attack until certain conditions are met (described below) or they are attacked.
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/080-06-009.two-aspects-of-alyxian.png}
\end{figure*}
...
When a character touches the mote of light (see "Fragment of Melancholy" below), three Chuul hidden under the sandy floor in the middle of the grotto rise and attack. Theo shrieks and cowers from the chuuls, which do not attack him. The chuuls pursue prey into area N17 but won't go any farther.
...
3 & A will-o'-wisp becomes visible and tries to lure the characters to area N25, then turns invisible once it arrives there. If attacked, the will-o'-wisp retaliates. Otherwise, it is indifferent toward the characters and harmless.\\
...
\begin{figure*}[th]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/081-06-010.cavern-of-many-hands.png}  
\end{figure*}
...
\item The key is made of tarnished silver and unlocks the box. (Without this key, a character can use thieves' tools to try to pick the box's lock, doing so with a successful DC 14 Dexterity check.)
\item The flask contains a Potion of Superior Healing.
\item The rolled-up scroll is a spell scroll of Otiluke's resilient sphere tied with a green ribbon.
\end{itemize}
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/082-06-011.swarm-sorrowfish.png}
...
The key to the door can be found in area N16a. A character can use an action to try to pick the lock with thieves' tools, doing so with a successful DC 22 Dexterity check. A knock spell or similar magic also opens the door.
...
\begin{figure*}[tbh]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/083-06-012.perigree-the-deva.png}  
\end{figure*}
...
\clearpage
\tikz[remember picture, overlay] \node[inner sep=0pt] at (current page.center){\includegraphics[height=\paperheight]{images/adventure/CRCotN/084-07-001.intro-splash.png}};
\thispagestyle{empty}
\newpage
...
Every visitor to the Heart and each of Alyxian's forms gains the benefit of a water walk spell upon arrival; this effect lasts for 1 hour. A creature can end the effect on itself at any time (no action required), enabling it to sink below the water's surface. Once the effect ends on a creature, it can't be reactivated.
...
\begin{figure*}
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/085-map-7.1-Heart-of-Despair.png}
\end{figure*}
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/087-07-002.statue-of-alyxian.png}
\end{figure*}
...
The Apotheon has multiple forms that the characters encounter in sequence, each with its own stat block. Three of these forms—Alyxian the Tormented, Alyxian the Callous, and Alyxian the Dispossessed—are hostile. The Apotheon has a fourth form—Alyxian the Absolved—that poses no threat to the characters and appears only if the Apotheon is redeemed. The sequence is as follows:
...
% \begin{figure*}[b]
%   \includegraphics[width=\textwidth]{images/adventure/CRCotN/088-07-003.alyxians-defiled-memories.png}  
% \end{figure*}
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/089-637828636812826040.png}  
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/090-637828636800144884.png}
...
\includegraphics[width=0.35\textwidth]{images/adventure/CRCotN/091-637828636804395371.png}
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/092-07-004.alyxian-the-absolved.png}  
\end{figure*}
...
\includegraphics[width=0.4\textwidth]{images/adventure/CRCotN/093-07-005.alyxian-with-jewel.png}
...
\begin{figure*}[t]
  \includegraphics[width=\textwidth]{images/adventure/CRCotN/094-07-006.sehanine-the-moon-weaver.png}
\end{figure*}
...
Avandra might reach out to paladins, druids, clerics, wizards, the adventurous, and the bold. She encourages her faithful to grasp their fate, embrace change for the better, and rise against the threat posed by Alyxian. If the characters need her aid, her Solar and Planetar might deliver useful information about places they hope to visit, or Avandra might provide the occasional swing of fate in the characters' favor.
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/095-08-009.tier-1-rivals.png}
...
\includegraphics[width=0.5\textwidth]{images/adventure/CRCotN/096-08-010.tier-3-rivals.png}
...
\begin{DndReadAloud}{Irvan Wastewalker}
...
\addcontentsline{toc}{subsection}{Aarakocra}

\begin{DndMonster}[float=ht]{Aarakocra}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Aarakocra.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Aboleth Spawn}

\begin{DndMonster}[float=ht]{Aboleth Spawn}
...
\DndMonsterAction{Abolethic Vessel}
The spawn must obey its aboleth master.

\DndMonsterAction{Amphibious}
The spawn can breathe air and water.

\DndMonsterAction{Water Dependency}
The spawn takes 6 (1d12) acid damage every 10 minutes it goes without being immersed in water.

\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The spawn makes one Spear attack, two Tentacle attacks, and one Psychic Lash attack.

\DndMonsterAction{Spear}
\textsl{Melee or Ranged Weapon Attack:} +7 to hit, reach 5 ft. or range 20/60 ft., one target. \textsl{Hit:} 7 (1d6 + 4) piercing damage, or 8 (1d8 + 4) piercing damage when used with two hands to make a melee attack.

\DndMonsterAction{Tentacle}
\textsl{Melee Weapon Attack:} +7 to hit, reach 10 ft., one creature. \textsl{Hit:} The target is grappled (escape DC 14) and takes 9 (2d8) psychic damage at the start of each of its turns until the grapple ends. The spawn has four tentacles, each of which can grapple one creature.

\DndMonsterAction{Psychic Lash}
\textsl{Ranged Spell Attack:} +7 to hit, range 120 ft., one creature. \textsl{Hit:} 18 (4d8) psychic damage.

\end{DndMonster}


\clearpage
\addcontentsline{toc}{subsection}{Acolyte}

\begin{DndMonster}[float=ht]{Acolyte}
...
\clearpage
\addcontentsline{toc}{subsection}{Orc}

\begin{DndMonster}[float=ht]{Orc}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Orc.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Occult Initiate}

\begin{DndMonster}[float=ht]{Occult Initiate}
\DndMonsterType{S or M humanoid (sorcerer), any alignment}
\DndMonsterBasics[
armor-class = {12},
...
\DndMonsterAction{Spellcasting}
The initiate casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 13):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{light, mage hand}
  \DndInnateSpellLevel[1e]{detect magic, levitate}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Shortsword}
\textsl{Melee Weapon Attack:} +4 to hit, reach 5 ft., one target. \textsl{Hit:} 5 (1d6 + 2) piercing damage plus 7 (2d6) psychic damage.

\DndMonsterAction{Arcane Blast Recharge 5-6}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Occult Initiate.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Alyxian Aboleth}

\begin{DndMonster}[float=ht]{Alyxian Aboleth}
\DndMonsterType{Large aberration, lawful evil}
\DndMonsterBasics[
armor-class = {17 (natural armor)},
hit-points = {\DndDice{18d10 + 36}},
speed = {10 ft., 30 ft. (key)}
]
\DndMonsterAbilityScores[
 str = 21,
 dex = 9,
...
\DndMonsterAction{Enslave Recharge 4-6}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Alyxian Aboleth.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Alyxian the Absolved}

\begin{DndMonster}[float=ht]{Alyxian the Absolved}
...
\begin{DndMonster}[float=ht]{Alyxian the Callous}
...
\begin{DndMonster}[float=ht]{Alyxian the Dispossessed}
...
\begin{DndMonster}[float=ht]{Alyxian the Hunter}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Alyxian the Hunter.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Alyxian the Tormented}

\begin{DndMonster}[float=ht]{Alyxian the Tormented}
...
\DndMonsterAction{Void Eyes Recharge 5-6}
...
\clearpage
\addcontentsline{toc}{subsection}{Ancient Brass Dragon}

\begin{DndMonster}[float=ht]{Ancient Brass Dragon}
\DndMonsterType{Gargantuan dragon, chaotic good}
\DndMonsterBasics[
armor-class = {20 (natural armor)},
hit-points = {\DndDice{17d20 + 119}},
speed = {40 ft., 40 ft. (key), 80 ft. (key)}
]
\DndMonsterAbilityScores[
 str = 27,
 dex = 10,
...
\textsl{Melee Weapon Attack:} +14 to hit, reach 15 ft., one target. \textsl{Hit:} 19 (2d10 + 8) piercing damage.
...
\DndMonsterAction{Breath Weapons Recharge 5-6}
The dragon uses one of the following breath weapons:


\begin{description}[nolistsep]
\item[Fire Breath]
The dragon exhales fire in a 90-foot line that is 10 feet wide. Each creature in that line must make a DC 21 Dexterity saving throw, taking 56 (16d6) fire damage on a failed save, or half as much damage on a successful one.
\item[Sleep Breath]
...
\par
\DndMonsterSection{Legendary Actions}
Ancient Brass Dragon can take 3 legendary actions, choosing from the options below. Only one legendary action can be used at a time and only at the end of another creature's turn. Ancient Brass Dragon regains spent legendary actions at the start of its turn.
...
\clearpage
\addcontentsline{toc}{subsection}{Animated Glass Statue}

\begin{DndMonster}[float=ht]{Animated Glass Statue}
\DndMonsterType{Large construct, neutral evil}
\DndMonsterBasics[
armor-class = {10},
...
The statue has advantage on an attack roll against a creature if at least one of the statue's allies is within 5 feet of the creature and the ally isn't incapacitated.

\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The statue makes two attacks: one with its beak and one with its talons.
...
\clearpage
\addcontentsline{toc}{subsection}{Ankylosaurus}

\begin{DndMonster}[float=ht]{Ankylosaurus}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Dinosaurs.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Occult Silvertongue}

\begin{DndMonster}[float=ht]{Occult Silvertongue}
\DndMonsterType{S or M humanoid (sorcerer), lawful evil}
\DndMonsterBasics[
armor-class = {13},
...
\DndMonsterAction{Alien Mind}
If a creature tries to read the silvertongue's thoughts or deals psychic damage to the silvertongue, that creature must succeed on a DC 16 Intelligence saving throw or be stunned until the start of its next turn.

\DndMonsterAction{Magic Resistance}
The silvertongue has advantage on saving throws against spells and other magical effects.

\DndMonsterAction{Spellcasting}
The silvertongue casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 16):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel[1]{dimension door}
  \DndInnateSpellLevel[2e]{charm person, mage armor, sending}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Crimson Bolt}
\textsl{Melee or Ranged Spell Attack:} +8 to hit, reach 5 ft. or range 60 ft., one creature. \textsl{Hit:} 27 (4d10 + 5) psychic damage.

\par
\DndMonsterSection{Bonus Actions}
\DndMonsterAction{Elemental Servitor (1/Day)}
The silvertongue magically summons an earth elemental, which appears in an unoccupied space the silvertongue can see within 60 feet of itself. The earth elemental takes its turn immediately after the silvertongue on the same initiative count and obeys the silvertongue's commands. The earth elemental disappears after 1 minute or when it or the silvertongue dies.
...
\begin{DndMonster}[float=ht]{Assassin}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Assassin.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Ayo Jabe (Tier 1)}

\begin{DndMonster}[float=ht]{Ayo Jabe (Tier 1)}
...
\begin{DndMonsterSpells}
  \DndInnateSpellLevel[1e]{animal friendship, goodberry}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
Ayo makes two Harpoon or Longbow attacks.
...
\textsl{Ranged Weapon Attack:} +4 to hit, range 150/600 ft., one target. \textsl{Hit:} 11 (2d8 + 2) piercing damage.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Ayo Jabe (Tier 1).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Ayo Jabe (Tier 2)}

\begin{DndMonster}[float=ht]{Ayo Jabe (Tier 2)}
\DndMonsterType{Medium humanoid (ranger, ), chaotic good}
\DndMonsterBasics[
armor-class = {15 (studded leather armor)},
...
\DndMonsterAction{Spellcasting}
Ayo casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 13):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel[1e]{animal friendship, goodberry, pass without trace}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
...
\DndMonsterAction{Harpoon}
\textsl{Melee Weapon Attack:} +5 to hit, reach 5 ft., one target. \textsl{Hit:} 11 (2d8 + 2) piercing damage.

\DndMonsterAction{Longbow}
\textsl{Ranged Weapon Attack:} +6 to hit, range 150/600 ft., one target. \textsl{Hit:} 12 (2d8 + 3) piercing damage.
...
\begin{DndMonster}[float=ht]{Ayo Jabe (Tier 3)}
\DndMonsterType{Medium humanoid (ranger, ), chaotic good}
\DndMonsterBasics[
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Ayo Jabe (Tier 3).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Balor}

\begin{DndMonster}[float=ht]{Balor}
...
\clearpage
\addcontentsline{toc}{subsection}{Bandit}

\begin{DndMonster}[float=ht]{Bandit}
...
\clearpage
\addcontentsline{toc}{subsection}{Bandit Captain}

\begin{DndMonster}[float=ht]{Bandit Captain}
\DndMonsterType{Medium humanoid (any race), any non-lawful alignment}
\DndMonsterBasics[
armor-class = {15 (studded leather armor)},
hit-points = {\DndDice{10d8 + 20}},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Bandit Captain.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Barlgura}

\begin{DndMonster}[float=ht]{Barlgura}
...
\begin{DndMonsterSpells}
  \DndInnateSpellLevel[1e]{entangle, phantasmal force}
  \DndInnateSpellLevel[2e]{disguise self, invisibility}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
...
\begin{DndMonster}[float=ht]{Berserker}
...
\begin{DndMonster}[float=ht]{Bristled Moorbounder}
...
\clearpage
\addcontentsline{toc}{subsection}{Bugbear}

\begin{DndMonster}[float=ht]{Bugbear}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Bugbear.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Bugbear Chief}

\begin{DndMonster}[float=ht]{Bugbear Chief}
\DndMonsterType{Medium humanoid (goblinoid), chaotic evil}
\DndMonsterBasics[
...
\DndMonsterAction{Heart of Hruggek}
...
\DndMonsterAction{Morningstar}
\textsl{Melee Weapon Attack:} +5 to hit, reach 5 ft., one target. \textsl{Hit:} 11 (2d8 + 3) piercing damage.

\DndMonsterAction{Javelin}
\textsl{Melee or Ranged Weapon Attack:} +5 to hit, reach 5 ft. or range 30/120 ft., one target. \textsl{Hit:} 9 (2d6 + 3) piercing damage in melee or 5 (1d6 + 3) piercing damage at range.
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Chasme}

\begin{DndMonster}[float=ht]{Chasme}
\DndMonsterType{Large fiend (demon), chaotic evil}
\DndMonsterBasics[
armor-class = {15 (natural armor)},
...
\begin{DndMonster}[float=ht]{Chuul}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Chuul.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Cloaker}

\begin{DndMonster}[float=ht]{Cloaker}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Cloaker.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Commoner}

\begin{DndMonster}[float=ht]{Commoner}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
armor-class = {10},
...
\begin{DndMonster}[float=ht]{Corrupted Giant Shark}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Corrupted Giant Shark.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Cult Fanatic}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Dancing Flame}

\begin{DndMonster}[float=ht]{Dancing Flame}
...
\DndMonsterSection{Actions}
\DndMonsterAction{Claw}
\textsl{Melee Weapon Attack:} +5 to hit, reach 5 ft., one target. \textsl{Hit:} 6 (1d6 + 3) fire damage.
...
The flame can have only one target charmed at a time. If it charms another, the effect on the previous target ends.
...
\begin{DndMonster}[float=ht]{Death Embrace}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Death Embrace.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Dermot Wurder (Tier 1)}

\begin{DndMonster}[float=ht]{Dermot Wurder (Tier 1)}
...
\DndMonsterAction{Spellcasting}
Dermot casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 13):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{guidance, light, spare the dying}
  \DndInnateSpellLevel[1e]{bless, cure wounds}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
Dermot makes one Warhammer attack and one Searing Wrath attack.

\DndMonsterAction{Warhammer}
\textsl{Melee Weapon Attack:} +5 to hit, reach 5 ft., one target. \textsl{Hit:} 7 (1d8 + 3) bludgeoning damage, or 8 (1d10 + 3) bludgeoning damage when used with two hands.

\DndMonsterAction{Searing Wrath}
\textsl{Ranged Spell Attack:} +5 to hit, range 60 ft., one creature. \textsl{Hit:} 9 (2d8) radiant damage, and the target is blinded until the end of its next turn.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Dermot Wurder (Tier 1).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Dermot Wurder (Tier 2)}

\begin{DndMonster}[float=ht]{Dermot Wurder (Tier 2)}
\DndMonsterType{Small humanoid (cleric, goblin, goblinoid), lawful good}
\DndMonsterBasics[
armor-class = {19 (splint mail)},
hit-points = {\DndDice{15d6 + 30}},
speed = {30 ft.}
]
\DndMonsterAbilityScores[
 str = 18,
...
\DndMonsterAction{Spellcasting}
Dermot casts one of the following spells, using Wisdom as the spellcasting ability (spell save DC 15):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{guidance, light, spare the dying}
...
\DndMonsterAction{Warhammer}
\textsl{Melee Weapon Attack:} +7 to hit, reach 5 ft., one target. \textsl{Hit:} 8 (1d8 + 4) bludgeoning damage, or 9 (1d10 + 4) bludgeoning damage when used with two hands.

\DndMonsterAction{Searing Wrath}
\textsl{Ranged Spell Attack:} +7 to hit, range 60 ft., one creature. \textsl{Hit:} 18 (4d8) radiant damage, and the target is blinded until the end of its next turn.
...
\begin{DndMonster}[float=ht]{Dermot Wurder (Tier 3)}
\DndMonsterType{Small humanoid (cleric, goblin, goblinoid), lawful good}
\DndMonsterBasics[
armor-class = {20 (plate armor)},
hit-points = {\DndDice{17d6 + 34}},
speed = {30 ft., {'number': 30, 'condition': "(mariner's armor)"} ft. (key)}
]
\DndMonsterAbilityScores[
 str = 18,
 dex = 12,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Dermot Wurder (Tier 3).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Deva}

\begin{DndMonster}[float=ht]{Deva}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Deva.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Drider}

\begin{DndMonster}[float=ht]{Drider}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Drider.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Drow}

\begin{DndMonster}[float=ht]{Drow}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Drow.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Drow Elite Warrior}

\begin{DndMonster}[float=ht]{Drow Elite Warrior}
\DndMonsterType{Medium humanoid (elf), neutral evil}
\DndMonsterBasics[
...
\begin{DndMonster}[float=ht]{Druid}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Druid.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Dryad}

\begin{DndMonster}[float=ht]{Dryad}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Dryad.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Orc War Chief}

\begin{DndMonster}[float=ht]{Orc War Chief}
\DndMonsterType{Medium humanoid (orc), chaotic evil}
\DndMonsterBasics[
...
\clearpage
\addcontentsline{toc}{subsection}{Flameskull}

\begin{DndMonster}[float=ht]{Flameskull}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Flameskull.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Priest}

\begin{DndMonster}[float=ht]{Priest}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\clearpage
\addcontentsline{toc}{subsection}{Galeokaerda}

\begin{DndMonster}[float=ht]{Galeokaerda}
\DndMonsterType{S or M humanoid (elf, sorcerer), neutral evil}
\DndMonsterBasics[
armor-class = {12},
...
\DndMonsterAction{Fey Ancestry}
Galeokaerda has advantage on saving throws against being charmed, and magic can't put her to sleep.

\DndMonsterAction{Spellcasting}
The extollant casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 15):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{minor illusion}
  \DndInnateSpellLevel[1e]{mage armor, major image, phantasmal force}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The extollant makes two Crimson Bolt attacks.

\DndMonsterAction{Crimson Bolt}
\textsl{Melee or Ranged Spell Attack:} +7 to hit, reach 5 ft. or range 60 ft., one creature. \textsl{Hit:} 20 (3d10 + 4) psychic damage.

\par
\DndMonsterSection{Reactions}
\DndMonsterAction{Reflect Agony}
When the extollant is damaged by a creature within 60 feet of it, the creature must make a DC 15 Wisdom saving throw, taking 16 (3d10) psychic damage on a failed saving throw, or half as much damage on a successful one.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Galeokaerda.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Galsariad Ardyth (Tier 1)}

\begin{DndMonster}[float=ht]{Galsariad Ardyth (Tier 1)}
...
\DndMonsterAction{Spellcasting}
Galsariad casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 13):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{mage armor, mage hand}
  \DndInnateSpellLevel[1]{longstrider}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Drain Potential}
\textsl{Melee or Ranged Spell Attack:} +5 to hit, reach 5 ft. or range 30 ft., one creature. \textsl{Hit:} 16 (3d10) necrotic damage, and Galsariad gains 5 temporary hit points.

\DndMonsterAction{Gravity Wave Recharge 5-6}
Galsariad causes a rippling wave of magical gravity to fill a 10-foot-radius sphere centered on a point he can see within 120 feet of himself. Each creature in that area must make a DC 13 Strength saving throw. On a failed saving throw, the creature takes 17 (5d6) force damage and is pulled up to 10 feet toward the sphere's center. On a successful save, the creature takes half as much damage and isn't pulled.
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Galsariad Ardyth (Tier 1).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Galsariad Ardyth (Tier 2)}

\begin{DndMonster}[float=ht]{Galsariad Ardyth (Tier 2)}
\DndMonsterType{Medium humanoid (drow, elf, wizard), neutral}
\DndMonsterBasics[
armor-class = {12},
hit-points = {\DndDice{15d8}},
speed = {30 ft., {'number': 30, 'condition': '(hover)'} ft. (key), True ft. (key)}
]
\DndMonsterAbilityScores[
 str = 8,
 dex = 14,
...
\DndMonsterAction{Spellcasting}
Galsariad casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 15):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{mage armor, mage hand}
  \DndInnateSpellLevel[1e]{longstrider, scrying, slow}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Drain Potential}
\textsl{Melee or Ranged Spell Attack:} +7 to hit, reach 5 ft. or range 60 ft., one creature. \textsl{Hit:} 22 (4d10) necrotic damage, and Galsariad gains 5 temporary hit points.

\DndMonsterAction{Gravity Wave Recharge 5-6}
Galsariad causes a rippling wave of magical gravity to fill a 20-foot-radius sphere centered on a point he can see within 100 feet of himself. Each creature in that area must make a DC 15 Strength saving throw. On a failed saving throw, the creature takes 35 (10d6) force damage and is pulled up to 20 feet toward the sphere's center, and is knocked prone. On a successful save, the creature takes half as much damage and isn't pulled or knocked prone.
...
\begin{DndMonster}[float=ht]{Galsariad Ardyth (Tier 3)}
\DndMonsterType{Medium humanoid (drow, elf, wizard), neutral}
\DndMonsterBasics[
armor-class = {17 (deflection)},
hit-points = {\DndDice{20d8}},
speed = {30 ft., {'number': 30, 'condition': '(hover)'} ft. (key), {'number': 40, 'condition': '(ring of swimming)'} ft. (key), True ft. (key)}
]
\DndMonsterAbilityScores[
 str = 8,
 dex = 14,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Galsariad Ardyth (Tier 3).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Ghost}
...
\begin{DndMonster}[float=ht]{Giant Octopus}
\DndMonsterType{Large beast, unaligned}
\DndMonsterBasics[
armor-class = {11},
...
\begin{DndMonster}[float=ht]{Giant Shark}
\DndMonsterType{Huge beast, unaligned}
\DndMonsterBasics[
armor-class = {13 (natural armor)},
hit-points = {\DndDice{11d12 + 55}},
...
\clearpage
\addcontentsline{toc}{subsection}{Giant Spider}

\begin{DndMonster}[float=ht]{Giant Spider}
\DndMonsterType{Large beast, unaligned}
\DndMonsterBasics[
armor-class = {14 (natural armor)},
...
\DndMonsterAction{Web Recharge 5-6}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Giant Spider.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Giant Vulture}

\begin{DndMonster}[float=ht]{Giant Vulture}
...
\clearpage
\addcontentsline{toc}{subsection}{Gibbering Mouther}

\begin{DndMonster}[float=ht]{Gibbering Mouther}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Gibbering Mouther.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Glabrezu}

\begin{DndMonster}[float=ht]{Glabrezu}
\DndMonsterType{Large fiend (demon), chaotic evil}
\DndMonsterBasics[
armor-class = {17 (natural armor)},
hit-points = {\DndDice{15d10 + 75}},
...
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{darkness, detect magic, dispel magic}
  \DndInnateSpellLevel[1e]{confusion, fly, power word stun}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
...
\clearpage
\addcontentsline{toc}{subsection}{Gladiator}

\begin{DndMonster}[float=ht]{Gladiator}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\begin{DndMonster}[float=ht]{Gloomstalker}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/EGW/Gloomstalker.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Goblin}

\begin{DndMonster}[float=ht]{Goblin}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Goblin.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Mastermind}

\begin{DndMonster}[float=ht]{Scholarly Mastermind}
\DndMonsterType{S or M humanoid (wizard), any alignment}
\DndMonsterBasics[
armor-class = {12},
hit-points = {\DndDice{15d8 + 15}},
speed = {30 ft.}
]
\DndMonsterAbilityScores[
 str = 10,
...
\DndMonsterAction{Spellcasting}
The mastermind casts one of the following spells, requiring no material components and using Intelligence as the spellcasting ability (spell save DC 15):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{alter self, light, mage hand}
  \DndInnateSpellLevel[1e]{comprehend languages, mage armor, zone of truth}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The mastermind makes two Arcane Shock or Dagger of the Poisoned Mind attacks.

\DndMonsterAction{Arcane Shock}
\textsl{Melee or Ranged Spell Attack:} +7 to hit, reach 5 ft. or range 60 ft., one target. \textsl{Hit:} 26 (4d10 + 4) lightning damage. If the target is a creature, it can't take reactions until the start of its next turn.

\DndMonsterAction{Dagger of the Poisoned Mind}
\textsl{Melee or Ranged Weapon Attack:} +7 to hit, reach 5 ft. or range 20/60 ft., one target. \textsl{Hit:} 6 (1d4 + 4) piercing damage plus 10 (3d6) psychic damage. If the target is a creature, it must succeed on a DC 15 Wisdom saving throw or be frightened until the end of its next turn.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Scholarly Mastermind.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Guard}

\begin{DndMonster}[float=ht]{Guard}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\clearpage
\addcontentsline{toc}{subsection}{Hezrou}

\begin{DndMonster}[float=ht]{Hezrou}
\DndMonsterType{Large fiend (demon), chaotic evil}
\DndMonsterBasics[
armor-class = {16 (natural armor)},
...
\begin{DndMonster}[float=ht]{Horizonback Tortoise}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/EGW/Horizonback Tortoise.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Incubus}

\begin{DndMonster}[float=ht]{Incubus}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Incubus.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Insight Acuere}

\begin{DndMonster}[float=ht]{Insight Acuere}
\DndMonsterType{Medium humanoid (wizard), lawful good}
\DndMonsterBasics[
armor-class = {12},
hit-points = {\DndDice{15d8 + 15}},
speed = {30 ft.}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Insight Acuere.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Invisible Stalker}

\begin{DndMonster}[float=ht]{Invisible Stalker}
\DndMonsterType{Medium elemental, neutral}
\DndMonsterBasics[
armor-class = {14},
hit-points = {\DndDice{16d8 + 32}},
speed = {50 ft., {'number': 50, 'condition': '(hover)'} ft. (key), True ft. (key)}
]
\DndMonsterAbilityScores[
 str = 16,
 dex = 19,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Invisible Stalker.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Irvan Wastewalker (Tier 1)}

\begin{DndMonster}[float=ht]{Irvan Wastewalker (Tier 1)}
...
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
Irvan makes two Dagger attacks.

\DndMonsterAction{Dagger}
\textsl{Melee or Ranged Weapon Attack:} +4 to hit, reach 5 ft. or range 20/60 ft., one target. \textsl{Hit:} 4 (1d4 + 2) piercing damage plus 7 (2d6) poison damage.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Irvan Wastewalker (Tier 1).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Irvan Wastewalker (Tier 2)}

\begin{DndMonster}[float=ht]{Irvan Wastewalker (Tier 2)}
\DndMonsterType{Medium humanoid (human), chaotic neutral}
\DndMonsterBasics[
armor-class = {15 (studded leather armor)},
...
\DndMonsterAction{Dagger}
\textsl{Melee or Ranged Weapon Attack:} +6 to hit, reach 5 ft. or range 20/60 ft., one target. \textsl{Hit:} 5 (1d4 + 3) piercing damage plus 14 (4d6) poison damage.
...
\begin{DndMonster}[float=ht]{Irvan Wastewalker (Tier 3)}
\DndMonsterType{Medium humanoid (human), chaotic neutral}
\DndMonsterBasics[
armor-class = {17 (studded leather armor)},
hit-points = {\DndDice{19d8 + 38}},
speed = {40 ft., {'number': 40, 'condition': '(see special equipment)'} ft. (key)}
]
\DndMonsterAbilityScores[
 str = 10,
 dex = 20,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Irvan Wastewalker (Tier 3).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Mastermind}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Monastic High Curator}

\begin{DndMonster}[float=ht]{Monastic High Curator}
\DndMonsterType{S or M humanoid (monk, wizard), any alignment}
\DndMonsterBasics[
...
While the high curator is wearing no armor and wielding no shield, its AC includes its Wisdom modifier.

\DndMonsterAction{Spellcasting}
The high curator casts one of the following spells, requiring no material components and using Wisdom as the spellcasting ability (spell save DC 18):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{detect magic}
  \DndInnateSpellLevel[2e]{detect thoughts, identify, scrying}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The high curator makes three Force Strike attacks and uses Brain Burn (if available).

\DndMonsterAction{Force Strike}
\textsl{Melee or Ranged Spell Attack:} +10 to hit, reach 5 ft. or range 10 ft., one target. \textsl{Hit:} 17 (2d10 + 6) force damage.

\DndMonsterAction{Brain Burn Recharge 4-6}
The high curator targets up to two creatures it can see within 30 feet of itself. Each target must make a DC 18 Constitution saving throw. On a failed saving throw, the target takes 28 (8d6) psychic damage and can't take reactions until the start of its next turn. On a successful save, the target takes half as much damage and suffers no other effect.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Monastic High Curator.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Knight}

\begin{DndMonster}[float=ht]{Knight}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Laurin Ophidas}

\begin{DndMonster}[float=ht]{Laurin Ophidas}
\DndMonsterType{Medium humanoid (half-elf), chaotic evil}
\DndMonsterBasics[
armor-class = {13 (leather armor)},
hit-points = {\DndDice{6d8 + 6}},
speed = {30 ft.}
...
\begin{DndMonster}[float=ht]{Light Devourer}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Light Devourer.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Mage}

\begin{DndMonster}[float=ht]{Mage}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\clearpage
\addcontentsline{toc}{subsection}{Maggie Keeneyes (Tier 1)}

\begin{DndMonster}[float=ht]{Maggie Keeneyes (Tier 1)}
...
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Giant Maul}
\textsl{Melee Weapon Attack:} +6 to hit, reach 10 ft., one target. \textsl{Hit:} 13 (2d8 + 4) bludgeoning damage, and if the target is a creature, Maggie can force it to make a DC 14 Strength saving throw; on a failed save, the target is pushed 5 feet away from Maggie and knocked prone.

\DndMonsterAction{Hammer Toss}
\textsl{Ranged Weapon Attack:} +6 to hit, range 20/60 ft., one target. \textsl{Hit:} 9 (2d4 + 4) bludgeoning damage, and if the target is a creature, Maggie can force it to make a DC 14 Strength saving throw; on a failed save, the target is pushed 5 feet away from Maggie and knocked prone.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Maggie Keeneyes (Tier 1).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Maggie Keeneyes (Tier 2)}

\begin{DndMonster}[float=ht]{Maggie Keeneyes (Tier 2)}
\DndMonsterType{Large giant (ogre), lawful neutral}
\DndMonsterBasics[
armor-class = {15 (chain shirt)},
...
Once during each of her turns, after hitting a creature with an attack, Maggie can force the target to make a DC 15 Strength saving throw; on a failed save, the target is pushed up to 10 feet horizontally away from Maggie and knocked prone.
...
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
Maggie makes two Giant Maul or Hammer Toss attacks.

\DndMonsterAction{Giant Maul}
\textsl{Melee Weapon Attack:} +7 to hit, reach 10 ft., one target. \textsl{Hit:} 13 (2d8 + 4) bludgeoning damage.

\DndMonsterAction{Hammer Toss}
\textsl{Ranged Weapon Attack:} +7 to hit, range 20/60 ft., one target. \textsl{Hit:} 9 (2d4 + 4) bludgeoning damage.

\par
\DndMonsterSection{Bonus Actions}
\DndMonsterAction{Rally (1/Day)}
Maggie targets one creature she can see within 30 feet of herself and bolsters it with words of encouragement. The target gains 15 temporary hit points if it can see or hear Maggie.
...
\begin{DndMonster}[float=ht]{Maggie Keeneyes (Tier 3)}
\DndMonsterType{Large giant (ogre), lawful neutral}
\DndMonsterBasics[
armor-class = {18 (plate armor)},
hit-points = {\DndDice{15d10 + 60}},
speed = {30 ft., {'number': 30, 'condition': '(ruidium armor)'} ft. (key)}
]
\DndMonsterAbilityScores[
 str = 20,
 dex = 14,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Maggie Keeneyes (Tier 3).png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Mammoth}

\begin{DndMonster}[float=ht]{Mammoth}
\DndMonsterType{Huge beast, unaligned}
\DndMonsterBasics[
armor-class = {13 (natural armor)},
hit-points = {\DndDice{11d12 + 55}},
...
\clearpage
\addcontentsline{toc}{subsection}{Manes}

\begin{DndMonster}[float=ht]{Manes}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Minotaur}

\begin{DndMonster}[float=ht]{Minotaur}
\DndMonsterType{Large monstrosity, chaotic evil}
\DndMonsterBasics[
armor-class = {14 (natural armor)},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Minotaur.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Monastic High Curator}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Monastic Infiltrator}

\begin{DndMonster}[float=ht]{Monastic Infiltrator}
\DndMonsterType{S or M humanoid (monk), any alignment}
\DndMonsterBasics[
...
\DndMonsterAction{Guarded Mind}
Spells and other effects can't read the infiltrator's thoughts or determine if the infiltrator is lying. Creatures can communicate telepathically with the infiltrator only if it allows such contact.

\DndMonsterAction{Unarmored Defense}
While the infiltrator is wearing no armor and wielding no shield, its AC includes its Wisdom modifier.

\DndMonsterAction{Spellcasting}
The infiltrator casts one of the following spells, requiring no material components and using Wisdom as the spellcasting ability (spell save DC 14):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{disguise self}
  \DndInnateSpellLevel[2e]{detect thoughts, invisibility}
  \DndInnateSpellLevel[1e]{dimension door, zone of truth}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The infiltrator makes three Unarmed Strike attacks.

\DndMonsterAction{Unarmed Strike}
\textsl{Melee Weapon Attack:} +8 to hit, reach 5 ft., one target. \textsl{Hit:} 10 (1d10 + 5) force damage.
...
\par
\DndMonsterSection{Reactions}
\DndMonsterAction{Retaliating Strike}
When a creature within 5 feet of the infiltrator hits or misses the infiltrator with a melee attack, the infiltrator makes one Unarmed Strike attack against the attacker.

\end{DndMonster}


\clearpage
\addcontentsline{toc}{subsection}{Monastic Operative}

\begin{DndMonster}[float=ht]{Monastic Operative}
\DndMonsterType{S or M humanoid (monk), any alignment}
\DndMonsterBasics[
...
\DndMonsterAction{Unarmored Defense}
While the operative is wearing no armor and wielding no shield, its AC includes its Wisdom modifier.

\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The operative makes three Unarmed Strike attacks, three Cobalt Dart attacks, or a combination thereof.

\DndMonsterAction{Unarmed Strike}
\textsl{Melee Weapon Attack:} +7 to hit, reach 5 ft., one target. \textsl{Hit:} 9 (1d10 + 4) bludgeoning damage.

\DndMonsterAction{Cobalt Dart}
\textsl{Ranged Weapon Attack:} +7 to hit, range 20/60 ft., one target. \textsl{Hit:} 6 (1d4 + 4) piercing damage plus 3 (1d6) force damage.

\par
\DndMonsterSection{Reactions}
\DndMonsterAction{Retaliating Strike}
When a creature within 5 feet of the operative hits or misses the operative with a melee attack, the operative makes one Unarmed Strike attack against the attacker.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Monastic Operative.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Giant Shark}
...
\begin{DndMonster}[float=ht]{Moorbounder}
\DndMonsterType{Large beast, unaligned}
\DndMonsterBasics[
armor-class = {13 (natural armor)},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/EGW/Moorbounder.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Nightmare}

\begin{DndMonster}[float=ht]{Nightmare}
\DndMonsterType{Large fiend, neutral evil}
\DndMonsterBasics[
armor-class = {13 (natural armor)},
hit-points = {\DndDice{8d10 + 24}},
speed = {60 ft., 90 ft. (key)}
]
\DndMonsterAbilityScores[
 str = 18,
 dex = 15,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Nightmare.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Noble}

\begin{DndMonster}[float=ht]{Noble}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Noble.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Occult Extollant}

\begin{DndMonster}[float=ht]{Occult Extollant}
\DndMonsterType{S or M humanoid (sorcerer), any alignment}
\DndMonsterBasics[
armor-class = {12},
hit-points = {\DndDice{14d8 + 28}},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Occult Extollant.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Occult Initiate}
...
\clearpage
\addcontentsline{toc}{subsection}{Ochre Jelly}

\begin{DndMonster}[float=ht]{Ochre Jelly}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Ochre Jelly.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Ogre}

\begin{DndMonster}[float=ht]{Ogre}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Ogre.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Olara}

\begin{DndMonster}[float=ht]{Olara}
...
\DndMonsterAction{Amphibious}
Olara can breathe air and water.

\DndMonsterAction{Fey Ancestry}
Olara has advantage on saving throws to end the charmed condition on herself, and magic can't put her to sleep.
...
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
Olara makes two melee attacks or two ranged attacks.
...
\begin{DndMonster}[float=ht]{Owlbear}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Owlbear.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Deva}
...
\begin{DndMonster}[float=ht]{Planetar}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Planetar.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Priest}
...
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Agent}

\begin{DndMonster}[float=ht]{Scholarly Agent}
\DndMonsterType{S or M humanoid (wizard), any alignment}
\DndMonsterBasics[
armor-class = {11},
...
\DndMonsterAction{Spellcasting}
The agent casts one of the following spells, using Intelligence as the spellcasting ability:
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{dancing lights, mage hand}
  \DndInnateSpellLevel[1e]{comprehend languages, identify, mage armor}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Arcane Shock}
\textsl{Melee or Ranged Spell Attack:} +5 to hit, reach 5 ft. or range 30 ft., one target. \textsl{Hit:} 14 (2d10 + 3) lightning damage. If the target is a creature, it can't take reactions until the start of its next turn.

\par
\DndMonsterSection{Reactions}
\DndMonsterAction{Glyph of Shielding}
The agent adds 2 to its AC against one attack that would hit it. To do so, the agent must be able to see the attacker and have a free hand.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Scholarly Agent.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Quasit}

\begin{DndMonster}[float=ht]{Quasit}
...
\clearpage
\addcontentsline{toc}{subsection}{Quipper}

\begin{DndMonster}[float=ht]{Quipper}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Quipper.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Reef Shark}

\begin{DndMonster}[float=ht]{Reef Shark}
...
\begin{DndMonster}[float=ht]{Revenant}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Revenant.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Riding Horse}

\begin{DndMonster}[float=ht]{Riding Horse}
\DndMonsterType{Large beast, unaligned}
\DndMonsterBasics[
armor-class = {10},
...
\clearpage
\addcontentsline{toc}{subsection}{Roper}

\begin{DndMonster}[float=ht]{Roper}
\DndMonsterType{Large monstrosity, neutral evil}
\DndMonsterBasics[
armor-class = {20 (natural armor)},
hit-points = {\DndDice{11d10 + 33}},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Roper.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Ruidium Elephant}

\begin{DndMonster}[float=ht]{Ruidium Elephant}
...
\DndMonsterAction{Trampling Charge}
If the elephant moves at least 20 feet straight toward a creature and then hits it with a Gore attack on the same turn, that target must succeed on a DC 16 Strength saving throw or be knocked prone. If the target is prone, the elephant can make one Stomp attack against it as a bonus action.

\par
\DndMonsterSection{Actions}
\DndMonsterAction{Gore}
\textsl{Melee Weapon Attack:} +10 to hit (with advantage if the target is a creature missing any hit points), reach 10 ft., one target. \textsl{Hit:} 25 (4d8 + 7) piercing damage plus 7 (2d6) psychic damage.

\DndMonsterAction{Stomp}
\textsl{Melee Weapon Attack:} +10 to hit, reach 5 ft., one prone creature. \textsl{Hit:} 29 (4d10 + 7) bludgeoning damage plus 7 (2d6) psychic damage.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Ruidium Elephant.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Agent}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Excavator}

\begin{DndMonster}[float=ht]{Scholarly Excavator}
\DndMonsterType{S or M humanoid, any alignment}
\DndMonsterBasics[
...
\DndMonsterAction{Siege Expert}
The excavator deals double damage to objects and structures.

\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
The excavator makes three Thunderous Warhammer attacks.

\DndMonsterAction{Thunderous Warhammer}
\textsl{Melee Weapon Attack:} +4 to hit, reach 5 ft., one target. \textsl{Hit:} 7 (1d10 + 2) thunder damage.

\par
\DndMonsterSection{Bonus Actions}
\DndMonsterAction{Telekinetic Toss Recharge 5-6}
The excavator targets one Medium or smaller creature or an object weighing 300 pounds or less that isn't being worn or carried. The target, which must be within 30 feet of the excavator and visible to it, is magically pushed up to 20 feet horizontally in a direction of the excavator's choice. If the target is a creature, it can make a DC 13 Strength saving throw to resist the effect and is not pushed on a successful save.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Scholarly Excavator.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Mastermind}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scout}
...
\begin{DndMonster}[float=ht]{Scuttling Serpentmaw}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Scuttling Serpentmaw.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Shadow Demon}

\begin{DndMonster}[float=ht]{Shadow Demon}
...
\clearpage
\addcontentsline{toc}{subsection}{Shield Guardian}

\begin{DndMonster}[float=ht]{Shield Guardian}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Shield Guardian.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Shira}

\begin{DndMonster}[float=ht]{Shira}
...
Shira casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 10, +2 to hit with spell attacks):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{chill touch}
  \DndInnateSpellLevel[1e]{blindness/deafness, ray of sickness}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Club}
...
\begin{DndMonster}[float=ht]{Slithering Bloodfin}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Slithering Bloodfin.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Skeleton}

\begin{DndMonster}[float=ht]{Skeleton}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Skeleton.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Slithering Bloodfin}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Solar}

\begin{DndMonster}[float=ht]{Solar}
\DndMonsterType{Large celestial, lawful good}
\DndMonsterBasics[
armor-class = {21 (natural armor)},
hit-points = {\DndDice{18d10 + 144}},
speed = {50 ft., 150 ft. (key)}
]
\DndMonsterAbilityScores[
 str = 26,
 dex = 22,
...
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{detect evil and good, invisibility}
  \DndInnateSpellLevel[3e]{blade barrier, dispel evil and good, resurrection}
  \DndInnateSpellLevel[1e]{commune, control weather}
\end{DndMonsterSpells}
\par
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
...
\DndMonsterLegendaryAction{Blinding Gaze (Costs 3 Actions)}{The solar targets one creature it can see within 30 feet of it. If the target can see it, the target must succeed on a DC 15 Constitution saving throw or be blinded until magic such as the lesser restoration spell removes the blindness.
}
\end{DndMonsterLegendaryActions}
\end{DndMonster}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Solar.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Sorrowfish}

\begin{DndMonster}[float=ht]{Sorrowfish}
...
\DndMonsterAction{Blood Frenzy}
The sorrowfish has advantage on melee attack rolls against any creature that doesn't have all its hit points.

\DndMonsterAction{Water Breathing}
The Sorrowfish can breathe only underwater.
...
\clearpage
\addcontentsline{toc}{subsection}{Spy}

\begin{DndMonster}[float=ht]{Spy}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
armor-class = {12},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Spy.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Stone Golem}

\begin{DndMonster}[float=ht]{Stone Golem}
\DndMonsterType{Large construct, unaligned}
\DndMonsterBasics[
armor-class = {17 (natural armor)},
hit-points = {\DndDice{17d10 + 85}},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Stone Golem.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Succubus}

\begin{DndMonster}[float=ht]{Succubus}
\DndMonsterType{Medium fiend (shapechanger), neutral evil}
\DndMonsterBasics[
armor-class = {15 (natural armor)},
hit-points = {\DndDice{12d8 + 12}},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Succubus.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Swarm of Quippers}

\begin{DndMonster}[float=ht]{Swarm of Quippers}
\DndMonsterType{Medium beast, unaligned}
\DndMonsterBasics[
armor-class = {13},
...
\begin{DndMonster}[float=ht]{Swarm of Sorrowfish}
\DndMonsterType{Medium aberration, unaligned}
\DndMonsterBasics[
armor-class = {14},
hit-points = {\DndDice{16d8 + 32}},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Swarm of Sorrowfish.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Sword Wraith Commander}

\begin{DndMonster}[float=ht]{Sword Wraith Commander}
\DndMonsterType{Medium undead, lawful evil}
\DndMonsterBasics[
...
\begin{DndMonster}[float=ht]{Sword Wraith Warrior}
\DndMonsterType{Medium undead, lawful evil}
\DndMonsterBasics[
armor-class = {16 (chain shirt)},
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MPMM/Sword Wraith Warrior.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Thug}

\begin{DndMonster}[float=ht]{Thug}
\DndMonsterType{Medium humanoid (any race), any non-good alignment}
\DndMonsterBasics[
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Thug.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Verin Thelyss}

\begin{DndMonster}[float=ht]{Verin Thelyss}
\DndMonsterType{Medium humanoid (drow, elf), lawful good}
\DndMonsterBasics[
armor-class = {17 (half plate armor)},
hit-points = {\DndDice{13d8 + 26}},
speed = {30 ft.}
...
\DndMonsterAction{Fey Ancestry}
Verin has advantage on saving throws against being charmed, and magic can't put him to sleep.

\DndMonsterAction{Sunlight Sensitivity}
While in sunlight, Verin has disadvantage on attack rolls, as well as on Wisdom (Perception) checks that rely on sight.

\DndMonsterAction{Spellcasting}
Verin casts one of the following spells, requiring no material components and using Charisma as the spellcasting ability (spell save DC 14):
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{dancing lights}
  \DndInnateSpellLevel[1e]{darkness, faerie fire, levitate}
\end{DndMonsterSpells}
...
\DndMonsterSection{Actions}
\DndMonsterAction{Multiattack}
Verin makes three Glaive attacks.

\DndMonsterAction{Glaive}
\textsl{Melee Weapon Attack:} +7 to hit, reach 10 ft., one target. \textsl{Hit:} 9 (1d10 + 4) slashing damage.

\DndMonsterAction{Hand Crossbow}
\textsl{Ranged Weapon Attack:} +7 to hit, range 30/120 ft., one target. \textsl{Hit:} 5 (1d6 + 2) piercing damage plus 22 (4d10) poison damage.

\par
\DndMonsterSection{Bonus Actions}
\DndMonsterAction{Manifest Echo}
...
\DndMonsterAction{Reposition}
Verin magically swaps places with his echo.

\par
\DndMonsterSection{Reactions}
\DndMonsterAction{Parry}
Verin adds 3 to his AC against one melee attack that would hit him. To do so, he must see the attacker and be wielding a melee weapon.

\end{DndMonster}


\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/CRCotN/Verin Thelyss.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Veteran}

\begin{DndMonster}[float=ht]{Veteran}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
...
\clearpage
\addcontentsline{toc}{subsection}{Vrock}

\begin{DndMonster}[float=ht]{Vrock}
\DndMonsterType{Large fiend (demon), chaotic evil}
\DndMonsterBasics[
armor-class = {15 (natural armor)},
hit-points = {\DndDice{11d10 + 44}},
speed = {40 ft., 60 ft. (key)}
]
\DndMonsterAbilityScores[
 str = 17,
 dex = 15,
...
\clearpage
\addcontentsline{toc}{subsection}{Warhorse}

\begin{DndMonster}[float=ht]{Warhorse}
\DndMonsterType{Large beast, unaligned}
\DndMonsterBasics[
armor-class = {11},
...
\clearpage
\addcontentsline{toc}{subsection}{Will-o'-Wisp}

\begin{DndMonster}[float=ht]{Will-o'-Wisp}
\DndMonsterType{Tiny undead, chaotic evil}
\DndMonsterBasics[
armor-class = {19},
hit-points = {\DndDice{9d4}},
speed = {0 ft., {'number': 50, 'condition': '(hover)'} ft. (key), True ft. (key)}
]
\DndMonsterAbilityScores[
 str = 1,
 dex = 28,
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{images/bestiary/MM/Will-o'-Wisp.png}
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Scholarly Excavator}
...
\end{figure}
\clearpage
\addcontentsline{toc}{subsection}{Yochlol}

\begin{DndMonster}[float=ht]{Yochlol}
...
\begin{DndMonsterSpells}
  \DndInnateSpellLevel{detect thoughts, web}
...
\clearpage
\addcontentsline{toc}{subsection}{Young Horizonback Tortoise}

\begin{DndMonster}[float=ht]{Young Horizonback Tortoise}
\DndMonsterType{Huge beast, unaligned}
\DndMonsterBasics[
armor-class = {15 (natural armor)},
hit-points = {\DndDice{8d12 + 16}},
...
\DndMonsterAction{Amphibious}
The young horizonback tortoise can breathe air and water.

\par
\DndMonsterSection{Actions}
\DndMonsterAction{Bite}
\textsl{Melee Weapon Attack:} +7 to hit, reach 10 ft., one target. \textsl{Hit:} 18 (4d6 + 4) piercing damage. If the target is a creature, it must succeed on a DC 14 Strength saving throw or be knocked prone.
...
% \chapter{Spell References}
% \addcontentsline{toc}{subsection}{Animal Friendship}
...
% \addcontentsline{toc}{subsection}{Barkskin}
...
% {1 action}
% {Touch}
% {V, S, a handful of oak bark}
% {Concentration, up to 1 hour}
% You touch a willing creature. Until the spell ends, the target's skin has a rough, bark-like appearance, and the target's AC can't be less than 16, regardless of what kind of armor it is wearing.

% \addcontentsline{toc}{subsection}{Bestow Curse}
...
% \addcontentsline{toc}{subsection}{Blindness/Deafness}
...
% \addcontentsline{toc}{subsection}{Chill Touch}
...
% \addcontentsline{toc}{subsection}{Commune}
...
% {1 minute}
% {Self}
% {V, S, incense and a vial of holy or unholy water}
% {1 minute}
% You contact your deity or a divine proxy and ask up to three questions that can be answered with a yes or no. You must ask your questions before the spell ends. You receive a correct answer for each question.

% Divine beings aren't necessarily omniscient, so you might receive "unclear" as an answer if a question pertains to information that lies beyond the deity's knowledge. In a case where a one-word answer could be misleading or contrary to the deity's interests, the DM might offer a short phrase as an answer instead.

% If you cast the spell two or more times before finishing your next long rest, there is a cumulative Answer chance for each casting after the first that you get no answer. The DM makes this roll in secret.

% \addcontentsline{toc}{subsection}{Continual Flame}
...
% \addcontentsline{toc}{subsection}{Cure Wounds}
...
% \addcontentsline{toc}{subsection}{Detect Magic}
...
% \addcontentsline{toc}{subsection}{Detect Thoughts}
...
% \addcontentsline{toc}{subsection}{Dispel Evil and Good}
...
% \addcontentsline{toc}{subsection}{Divination}
...
% \addcontentsline{toc}{subsection}{Earthquake}
...
% {1 action}
% {500 feet}
% {V, S, a pinch of dirt, a piece of rock, and a lump of clay}
% {Concentration, up to 1 minute}
...
% \addcontentsline{toc}{subsection}{Fly}
...
% \addcontentsline{toc}{subsection}{Greater Restoration}
...
% \addcontentsline{toc}{subsection}{Identify}
...
% \addcontentsline{toc}{subsection}{Knock}
...
% \addcontentsline{toc}{subsection}{Lesser Restoration}
...
% \addcontentsline{toc}{subsection}{Longstrider}
...
% \addcontentsline{toc}{subsection}{Mage Armor}
...
% \addcontentsline{toc}{subsection}{Otiluke's Resilient Sphere}
...
% {1 action}
% {30 feet}
% {V, S, a hemispherical piece of clear crystal and a matching hemispherical piece of gum arabic}
% {Concentration, up to 1 minute}
...
% \addcontentsline{toc}{subsection}{Pass without Trace}
...
% \addcontentsline{toc}{subsection}{Passwall}
...
% \addcontentsline{toc}{subsection}{Ray of Sickness}
...
% \addcontentsline{toc}{subsection}{Remove Curse}
...
% \addcontentsline{toc}{subsection}{See Invisibility}
...
% {1 action}
% {Self}
% {V, S, a pinch of talc and a small sprinkling of powdered silver}
% {1 hour}
% For the duration, you see invisible creatures and objects as if they were visible, and you can see into the Ethereal Plane. Ethereal creatures and objects appear ghostly and translucent.

% \addcontentsline{toc}{subsection}{Sending}
...
% \addcontentsline{toc}{subsection}{Shillelagh}
...
% {1 bonus}
% {Touch}
% {V, S, mistletoe, a shamrock leaf, and a club or quarterstaff}
% {1 minute}
% The wood of a club or quarterstaff you are holding is imbued with nature's power. For the duration, you can use your spellcasting ability instead of Strength for the attack and damage rolls of melee attacks using that weapon, and the weapon's damage die becomes a d8. The weapon also becomes magical, if it isn't already. The spell ends if you cast it again or if you let go of the weapon.

% \addcontentsline{toc}{subsection}{Spare the Dying}
...
% \addcontentsline{toc}{subsection}{Stone Shape}
...
% \addcontentsline{toc}{subsection}{Teleportation Circle}
...
% \addcontentsline{toc}{subsection}{Thunderwave}
...
% \addcontentsline{toc}{subsection}{Water Walk}
...
% \item You allow up to twenty creatures that you can see to regain all hit points, and you end all effects on them described in the greater restoration spell.
% \item You grant up to ten creatures that you can see resistance to a damage type you choose.
% \item You grant up to ten creatures you can see immunity to a single spell or other magical effect for 8 hours. For instance, you could make yourself and all your companions immune to a lich's life drain attack.
