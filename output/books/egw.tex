...
\newpage
\chapter{Preface}
\section{Imagination is a strange \& wonderful thing}
\begin{DndReadAloud}{}
\DndDropCapLine{I}{}magination drives innovation and inspires communal creation. For this geeky theater kid, imagination was my solace.


Since before my granny began reading me to sleep with \textit{The Lord of the Rings} and Piers Anthony at the age of seven, I found myself simultaneously lost in, and empowered by, imagination. From playing make-believe with my brother in our rainy, Florida yard as children, to mowing through video game RPG after RPG, I found myself drawn into stories, especially those I could shape alongside my friends. It wasn't until I was introduced to \textit{Dungeons \& Dragons} during my freshman year of high school that I found an experience that entwined everything I loved about storytelling, collaboration, theater, and creativity. I began building worlds for my friends to play in and filling notebooks with strange ideas, quirky NPCs, and mediocre story threads (hey, everyone has to start somewhere). I had found my favorite pastime, one that continues to lift me up and shape who I am today.

All these years later, through a magical series of circumstances, a group of gaming friends and I began streaming our home game of D\&D on the internet under the name \textit{Critical Role}, expecting little to no interest after spending nearly a decade in web media being told anything longer than five minutes has little value to the "ADHD generation." These myths were rapidly proven wrong, and our home game swelled into a community, then into an unanticipated phenomenon that has become something so deeply wonderful and important to me, and it seems, many others across the world.
...
\textit{Matthew Mercer, Dungeon Master of Critical Role}
...
\textit{Chapter 1} of this book introduces the big ideas you'll need to know before creating a campaign in Wildemount: its history and its gods.

\textit{Chapter 2} presents the major political players that shape daily life in Wildemount: its factions and societies. Depending on the choices made by your party of adventurers, these organizations might become their allies or their enemies. Some characters might begin play with a history of involvement with one of these factions, and several backgrounds are included later on to represent this allegiance.

\textit{Chapter 3} contains the Wildemount gazetteer, which details the cities and points of interest in each of the continent's regions. The gazetteer includes NPCs, background information, and even plot hooks that you can use as the seeds of your own adventures. It also gives a brief overview of the other lands of Exandria beyond Wildemount.

\textit{Chapter 4} is for players first and foremost; combined with the \textit{Player's Handbook}, it contains everything you need to create a character for a Wildemount campaign.

The final chapters of this book, \textit{chapters 5} through \textit{7}, give DMs starting adventures they can use to kick off their campaigns as well as new magic items and monsters to include in adventures of their own design.
...
\section{History of Wildemount}
\DndDropCapLine{T}{}he continent of Wildemount has undergone many ages of discovery, conflict, and renewal. These bygone eras are more than ancient history. Whether the people of Wildemount know it or not, the struggles they face in their daily lives were set in motion by the turbulent events of past ages. This section explores this history and the major figures whose actions shaped the physical and cultural landscape of Wildemount.
...
\begin{DndTable}[header=Prime Deities]{XcXXX}
...
\begin{DndTable}[header=Betrayer Gods]{XcXXX}
...
\begin{DndTable}[header=Lesser Idols]{XcXXX}
...
\textbf{Theft}: 5–10 days incarceration and/or a fine of twice the worth of the stolen goods.



\textbf{Worship of non-empire gods:} 30 days incarceration and a fine of 250 gp.



\textbf{Ownership of another intelligent humanoid creature:} 12–20 months incarceration and a fine of 1,800 gp.



\textbf{Trespassing}: 12 days incarceration and/or a fine of 215 gp.



\textbf{Failure to pay taxes to the Crown:} 5–30 days incarceration and a repossession of property equal to the amount owed.



\textbf{Damage to private property:} 5–15 days incarceration or a fine of twice the worth of property destroyed.



\textbf{Damage to Crown property:} 15–60 days incarceration and a fine of twice the worth of property destroyed.



\textbf{Kidnapping}: 60 days incarceration and/or a fine of 800 gp.



\textbf{Assault with intent to injure:} 30 days incarceration and/or a fine of 350 gp.



\textbf{Assault with intent to kill:} 250 days incarceration and/or a fine of 1,800 gp, or execution.



\textbf{Murder}: 8–15 years incarceration and/or a fine of 6,000 gp, or execution.



\textbf{Treason}: execution.
...
\textbf{Theft}: 2–5 days incarceration and a fine equal to the worth stolen.



\textbf{Ownership of another intelligent humanoid creature:} 10–20 months incarceration and a fine of 1,500 gp.



\textbf{Trespassing}: 5 days incarceration and a fine of 120 gp.



\textbf{Damage to private property:} 5–20 days incarceration or a fine of twice the worth of property destroyed.



\textbf{Damage to dynasty property:} 12–50 days incarceration and a fine of twice the worth of property destroyed.
...
\textbf{Worship of Betrayer Gods:} 150 days incarceration, or execution.



\textbf{Assault with intent to injure:} 12 days incarceration and a fine of 200 gp.



\textbf{Assault with intent to kill:} 200 days incarceration and a fine of 1,200 gp, or execution.



\textbf{Murder}: 5–10 years incarceration and/or a fine of 4,000 gp, or execution.
...
\textbf{Theft}: 3–10 days incarceration and/or a fine of twice the worth stolen.



\textbf{Public worship of Betrayer Gods:} 10 days incarceration and/or a fine of 300 gp.



\textbf{Ownership of another intelligent humanoid creature:} 6–12 months incarceration and/or a fine of 1,000 gp.



\textbf{Trespassing}: 7 days incarceration, and/or a fine of 100 gp.



\textbf{Failure to pay taxes to the Clovis Concord:} 3–15 days incarceration and a repossession of property equal to the amount owed.
...
\textbf{Damage to concord property:} 30–60 days incarceration and a fine of twice the worth of property destroyed.



\textbf{Kidnapping}: 30 days incarceration and/or a fine of 500 gp.



\textbf{Assault with intent to injure:} 15 days incarceration and/or a fine of 250 gp.



\textbf{Assault with intent to kill:} 170 days incarceration and/or a fine of 1,000 gp.



\textbf{Murder}: 5–10 years incarceration and/or a fine of 5,000 gp.
...
\item low level (1–6)
\item mid level (7–11)
\item high level (12–16)
\item epic level (17–20)
\end{itemize}
...
\begin{itemize}
\item \textit{Menagerie Coast}
\item \textit{Marrow Valley}
\item \textit{Zemni Fields}
\item \textit{Greying Wildlands}
\item \textit{Eiselcross}
\item \textit{Wastes of Xorhas}
\item \textit{Blightshore}
\item \textit{Distant Lands of Exandria}
\end{itemize}
...
\begin{DndReadAloud}{Song of Dashilla the Dreadful}
...
Deep beneath the waves of the open Lucidian Ocean lies a terrifying graveyard of wrecked, merrow-infested ships scattered across the ocean floor. This sunken cemetery of broken vessels is strewn over miles and miles, and each salvage ship that tries to reclaim cargo from the Diver's Grave only adds another corpse to its hungry sands. The Grave seems to sense ships as they approach and sends out a storm to consume them. At the heart of the Grave is an underwater maze of carnivorous seaweed, and within this dread labyrinth lives Dashilla the Dreadful, a terrible \textbf{sea fury} (see \textit{chapter 7}) who hungrily awaits her next shipment of wayward sailors.
...
\textbf{Solvia Groves Diamond Plum Wine:} 60 gp per bottle.



\textbf{Oveso Family Dark Red:} 35 gp per bottle.



\textbf{Rustlecall's Evening Dream Plum Wine:} 40 gp per bottle.



\textbf{Solvia Groves Sunset White Wine:} 30 gp per bottle.



\textbf{Cuthras Silver Vineyard Premium Red Wine:} 50 gp per bottle.
...
These three islands are comprised of steep, volcanic peaks with sheer cliff faces, pock-marked with numerous caves housing \textbf{Blood Hawk}, \textbf{Harpy}, and (rumor has it) an impossibly big \textbf{roc}. There are only small pockets of trees and jungle, so resources are scarce and few ships have a legitimate reason to stop here. However, this does not stop the Revelry from using the region for storage, ambushes, and meetings outside Darktow.
...
Weddings and religious ceremonies of all faiths take place amid the stars of the forest—but the lights are not always a friendly omen. The glowing insects also summon forth the nocturnal dinosaurs, amphibious \textbf{Swavain Basilisk} (see \textit{chapter 7}), and other night beasts that call the forest home.
...
Stumbling on a secret gathering of \textbf{Cultist} of Tiamat preparing to sacrifice a woman to their evil goddess, the adventurers must stop the ritual and free the captive, who aids them in the battle. She introduces herself as Calianna, a half-elf sorcerer with a draconic lineage that covers half of her body in black scales. She breathlessly describes this terrible cabal, known as the Cult of the Caustic Heart (see \textit{chapter 2}), and requests the characters' aid in vanquishing it once and for all.
...
Monsters are killing Grimgolir's miners. The typically tough and unbeatable Grimgolir soldiers can't seem to find the creatures. Looking for a fresh perspective, they hire the characters to hunt the monsters in the abandoned mine while operations are shutdown. The monsters are \textbf{Mimic} that turn into pickaxes, railcars, and other mining equipment. They strike at the characters with hit-and-run tactics, retreating into darkness and using their unique powers to blend in with the environment.

\subparagraph{Rise of the Worms (Epic Level)}
While the characters are in Grimgolir, several \textbf{Purple Worm} tunnel into the city, causing mass destruction. After the worms are killed or driven off, Kryn forces come through the tunnels created by the monstrosities, razing strategic military outposts while the city is already in disarray. The Kryn Dynasty knows how critical the city is to training Dwendalian troops, so they mobilized the worms and followed behind to deal Grimgolir a decisive blow.
...
While the characters are in Kamordah, an earthquake topples buildings and releases lava from beneath the earth. The broken earth also opens the way for \textbf{Magma Mephit} that cause mischief around the settlement. If the characters manage to save themselves from the chaos, there are plenty of other citizens in need of rescue.

\subparagraph{Twilight Phoenix (Epic Level)}
The truth of Kamordah's geothermal activity is far more sinister and fantastical than many know. The ancient and mad twilight phoenix Desirat (see \textit{chapter 1}) is chained beneath Mount Mentiri. A cabal of \textbf{Archmage} who worship Asmodeus seek to free the Lord of the Nine Hells' steed, secretly gathering components for a ritual to sunder the mountain and unleash the crazed entity to incinerate the countryside. If the characters cannot stop the ritual, they must combat the twisted, primal phoenix herself.
...
The characters are asked by the \textbf{aarakocra} of Vol'antim to help destroy a nest of gorefeather \textbf{Harpy}. During the quest, the characters uncover a clutch of harpy eggs, which the aarakocra believe should be destroyed, since legends say that each generation of harpies is stronger than the last. If the characters destroy the eggs, they will drive the harpies to greater acts of destruction. But they refuse, how might the aarakocra react?
...
As the characters travel through the region, they need to pass through the gate. When they get to the outpost, they learn that monsters from the mountains (\textbf{Gnoll}, \textbf{Hobgoblin}, \textbf{Orc}, or \textbf{Troll}) murdered the Crownsguard and have claimed the gate as their own. From this secure position, they launch more raids into the Marrow Valley. Someone has to stop them and take back the gate.
...
The characters are hired by the Myriad or the Kryn Dynasty to intercept imperial documents as they travel from Rexxentrum to Zadash. The first courier takes the documents as far as the crossroads before handling them off to a second courier. Both couriers are \textbf{Knight} of the Crownsguard mounted on \textbf{Warhorse}. The documents are war plans bearing magical wards and the seal of the king.
...
Hidden deep in the heart of the Dunrocks are the forgotten depths of the Bastille of Torment, a massive, multilevel dungeon where Torog tortured the enemies of the Betrayer Gods during the Age of Arcanum. This horrifying abandoned prison is now run by a cabal of \textbf{Spirit Naga}, who guard the many arcane secrets and treasures left by the Betrayers.
...
One square yard of \textit{pride silk} weighs 1 pound and costs 100 gp. An outfit made of pride silk weighs 4 pounds and costs 500 gp. If you aren't wearing armor, your base Armor Class is 11 + your Dexterity modifier while wearing it.
...
Marta Denizreitch (chaotic neutral, female, human \textbf{mage}) lives in a remote tower where she experiments with conjuration magic to develop new spells. The Cerberus Assembly funds Marta's research. Years ago, Marta had a problem with \textbf{Troll} attacking the tower, so she summoned \textbf{Hell Hound} to roam the wilds near her tower and keep the trolls at bay. She does not want the hell hounds to cause problems down the line, so she hires the characters to hunt a few to keep the population down. The characters discover they aren't the only ones killing hell hounds: a \textbf{hill giant} and a small gang of trolls are killing the hounds in preparation for an attack on Marta's tower!
...
Kravaraad's \textbf{Fire Giant} have greedily amassed treasure since the time before the Calamity. To reach their subterranean vault, the characters must sneak by or carve through the latest creatures who have challenged the fire giants (often \textbf{Frost Giant} or other creatures that can endure the cold). But making it to the fire giants is only half the battle. The fire giants have hewn a vast dungeon under the mountain, and characters must navigate its perils while maintaining their balance whenever Kravaraad causes the entire complex to tremble. The vault itself is guarded by an enslaved \textbf{adult red dragon} that longs to be free.
...
d6 & Encounter\\
1 & The characters encounter 1d4 wildfolk \textbf{Scout} hunting a \textbf{saber-toothed tiger}. The scouts are out of arrows and willing to trade equipment and information to replenish their ammunition.\\
...
d6 & Encounter\\
1 & The characters encounter 1d4 + 1 \textbf{Mammoth} being hunted by 2d6 wildfolk \textbf{Scout}.\\
2 & An \textbf{abominable yeti} and 1d4 \textbf{Yeti} stalk the characters.\\
3 & The characters encounter 2d4 \textbf{Allowak Yeti} (see "\textit{Allowak's Sanctuary Yeti Statistics}" later in this chapter). The yetis attempt to scare the characters away but do not wish to do harm.\\
4 & The characters pass an Aeorian building that crashed nearby. The building contains 1d4 + 4 \textbf{Wight}.\\
5 & An \textbf{Aeorian absorber} (see \textit{chapter 7}) ambushes the characters.\\
...
3 & The characters find a camp of 2d4 \textbf{Minotaur} and 4d6 \textbf{Orc} looking for wildfolk to recruit for the Kryn. These explorers want to keep their operation covert. If they aren't convinced the characters can keep their secret, the Xhorhasians attack.\\
4 & A \textbf{roc} flies overhead and attempts to scoop up a character of your choice as its next meal.\\
5 & The characters encounter a coven of three \textbf{Night Hag} searching for Aeorian items. In their humanoid guises, these hags pretend to be lost explorers and request the characters' escort. When the characters are in a vulnerable spot, the hags reveal their true nature and attack.\\
6 & The characters are ambushed by 1d8 + 1 \textbf{Frost Giant}.\\
\end{DndTable}

\begin{DndTable}[header=Eiselcross Encounters: Levels 17–20]{cX}

d8 & Encounter\\
1 & The characters find the buried top of an Aeorian tower that crashed into the ice. Ice fills the lower levels of the tower, and 1d4 + 1 \textbf{Aeorian Nullifier} (see \textit{chapter 7}) are frozen in the ice.\\
2 & The characters encounter 2d6 gladiator wormkin (see "\textit{Tomb of the Worm}" later in this chapter) attempting to force-feed a group of 3d6 wildfolk \textbf{Commoner} the meat of the Undermaw.\\
...
4 & The characters encounter two \textbf{Mage} from Balenpost planning to steal an Aeorian item from a camp of 3d6 \textbf{Frost Giant} and their tamed \textbf{frost worm} (see \textit{chapter 7}) The mages ask for the characters' help with the heist.\\
...
6 & The characters encounter 2d6 \textbf{Frost Giant Zombie} (see \textit{chapter 7}). These zombies did not come from the Fortress of the Dead Jarl. Their origin is up to you.\\
...
\item In their exalted state, the Arms of the Betrayers (see \textit{chapter 6}) are powerful enough to break the bubbles with an attack.
\end{itemize}

\subparagraph{Arms and Armor}
Aeorian technology was created to battle the gods and their servants. Explorers seek weapons and armor, most of which is crafted to pierce divine defenses and guard against deific assaults. Weapons as small as daggers and as large as cannons were crafted in Aeor. Although much was destroyed in the crash, there are still items in the rubble (see \textit{chapter 6}). The pieces are valuable, and the blueprints for creating such powerful items would be priceless, though none have been found so far.
...
The \textbf{Allowak Yeti} are \textbf{Yeti} and \textbf{Abominable Yeti}, with these changes:
...
The Cerberus Assembly learns that King Dwendal's \textbf{Spy} have infiltrated Balenpost. They hire the characters to find and report the spies to Wardlow Akron. The characters might uncover Karta Meck's network of four spies within the camp or find a lead-lined box among Karta's supplies which holds a sending stone paired with another held by Oliver Schreiber (see "\textit{Dwendalian Empire}" in chapter 2). If discovered, the spies attempt to win over the characters, promising an Aeorian item in exchange for helping to discover what secrets are hidden in Horswell's lab.
...
When the characters arrive in Balenpost or Syrinlya, a \textbf{frost giant zombie} (see \textit{chapter 7}) attacks the camp. If the characters help defeat the giant, the leader of the camp tells the characters it is the third attack in as many days and asks them to find the source of the zombies. Characters can track the zombies back to the fortress. Each day the characters follow this path, roll any die. On an even result, the characters encounter 1d4 frost giant zombies. When they reach the fortress, they find that one of the walls is breached and must repair it to stop the zombies from leaving the castle. This breach could be natural or could be caused by a faction with a score to settle against the attacked outpost.
...
A pair of \textbf{Efreeti} recently emerged from the River Inferno, and the characters are the first intelligent creatures they find. Using \textit{tongues} spells, the efreet demand that the characters tell them everything they know about this strange land, then demand that the characters point them in the direction of the nearest settlement. The efreet plan to enslave the settlement's inhabitants and put them to work building an obsidian tower on the shore of the River Inferno, where the efreet can stay whenever they deign to visit this dismally cold corner of the multiverse.
...
While the characters stay in Asarius, \textbf{Spy} from the Dwendalian Empire infiltrate the city and simultaneously release war beasts from their pens after enraging them with whips and hot irons. As the characters try to stop the rampage, they learn that the spies are using the confusion to steal the city's secrets.

\subparagraph{Echo of the Past (Mid Level)}
A chaotic good, male, dranassar survivor named Jibu-Corryn has been living as a dark elf in Asarius under the name of Alyxikon, a minor government secretary. A cult of \textbf{Hobgoblin} and \textbf{Bugbear} who call themselves the Lords of Strife are hunting Jibu after hearing a rumor that one of the last of the dranassar are hiding in Asarius. Their leader, a hobgoblin captain named Gorthux, possesses the power to transform into a \textbf{bone devil} once per day, and plans to offer Jibu as a sacrifice to Bane.
...
A demon has made the forest bordering Charis its lair. Every day, the \textbf{hezrou} Garlagrag attempts to summon more and more demons into the forest, and the woods are now flush with hezrous and \textbf{Dretch}. The people of Charis seek aid to fight off the demons or to end Garlagrag's plot once and for all.
...
As dutiful servants of the Cerberus Assembly, the characters are tasked with ridding a local safe house of cult activity. But the operation doesn't go according to plan: one of the \textbf{Cultist} is the teenage son of a prominent assembly official, and the characters must decide whether they will shine a light on his indiscretion or bury it at the potential cost of becoming accomplices themselves.
...
\section{Distant Lands of Exandria}
...
{Sunbreaker Olomon}
\DndDropCapLine{T}{}he sprawling lands and endless challenges of Exandria forge heroes and villains of many different stripes. The myriad dangers of this wild continent constantly encroach upon innocents in need of protection, even as the legends and the magic of the past challenge those brave enough to reshape the world—for good or ill. The material in this chapter offers a number of new options for player characters to define who they are and what they wish to become.


The character options in this book are useful for players and Dungeon Masters alike, allowing adventurers and NPCs to take starring and supporting roles in your Wildemount D\&D campaign. In this chapter, you'll find stories and statistics that tie the races of the \textit{Player's Handbook} and the broader world of D\&D to the lands of Wildemount, as well as new subclasses, new backgrounds, and new spells focused on an esoteric study of magic known as dunamancy.

The races, classes, and magic presented in this chapter might have different origins or defy the expectations established in other D\&D books. The information in this chapter is specific to Wildemount, and in some cases, to the wider world of Exandria. If something in this book differs from what's presented in the \textit{Player's Handbook}, this material takes precedence in a Wildemount campaign.

\section{Races}
The nations of Wildemount are populated by people of many different races. All the races present in the \textit{Player's Handbook}, as well as many of the other races of the D\&D game, have a home in Wildemount. However, some of those races have cultures that differ from those of their kin elsewhere in the multiverse. This chapter provides cultural information about the common races of Wildemount, plus several subraces not found in the \textit{Player's Handbook}.
...
In addition to the races of the \textit{Player's Handbook}, Wildemount is home to many other races, including the following:

\textbf{Aarakocra}, bird-like humanoids who roost on isolated mountaintops

\textbf{Aasimar}, beings who gain supernatural power from the angelic spark in their souls

\textbf{Firbolgs}, forest guardians who engage in peaceful methods to protect their homes

\textbf{Genasi}, humanoids imbued with elemental power as a result of their birth

\textbf{Goblins}, outcast scavengers descended from the experiments of a dark god

\textbf{Goliaths}, hulking wanderers who dwell atop the highest mountains

\textbf{Kenku}, accursed corvine humanoids who can speak only using mimicry

\textbf{Tortles}, tortoise-like humanoids with an innate connection to the sea
...
\subsection{Dwarves in the Dwendalian Empire}
...
\subsection{Dwarves on the Menagerie Coast}
...
\subsection{Elves in the Dwendalian Empire}
...
\subsection{Elves on the Menagerie Coast}
...
\subsection{Elf Subraces}
At the DM's discretion, players have access to the pallid elf and sea elf subraces described below, in addition to the elf subraces in the \textit{Player's Handbook}.
...
\subsection{Halflings in the Dwendalian Empire}
...
\subsection{Halflings on the Menagerie Coast}
...
\subsection{Halflings in Xhorhas}
...
\subsection{Halfling Subraces}
At the DM's discretion, players have access to the halfling (lotusden) subrace, in addition to the halfling subraces in the \textit{Player's Handbook}.
...
\subsection{Humans in the Dwendalian Empire}
...
\subsection{Humans on the Menagerie Coast}
...
\subsection{Aarakocra on the Menagerie Coast}
...
\subsection{Aarakocra in Xhorhas}
...
\subsection{Aasimar in the Dwendalian Empire}
...
\subsection{Aasimar on the Menagerie Coast}
...
\subsection{Aasimar Traits}

\begin{itemize}
\item Aasimar (Protector)
\item Aasimar (Scourge)
\item Aasimar (Fallen)
\end{itemize}
...
\subsection{Dragonborn Variants}
You can allow a player to choose one of the following dragonborn variants.


\begin{itemize}
\item Dragonborn (Draconblood)
\item Dragonborn (Ravenite)
\end{itemize}

\subsection{Dragonborn in the Dwendalian Empire}
...
\subsection{Dragonborn on the Menagerie Coast}
...
\subsection{Dragonborn in Xhorhas}
...
\subsection{Firbolgs in the Dwendalian Empire}
...
\subsection{Firbolgs on the Menagerie Coast}
...
\subsection{Firbolgs in Xhorhas}
...
\subsection{Genasi in the Dwendalian Empire}
...
\subsection{Genasi on the Menagerie Coast}
...
\subsection{Gnomes in the Dwendalian Empire}
...
\subsection{Gnomes on the Menagerie Coast}
...
\subsection{Goblinkin in the Dwendalian Empire}
Goblins living in Western Wynandir form small tribal groups and do their best to evade the vigilant eye of the imperial army. The fearsome soldiers of the Righteous Brand, known to the goblins as \textit{drohurror} or "terrorfolk," are the greatest threat to the tribes. But with goblins treated as little better than vermin throughout the empire, any imperial citizen strong enough to wield a pitchfork can be a threat in their own right.
...
\subsection{Goblinkin on the Menagerie Coast}
...
\begin{DndSidebar}[float=!b]{Goblinkin and the Curse of Strife}
...
\subsection{Half-Elves in the Dwendalian Empire}
...
\subsection{Half-Elves on the Menagerie Coast}
...
\subsection{Half-Elves in Xhorhas}
...
\subsection{Half-Orcs in the Dwendalian Empire}
...
\subsection{Half-Orcs on the Menagerie Coast}
...
\subsection{Half-Orcs in Xhorhas}
...
\subsection{Tieflings in the Dwendalian Empire}
...
\subsection{Tieflings on the Menagerie Coast}
...
\subsection{Tieflings in Xhorhas}
...
\subsection{Supernatural Gift: Hollow One}
...
\subsection{Dunamis and Dunamancy}
...
\subsubsection{Beyond the Kryn Dynasty}
...
\subsubsection{Dunamis as a Martial Focus}
...
At 3rd level, a fighter gains the Martial Archetype class feature described in the \textit{Player's Handbook}. The fighter is a new option for that feature.
...
At 2nd level, a wizard gains the Arcane Tradition class feature described in the \textit{Player's Handbook}. wizard and wizard are two new traditions available to wizards.

\subsection{Dunamancy Spells}
...
\subsubsection{Dunamancy Spell List}

\begin{description}
\item[Cantrips.]
\textit{sapping sting} (necromancy)

\item[Level 1.]
\textit{gift of alacrity}* (divination)

\textit{magnify gravity}** (transmutation)

\item[Level 2.]
\textit{fortune's favor} (divination)

\textit{immovable object}** (transmutation)

\textit{wristpocket} (conjuration, ritual)

\item[Level 3.]
\textit{pulse wave} (evocation)

\item[Level 4.]
\textit{gravity sinkhole}** (evocation)

\item[Level 5.]
\textit{temporal shunt}* (transmutation)

\item[Level 6.]
\textit{gravity fissure}** (evocation)

\item[Level 7.]
\textit{tether essence} (necromancy)

\item[Level 8.]
\textit{dark star}** (evocation)

\textit{reality break}* (conjuration)

\item[Level 9.]
\textit{ravenous void}** (evocation)

\textit{time ravage}* (necromancy)
...
\begin{DndSidebar}[float=!b]{Dunamancy for Non-Dunamancers}
...
\begin{itemize}
\begin{multicols}{2}
\item \textit{Dark Star}
\item \textit{Fortune's Favor}
\item \textit{Gift of Alacrity}
\item \textit{Gravity Fissure}
\item \textit{Gravity Sinkhole}
\item \textit{Immovable Object}
\item \textit{Magnify Gravity}
\item \textit{Pulse Wave}
\item \textit{Ravenous Void}
\item \textit{Reality Break}
\item \textit{Sapping Sting}
\item \textit{Temporal Shunt}
\item \textit{Tether Essence}
\item \textit{Time Ravage}
\item \textit{Wristpocket}
\end{multicols}

\end{itemize}

\subsection{Heroic Chronicle}
...
\begin{DndTable}[header=Social Status Relationships]{cXcccc}
...
\subparagraph{Homeland}
The known lands of Wildemount are divided into four major geographic regions, each of which is described in \textit{chapter 3}. From west to east, these regions are the Menagerie Coast, Western Wynandir (which is further divided into the Marrow Valley and the Zemni Fields), the Greying Wildlands, and Eastern Wynandir. The northernmost reaches of the continent—the forgotten lands of Eiselcross—are not included in this section.
...
\begin{DndTable}[header=Homelands]{cX}
...
In addition to granting you items, gold, and proficiencies, your background gives you a sense of belonging in the world. You can roll on the Backgrounds table to randomly determine your character's background, or you can choose one that fits your character concept. This table includes new backgrounds and adapted backgrounds from this book (EGW) as well as the backgrounds from the \textit{Player's Handbook} (PH). New and adapted backgrounds are described later in this chapter.

\begin{DndTable}[header=Backgrounds]{cXc}
...
\subparagraph{Greying Wildlands}
...
\begin{DndTable}[header=Marrow Valley Settlements]{cXX}
...
\begin{DndTable}[header=Zemni Fields Settlements]{cXX}
...
\begin{DndTable}[header=Greying Wildlands Settlements]{cXX}
...
\begin{DndTable}[header=Eastern Wynandir Settlements]{cXX}
...
\begin{DndTable}[header=Family Size (Village)]{cXX}
...
\begin{DndTable}[header=Family Size (City)]{cXX}
...
\begin{DndTable}[header=Family Relationships]{cX}
...
\subparagraph{Acquired Allies and Rivals}
...
When you've determined the relationships between you and your acquired allies and rivals, roll for each one on the Ally and Rival Identities table to determine their game statistics. This table includes monsters and NPCs in this book (EGW) and in the \textit{Monster Manual} (MM).
...
\begin{DndTable}[header=Ally Relationships]{cX}
...
\begin{DndTable}[header=Rival Relationships]{cX}
...
\subparagraph{Secret Identities}
Some of these allies and rivals might keep their true identity secret from your character. The DM can decide to make one or more of the rolls on the Ally and Rival Identities table to keep the secret intact. Stat blocks appear in either appendix B of the \textit{Monster Manual} (MM) or \textit{chapter 7} of this book (EGW).

\begin{DndTable}[header=Ally and Rival Identities]{cX}

d100 & Stat Block\\
01–05 & \textbf{Commoner} (MM)\\
06–10 & \textbf{Acolyte} (MM)\\
11–15 & \textbf{Bandit} (MM)\\
16–20 & \textbf{Bandit captain} (MM)\\
21–25 & \textbf{Berserker} (MM)\\
26–30 & \textbf{Cultist} (MM)\\
31–35 & \textbf{Cult fanatic} (MM); gain one fateful moment\\
36–40 & \textbf{Druid} (MM)\\
41–45 & \textbf{Gladiator} (MM); gain one fateful moment\\
46–50 & \textbf{Guard} (MM)\\
51–55 & \textbf{Knight} (MM)\\
56–60 & \textbf{Priest} (MM)\\
61–65 & \textbf{Scout} (MM)\\
66–70 & \textbf{Spy} (MM)\\
71–75 & \textbf{Tribal warrior} (MM)\\
76–80 & \textbf{Veteran} (MM)\\
81–84 & \textbf{Mage} (MM); gain one fateful moment\\
85–88 & \textbf{Noble} (MM); gain one fateful moment\\
89–92 & \textbf{Assassin} (MM); gain one fateful moment\\
93–94 & \textbf{Blood hunter} (EGW); gain one fateful moment\\
95–96 & Good or neutral \textbf{werebear} or \textbf{weretiger} (DM's choice; MM); gain one fateful moment\\
97–98 & Evil \textbf{wereboar}, \textbf{wererat}, or \textbf{werewolf} (DM's choice; MM); gain one fateful moment\\
99 & \textbf{Archmage} (MM); gain one fateful moment\\
00 & \textbf{Adult gold dragon} or \textbf{adult red dragon} (DM's choice; MM); gain one fateful moment\\
\end{DndTable}

\subparagraph{Fateful Moments}
...
\begin{DndTable}[header=Fateful Moments]{cX}

d20 & Event\\
1 & Your parents were murdered in front of you. Roll on the \textit{Ally and Rival Identities table} to determine the type of creature that killed them. You have proficiency in the Stealth and Survival skills.\\
2 & You met a dark elf dying in the wilderness. Around their neck was a silver talisman containing a cameo of their child and the name "Il'viranya." It is an \textit{amulet of proof against detection and location}.\\
3 & A mysterious stranger gave you a gift that saved your life while you were lost in the wilderness. Roll on the \textit{Ally and Rival Identities table} to determine the identity of the stranger. Then roll on Magic Item Table B in the \textit{Dungeon Master's Guide} to determine the item. If you roll a consumable item from the table, roll again.\\
...
7 & A famous mage saw potential in you and tutored you in the arcane arts. You have a spellbook and the Magic Initiate feat from the \textit{Player's Handbook}.\\
...
9 & You were transformed into a bear by mysterious magic, and lived for a year as an animal before you were saved by a druid. Magic still lingers within you, though, and you can cast \textit{speak with animals} at will.\\
...
12 & You were visited by a demon lord in a dream. You awakened knowing the \textit{find familiar} spell and are now able to cast it as a ritual, but your familiar always takes the form of a \textbf{quasit}. You also have a random form of indefinite madness, determined by rolling on the indefinite madness in chapter 8 of the \textit{Dungeon Master's Guide}.\\
13 & While exploring a remote forest, you were attacked by evil lycanthropes but escaped before being killed. You are cursed with \textbf{wereboar}, \textbf{wererat}, or \textbf{werewolf} lycanthropy (DM's choice).\\
14 & While lost in a remote forest or jungle, you were saved by a \textbf{werebear} or \textbf{weretiger} (DM's choice). The lycanthrope believed you were destined for greatness and granted you the gift of lycanthropy with your consent.\\
15 & You saved a pseudodragon from being eaten by a giant spider in a dark forest. The \textbf{pseudodragon} now loyally follows you wherever you go, even if you'd rather it stay hidden. It is controlled by the DM but obeys your commands if treated well.\\
16 & You nearly died from a virulent disease (the DM's choice of cackle fever, sewer plague, or sight rot; see \textit{chapter 8} of the \textit{Dungeon Master's Guide}). Your life was saved by an agent of the Cobalt Soul, who could not cure the disease, but who gave you a \textit{periapt of health} that suppresses it.\\
...
18 & You saved a riderless horse wearing full tack and harness from wolves. You own a \textbf{riding horse} and a saddle, and you have proficiency in the Animal Handling skill.\\
...
\begin{DndTable}[header=Favorite Foods (Menagerie Coast)]{cX}
...
\begin{DndTable}[header=Favorite Foods (Western Wynandir)]{cX}
...
\begin{DndTable}[header=Favorite Foods (Greying Wildlands)]{cX}
...
\begin{DndTable}[header=Favorite Foods (Eastern Wynandir)]{cX}
...
\subparagraph{Mysterious Secret}
...
\begin{DndTable}[header=Mysterious Secrets]{cX}
...
\begin{DndTable}[header=Prophecy Inspirations]{cX}
...
\subparagraph{For the Dungeon Master}
...
\begin{itemize}
\item For the next 1d10 days, the character gains inspiration whenever they finish a long rest.
\item For the next 1d10 days, the character has advantage on saving throws to avoid being frightened.
\item For the next 1d4 days, the character's weapon attacks deal an extra 1d6 damage of the weapon's type.
\end{itemize}

\subsection{Backgrounds}
This section presents two new backgrounds—the Grinner and the Volstrucker Agent—as well as suggestions for adapting some of the backgrounds from the \textit{Player's Handbook} to tie them more closely to the factions of Wildemount.
...
\subsubsection{Adapting Backgrounds}
All the backgrounds from the \textit{Player's Handbook} fit perfectly into Wildemount. Additionally, though, a number of existing backgrounds can be adapted to represent specific factions in the campaign.


\begin{itemize}
\begin{multicols}{2}
\item Augen Trust (Spy)
\item Cobalt Scholar (Sage)
\item Luxonborn (Acolyte)
\item Myriad Operative (Criminal)
\item Revelry Pirate (Sailor)
\end{multicols}

\end{itemize}

\chapter{Adventures in Wildemount}
\DndQuote%
{}
...
The \textit{Monster Manual} contains statistics for many of the creatures found in these adventures. When a creature's name appears in \textbf{bold} type, that's a visual cue pointing you to the creature's stat block in the \textit{Monster Manual}. If the stat block instead appears in this book, the adventure's text tells you so.

The names of spells and magic items referenced in the adventure are in \textit{italics}. If a spell or magic item appears in this book, the text will say so. If it doesn't, information on spells can be found in the \textit{Player's Handbook} and information on magic items can be found in the \textit{Dungeon Master's Guide}.

\section{Using These Adventures}
...
\section{Magic Items of Wildemount}
...
Many of the magic items in this section are relics of the flying city-state of Aeor, and can often be found in Aeorian ruins in Eiselcross. See \textit{chapter 3} for more information on Eiselcross and Aeor.


\begin{itemize}
\begin{multicols}{4}
\item \textit{Acheron Blade}
\item \textit{Amulet of the Drunkard}
\item \textit{Arcane Cannon}
\item \textit{Battering Shield}
\item \textit{Bloodaxe}
\item \textit{Breathing Bubble}
\item \textit{Brooch of Living Essence}
\item \textit{Butcher's Bib}
\item \textit{Coin of Delving}
\item \textit{Corpse Slayer}
\item \textit{Dispelling Stone}
\item \textit{Duskcrusher}
\item \textit{Dust of Deliciousness}
\item \textit{Goggles of Object Reading}
\item \textit{Hunter's Coat}
\item \textit{Last Stand Armor}
\item \textit{Luxon Beacon}
\item \textit{Needle of Mending}
\item \textit{Nightfall Pearl}
\item \textit{Orb of the Veil}
\item \textit{Potion of Maximum Power}
\item \textit{Potion of Possibility}
\item \textit{Reincarnation Dust}
\item \textit{Ring of Obscuring}
\item \textit{Ring of Temporal Salvation}
\item \textit{Rod of Retribution}
\item \textit{Spell Bottle}
\item \textit{Staff of Dunamancy}
\item \textit{Staff of the Ivory Claw}
\item \textit{Vox Seeker}
\item \textit{Weapon of Certain Death}
\end{multicols}

\end{itemize}

\section{Vestiges of Divergence}
...
Each Vestige of Divergence is a magic item that evolves with its wielder. If not attuned to a worthy individual over a prolonged period, such items commonly revert to their \textbf{dormant state}. While in this state, a Vestige of Divergence grants an attuned bearer only some of its power. Over time, and in response to perseverance and personal growth, a Vestige of Divergence might unlock facets of its lost capabilities to enter an \textbf{awakened state}. Eventually, through extreme personal challenge, evolution, and achievement, these artifacts can reach their ultimate potential in their \textbf{exalted state}. The properties and features gained at each new state are cumulative with the properties and features granted at a previous state, unless otherwise noted.
...
\begin{itemize}
\begin{multicols}{2}
\item \textit{Danoth's Visor}
\item \textit{Grimoire Infinitus}
\item \textit{Hide of the Feral Guardian}
\item \textit{Infiltrator's Key}
\item \textit{Stormgirdle}
\item \textit{Verminshroud}
\item \textit{Wreath of the Prism}
\end{multicols}

\end{itemize}

\begin{DndSidebar}[float=!b]{Advancement of a Vestige of Divergence}
...
\begin{itemize}
\item A character overcomes one of their greatest fears, bravely facing an otherwise paralyzing phobia to save a fellow party member.
\item A character is beaten within an inch of their life by a long-hated foe. In the face of defeat, they feel a deep, dormant strength grow from within.
\item A character loses a close ally in battle, their anguish and fury stirring the power within a Vestige of Divergence.
\item A character discovers a facet of their destiny that guides them toward a dangerous cause. Setting aside their fears, they accept their fate and responsibility.
\item A character successfully takes vengeance against a rival who has long tormented them.
\item A character known for restraint gives in to the amoral, violent urges that a Vestige of Divergence was forged to hone.
\end{itemize}
...
\section{Arms of the Betrayers}
The Arms of the Betrayers are sentient weapons forged from the souls of fiends by the Betrayer Gods for their humanoid champions. (See "\textit{Lesser Idols}" in chapter 1 for more details.) These artifacts are more than just magic items. They are powerful sentient beings, filled with fury and eager to be wielded—and to spill blood.

\subsection{Betrayer Artifact Properties}
The Arms of the Betrayers advance in power in the same manner as the Vestiges of Divergence (see the previous section). In its dormant state, each of these artifacts has one minor beneficial property and one minor detrimental property. When the artifact attains an awakened state, it gains an additional minor beneficial property and an additional minor detrimental property. When the item reaches its exalted state, it gains a major beneficial property. See "\textit{Artifact Properties}" in chapter 7 of the \textit{Dungeon Master's Guide} for more information.

\subsection{Destroying These Artifacts}
...
\begin{DndTable}[header=Arms of the Betrayers Destruction]{cX}
...
4 & The fiery breath of an \textbf{ancient red dragon} is the only thing that can destroy the weapon.\\
5 & The weapon is destroyed if devoured by Uk'otoa.\\
6 & Thrusting the weapon into a \textit{Luxon beacon} destroys the weapon and the beacon alike.\\
...
\section{Artifact Descriptions}
These artifacts are presented in alphabetical order. For the rules on artifacts, see \textit{chapter 7} of the \textit{Dungeon Master's Guide}.


\begin{itemize}
\begin{multicols}{2}
\item \textit{Blade of Broken Mirrors}
\item \textit{Grovelthrash}
\item \textit{Lash of Shadows}
\item \textit{Mace of the Black Crown}
\item \textit{Ruin's Wake}
\item \textit{Silken Spite}
\item \textit{The Bloody End}
\item \textit{Will of the Talon}
\end{multicols}

\end{itemize}

\chapter{Wildemount Bestiary}
\DndQuote%
{}
...
\DndDropCapLine{E}{}ndless turmoil has scarred Wildemount, from the wars of ages long past to the more recent bloody conflicts between the many factions that lay claim to this land. These struggles have shaped the past and the future—even as they have imbued the denizens of Wildemount with the tenacity to survive in a world filled with danger.


This chapter provides stat blocks for various creatures of Wildemount. These creatures are presented in alphabetical order. For guidance on how to use a creature's stat block, see the introduction of the \textit{Monster Manual}.

\section{Wildemount NPCs}
Appendix B of the Monster Manual contains stat blocks that can be used to represent most nonplayer characters (NPCs) in Wildemount. You can modify these stat blocks to give NPCs features similar to the character options in \textit{chapter 4} of this book. For example, you can create an NPC dunamancer by taking the archmage or mage stat block in the \textit{Monster Manual} and replacing some of its spells with new spells from chapter 4, or you can take the knight or veteran stat block and add a trait similar to the Manifest Echo class feature of the Echo Knight in chapter 4.

\begin{DndSidebar}[float=!b]{Elder Evils of Exandria}
...
\begin{itemize}
\item Azathoth the Boundless
\item Bolothamogg Who Watches from Beyond the Stars
\item Ceratos of Many Minds
\item Father Llymic the Alien Thought Given Flesh
\item Haemnathuun the Blood Lord
\item Hadar the Dark Hunger
\item Hargut of the Gray Pestilence
\item Ityak-Ortheel the Elf-Eater
\item Maram of the Great Spear
\item Pandorym the Utter Annihilation
\item Piscaethces the Blood Queen
\item Rasalhague the Noxious Star
\item Shothotugg the Eater of Worlds
\item Tharizdun the Chained Oblivion
\item Y'chak the Violet Flame
\end{itemize}
...
\begin{itemize}
\begin{multicols}{4}
\item \textbf{Aeorian Absorber}
\item \textbf{Aeorian Nullifier}
\item \textbf{Aeorian Reverser}
\item \textbf{Blood Hunter}
\item \textbf{Bristled Moorbounder}
\item \textbf{Core Spawn Crawler}
\item \textbf{Core Spawn Emissary}
\item \textbf{Core Spawn Seer}
\item \textbf{Core Spawn Worm}
\item \textbf{Frost Giant Zombie}
\item \textbf{Frost Worm}
\item \textbf{Gearkeeper Construct}
\item \textbf{Gloomstalker}
\item \textbf{Horizonback Tortoise}
\item \textbf{Husk Zombie}
\item \textbf{Merrow Shallowpriest}
\item \textbf{Moorbounder}
\item \textbf{Nergaliid}
\item \textbf{Sahuagin Warlock of Uk'otoa}
\item \textbf{Sea Fury}
\item \textbf{Shadowghast}
\item \textbf{Swavain Basilisk}
\item \textbf{Udaak}
\end{multicols}
...
\chapter{Glossary}
\textbf{Aeor} was a flying city of mages who sought to destroy the gods before they themselves were destroyed during the Calamity. Aeor crashed into Eiselcross.

\textbf{Age of Arcanum} is the previous age before the Calamity and the Divergence, a period known for its widespread use of magic and dangerous conflicts between prosperous mortal nations and the gods.

\textbf{All-Hammer} is the alternative title for the god Moradin.

\textbf{Arch Heart} is the alternative title for the god Corellon.

\textbf{Asmodeus} is the Betrayer God of domination.

\textbf{Assembly} refers to the Cerberus Assembly.

\textbf{Augen Trust} is the spy network of the Dwendalian Empire, used to expose those responsible for creating unrest and sowing rebellion within the empire.

\textbf{Aurora Watch} is the trained guard and military arm of the Kryn Dynasty.

\textbf{Avandra} is the god of luck, freedom, and change.

\textbf{Bahamut} is the god of justice, protection, and honor.

\textbf{Bane} is the Betrayer God of conquest and tyranny.

\textbf{Betrayer Gods} are the deities that turned to the dark, evil side of creation.

\textbf{Biting North} is the northern, arctic region of Wildemount that is comprised of the Greying Wildlands and Eiselcross.

\textbf{Blightshore} is the far-eastern shore of Eastern Wynandir once known as the Miskath Strand, scarred with deep corruption from the experiments of the Betrayer Gods.

\textbf{Blood Hunters} are mistrusted monster hunters that live outside society, using blood magic to stalk their quarries.

\textbf{Bright Queen Leylas Kryn} is the head of Den Kryn and heralded as the leader of the Kryn Dynasty of Xhorhas.

\textbf{Calamity} is the name given for the collective wars and ensuing cataclysms that occurred at the end of the Age of Arcanum, which nearly destroyed all life and civilization across Exandria.

\textbf{Cerberus Assembly} is a collection of eight powerful mages who work within the Dwendalian Empire under King Bertrand Dwendal, but often pursue their own interests.

\textbf{Change Bringer} is the alternate title for the god Avandra.

\textbf{Children of Malice} is a faction of followers of Lolth who are driven to undermine and ruin the Kryn Dynasty for their turning from the Spider Queen.

\textbf{Claret Orders} is a loose faction of Blood Hunter organizations.

\textbf{Clovis Concord} is the governing body of the Menagerie Coast, comprised of a union between the marquises who independently rule the major coastal cities.

\textbf{Cobalt Soul} refers to the Library of the Cobalt Soul.

\textbf{Concord (Concordian}) refers to the Clovis Concord (and members of that particular faction).

\textbf{Consecution} is the Kryn ritual of binding a soul to a \textit{Luxon beacon}, enabling the soul to be reborn in a new body when its previous body dies.

\textbf{Corellon} is the god of spring, beauty, and the art.

\textbf{Crown} refers to the rulership of King Bertrand Dwendal and the Dwendalian Empire.

\textbf{Crownsguard} are the trained guards who patrol the Dwendalian Empire and are often assigned to enforce laws in particular locations and cities.

\textbf{Dawn Father} is the alternative title for the god Pelor.

\textbf{Diarchy of Uthodurn} is a society of elves and dwarves in the Flotket Alps of the Greying Wildlands.

\textbf{Divergence} is the term used to describe the moment that Prime Gods, after banishing the Betrayer Gods from Exandria following the Calamity, left Exandria and manifested the Divine Gate.

\textbf{Divine Gate} is the boundary established by the Prime Gods between Exandria and the Outer Planes, preventing all major divinity from setting foot on the world.

\textbf{Draconblood} are the former ruling class of dragonborn in Draconia before its fall, known for their tailed bodies and guile.

\textbf{Draconia} was the once majestic dragonborn nation that now lays in ruins within the Dreemoth Ravine.

\textbf{Dranassar} were tall, beautiful humanoids whom Bane transformed into goblins, hobgoblins, and bugbears to create his armies.

\textbf{Dunamancy} is the arcane study and mastering of dunamis and dunamis-related magic.

\textbf{Dunamis} is the mysterious arcane energy of potential, probability, and gravity studied and harnessed by spellcasters of the Kryn Dynasty.

\textbf{Dwendalian Empire} refers to the Dwendalian Empire that rules over Western Wynandir.

\textbf{Dynasty} refers to the Kryn Dynasty of Xhorhas.

\textbf{Eastern Wynandir} is the eastern region of Wildemount, which includes Xhorhas and the Miskath Strand (Blightshore).

\textbf{Eiselcross} is the cluster of icy islands that makes up the northern region of the Biting North.

\textbf{Elder Evils} are ancient, esoteric entities of maddening malevolence that exist beyond the fringes of Exandria, their will subtly corrupting the minds and dreams of mortals.

\textbf{Empire} refers to the Dwendalian Empire.

\textbf{Empire Gods} refers to the members of the Prime Deities pantheon that remain approved for worship within the Dwendalian Empire. This includes Erathis, Bahamut, Moradin, Pelor, Ioun, and the Raven Queen.

\textbf{Erathis} is the god of law, order, and civilization.

\textbf{Everlight} is the alternative title for the god Raei.

\textbf{Exandria} is the name of the world that includes the continent of Wildemount. It exists on the Material Plane.

\textbf{Expositors} are highly trained spies and infiltrators working for the Cobalt Soul.

\textbf{Ghor Dranas} was the central city of the Betrayer Gods and their armies. Destroyed in the Calamity, it has been rebuilt as the city of Rosohna.

\textbf{Glassblades} are the trained soldiers and rangers that serve the Diarchy of Uthodurn.

\textbf{Golden Grin} is an Exandria-wide secret society that works to destroy political corruption, check the abuse of power, and inspire everyone to rise.

\textbf{Greying Wildlands} is the southern region of the Biting North.

\textbf{Gruumsh} is the Betrayer God of savagery and slaughter.

\textbf{Ioun} is the god of knowledge, philosophy, and lore.

\textbf{Julous Dominion} was the society that resisted Dwendalian expansion in the mid-500's PD before being conquered and absorbed into the empire.

\textbf{Ki'Nau} are the indigenous island people who reestablished society along the Menagerie Coast after the Calamity.

\textbf{King} generally refers to King Bertrand Dwendal.

\textbf{King Bertrand Dwendal} is the current ruler of the Dwendalian Empire and Western Wynandir.

\textbf{Knowing Mentor} is the alternative title for the god Ioun.

\textbf{Kord} is the god of strength, contests, and storms.

\textbf{Kryn} refers to the Kryn Dynasty faction of Xhorhasian citizens and soldiers under its banner.

\textbf{Kryn Dynasty} is the faction of largely drow and wastefolk that rules most of Xhorhas.

\textbf{Law Bearer} is the alternative title for the god Erathis.

\textbf{Lolth} is the Betrayer God of deceit and spiders.

\textbf{Library of the Cobalt Soul} is a network of acolytes and scholars that believe in the gathering and open sharing of information and lore, many of whom worship Ioun.

\textbf{Luxon} is a pre-pantheon entity of light that is worshiped by the Kryn Dynasty.

\textbf{Melora} is the god of wilderness and nature.

\textbf{Marquet} is the distant, largely arid continent far to the southwest of Wildemount.

\textbf{Marquis} is generally the title of a city leader within the Clovis Concord.

\textbf{Marquessian} refers to the language of Marquet, architecture and crafts from Marquet, or denizens who descend from citizens of Marquet.

\textbf{Miskath Strand} is the far-eastern shore of Eastern Wynandir, scarred with deep corruption from the experiments of the Betrayer Gods. This region is now known as Blightshore.

\textbf{Molaesmyr} is the ruined and cursed elven city that once ruled over the Greying Wildlands from within the forest now called the Savalirwood.

\textbf{Moon Weaver} is the alternative title for the god Sehanine.

\textbf{Moradin} is the god of craft and creation.

\textbf{Myriad} are a scattered but powerful network of criminals and thieves throughout Wildemount.

\textbf{PD} denotes a year that has occurred "Post-Divergence." For example, the Chroma Conclave's attack on Tal'Dorei occurred in 815 PD.

\textbf{Pelor} is the god of the sun, summer, and the harvest.

\textbf{Platinum Dragon} is the alternative title for the god Bahamut.

\textbf{Prime Deities} are the gods who turn to the more orderly, good, and balanced view of creation.

\textbf{Quajath} is a massive worm creature of powerful will sealed within the ice of Eiselcross.

\textbf{Raei} is the god of atonement and compassion.

\textbf{Raven Queen} is the god of winter, fate, and the transition of death.

\textbf{Ravenites} are the surviving dragonborn previously held as a lower, slave-class under the Draconbloods of Draconia before its fall, known for their tailless bodies and hardy physique.

\textbf{Revelry} is the faction and banner that most operating pirates across the Menagerie Coast are united under.

\textbf{Righteous Brand} is the military army of the Dwendalian Empire.

\textbf{Scars of Scale and Tooth} is a new faction of Ravenites and survivors of the destruction of Draconia, centered around the city of Xarzith Kitril.

\textbf{Sehanine} is the god of moonlight, illusions, and misdirection.

\textbf{Starosta} is the title of a settlement leader within the Dwendalian Empire.

\textbf{Storm Lord} is the alternative title for the god Kord.

\textbf{Tal'Dorei} is a continent southwest of Wildemount, across the Lucidian Ocean.

\textbf{Taskhands} are high-ranking military leaders within the Kryn Dynasty, sometimes assigned to preside as judges in times of conflict.

\textbf{Tharizdun} is the Betrayer God of madness and destruction.

\textbf{Tiamat} is the Betrayer God of greed, envy, and wealth.

\textbf{Torog} is the Betrayer God of imprisonment, torture, and enslavement.

\textbf{Tribes} is a term often referring to the Tribes of Shadycreek Run.

\textbf{Tribes of Shadycreek Run} is a collection of crime families that runs through the Dwendalian Empire and the Greying Wildlands.

\textbf{Truscan Vale} is the far western plain within the Marrow Valley that is largely controlled by the Truscan noble family.

\textbf{Uk'otoa} is a powerful serpent that is sealed within the Lucidian Ocean.

\textbf{Umavi} are consecuted members of the Kryn Dynasty who have been reborn and lived enough lifetimes to believe they are perfect souls.

\textbf{Uthodurnian} relates something to the society of the Diarchy of Uthodurn.

\textbf{Wastefolk} are nomads who have adapted to life in the wastes of Xhorhas, which they call them home.

\textbf{Western Wynandir} is the western, central valley of Wildemount, which includes the Zemni Fields and the Marrow Valley.

\textbf{Wild Mother} is the alternative title for the god Melora.

\textbf{Wildemount} is the continent described in this volume and the setting for the second campaign of the hit series \textit{Critical Role}.

\textbf{Zhelezo} are the standing military of the Clovis Concord up and down the Menagerie Coast.
