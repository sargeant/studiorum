...
\begin{DndSidebar}[float=!b]{Rules to Game By}
...
\begin{description}
\item[When in doubt, make it up!]
It's better to keep the game moving than to get bogged down in the rules.
\item[It's not a competition.]
The DM isn't competing against the player characters. You're there to run the monsters, referee the rules, and keep the story moving.
\item[It's a shared story.]
...
\item[Be consistent.]
If you decide that a rule works a certain way in one session, make sure it works that way the next time it comes into play.
\item[Make sure everyone is involved.]
Ensure every character has a chance to shine. If some players are reluctant to speak up, remember to ask them what their characters are doing.
\item[Be fair.]
Use your powers as Dungeon Master only for good. Treat the rules and the players in a fair and impartial manner.
\item[Pay attention.]
Make sure you look around the table occasionally to see if the game is going well. If everyone seems to be having fun, relax and keep going. If the fun is waning, it might be time for a break, or you can try to liven things up.
\end{description}
...
\subsection{Improvising Ability Checks}
...
\begin{itemize}
\item What kind of ability check?
\item How hard is it?
\item What's the result?
\end{itemize}
...
\begin{itemize}
\item \textbf{Easy (DC 10)}. An easy task requires a minimal level of competence or a modicum of luck to accomplish.
\item \textbf{Moderate (DC 15)}. A moderate task requires a slightly higher level of competence to accomplish. A character with a combination of natural aptitude and specialized training can accomplish a moderate task more often than not.
\item \textbf{Hard (DC 20)}. Hard tasks include any effort that is beyond the capabilities of most people without aid or exceptional ability.
\end{itemize}
...
\textbf{Characters.} This term refers to the adventurers run by the players. They are the protagonists in any D\&D adventure. A group of characters or adventurers is called a party.

\textbf{Nonplayer Characters (NPCs).} This term refers to characters run by the DM. How an NPC behaves is dictated by the adventure and by the DM.

\textbf{Boxed Text.} At various places, the adventure presents descriptive text that's meant to be read or paraphrased aloud to players. This read-aloud text is offset in boxes. Boxed text is most commonly used to describe rooms or present bits of scripted dialogue.

\textbf{Stat Block.} Any monster or NPC that is likely to be involved in combat requires game statistics so that the DM can run it effectively. These statistics are presented in a format called a statistics block, or stat block. You'll find the stat blocks needed for this adventure in appendix B.

\textbf{Tenday.} In the Forgotten Realms, a week is ten days long and called a tenday. Each month consists of three tendays—thirty days total.

\subsection{Magic Items and Monsters}
...
\section{Overview}
Lost Mine of Phandelver is divided into four parts. In part 1, "Goblin Arrows," the adventurers are on the road to the town of Phandalin when they stumble into a goblin ambush. They discover that the goblins (who belong to the Cragmaw tribe) have captured their dwarf friend \textbf{Gundren Rockseeker} and his escort, a human warrior named \textbf{Sildar Hallwinter}. The characters must deal with the ambushers and then follow their trail back to the goblins' hideout. They rescue Sildar and learn from him that Gundren and his brothers discovered a famous lost mine. Sildar knows only that Gundren and his map have been taken to somewhere called "Cragmaw Castle."
...
\subsection{Meet Me in Phandalin}
The characters are in the city of Neverwinter when their dwarf patron and friend, \textbf{Gundren Rockseeker}, hires them to escort a wagon to Phandalin. Gundren has gone ahead with a warrior, \textbf{Sildar Hallwinter}, to attend to business in the town while the characters follow with the supplies. The characters will be paid 10 gp each by the owner of Barthen's Provisions in Phandalin when they deliver the wagon safely to that trading post.

\begin{DndSidebar}[float=!b]{Roleplaying and Inspiration}
...
\begin{DndReadAloud}{}
In the city of Neverwinter, a dwarf named \textbf{Gundren Rockseeker} asked you to bring a wagonload of provisions to the rough-and-tumble settlement of Phandalin, a couple of days' travel southeast of the city. Gundren was clearly excited and more than a little secretive about his reasons for the trip, saying only that he and his brothers had found "something big," and that he'd pay you ten gold pieces each for escorting his supplies safely to Barthen's Provisions, a trading post in Phandalin. He then set out ahead of you on horse, along with a warrior escort named \textbf{Sildar Hallwinter}, claiming he needed to arrive early to "take care of business."
...
If you are using the "Meet Me in Phandalin" adventure hook, then any character who approaches to make a closer investigation can identify the horses as belonging to \textbf{Gundren Rockseeker} and \textbf{Sildar Hallwinter}. They've been dead about a day, and it's clear that arrows killed the horses. When the characters inspect the scene closer, read the following:
...
\begin{itemize}
\item Review the goblin stat block in appendix B. Since the goblins are hiding, you'll need to know their Stealth skill modifier: +6.
\item Check to see who, if anyone, is Surprise. The party cannot surprise the goblins, but the goblins might surprise some or all the characters. Make a Dexterity (Stealth) check for the goblins, rolling once for all of them. Roll a d20, add the goblins' Stealth skill modifier (+6) to the roll, and compare the result to the characters' passive Wisdom (Perception) scores. Any character whose score is lower than the goblins' check result is Surprise and loses his or her turn during the first round of combat (see "Surprise" in the rulebook).
\item Use the initiative rules in the rulebook to determine who acts first, second, third, and so on. Keep track of everyone's initiative count in the margins of this book or on a separate piece of paper.
\item When the time comes for the goblins to act, two of them rush forward and make melee attacks while two goblins stand 30 feet away from the party and make ranged attacks. The goblins' stat block contains the information you need to resolve these attacks. For more information on what the goblins can do on their turn, see chapter 2, "Combat," in the rulebook.
\item When three goblins are defeated, the last goblin attempts to flee, heading for the goblin trail.
\end{itemize}
...
The characters might not find the goblin trail, or they could decide to continue to Phandalin. In that case, skip ahead to part 2, "Phandalin." Elmar Barthen (the owner of Barthen's Provisions) seeks out the characters and informs them that \textbf{Gundren Rockseeker} never arrived. He recounts the goblin troubles and suggests that the characters return to the ambush site to investigate further (after they rest). Barthen also tells the party that Linene Graywind of the Lionshield Coster (see page 16) can provide more information on the goblin attacks.
...
The leader of the Cragmaw bandits lairing here is a bugbear named Klarg, who has orders from the chief of the Cragmaws to plunder any poorly defended caravans or travelers that come this way. A few days ago, a messenger from Cragmaw Castle brought new instructions: Waylay the dwarf \textbf{Gundren Rockseeker} and anyone traveling with him.

\includegraphics[width=0.4\textwidth]{None}
\includegraphics[width=0.4\textwidth]{None}
\begin{DndSidebar}[float=!b]{Adventure Maps}
...
\begin{DndSidebar}[float=!b]{What the Goblins Know}
...
\begin{itemize}
\item About fifteen goblins currently dwell in the lair.
\item Their leader is a bugbear named Klarg. He answers to King Grol, chief of the Cragmaw tribe, who dwells in Cragmaw Castle. (The goblins can provide basic directions to Cragmaw Castle. It's about twenty miles northeast of the Cragmaw hideout, in Neverwinter Wood.)
\item Klarg received a messenger goblin from King Grol a few days ago. The messenger told him that someone named the Black Spider was paying the Cragmaws to watch out for the dwarf \textbf{Gundren Rockseeker}, capture him, and send him and anything he was carrying back to King Grol. Klarg followed his orders. Gundren was ambushed and taken along with his personal effects, including a map.
\item The dwarf and his map were delivered to King Grol, as instructed. The dwarf's human companion is being held in the "eating cave" (6).
\end{itemize}
...
\textbf{Sildar Hallwinter}, a human warrior, is held prisoner in this chamber. He is securely bound on the southern ledge of the cavern. The goblins have been beating and tormenting him, so he is weak and at 1 hit point.
...
\subsubsection{Developments}
If he is rescued and healed, \textbf{Sildar Hallwinter} remains with the party but is anxious to reach Phandalin as quickly as possible. He doesn't have any weapons or armor, but he can take a shortsword from a defeated goblin or use a weapon loaned to him by a character.

If Sildar joins the party, see the "NPC Party Members" sidebar for tips on how to run him.

\subsubsection{Treasure}
Yeemik carries a pouch containing three gold teeth (1 gp each) and 15 sp. Sildar's gear, along with \textbf{Gundren Rockseeker}, was taken to Cragmaw Castle.

\textbf{NPC Party Members}

An NPC might join the party, if only for a short time. Here are some tips to help you run an NPC party member:


\begin{itemize}
\item Let the characters make the important decisions. They are the protagonists of the adventure. If the characters ask an NPC party member for advice or direction, remember that NPCs make mistakes too.
\item An NPC won't deliberately put himself or herself in harm's way unless there's a good reason to do so.
\item An NPC won't treat all party members the same way, which can create some fun friction. As an NPC gets to know the characters, think about which characters the NPC likes most and which characters the NPC likes least, and let those likes and dislikes affect how the NPC interacts with the various party members.
\item In a combat encounter, keep the NPC's actions simple and straightforward. Also, look for things that the NPC can do besides fighting. For example, an NPC might stabilize a dying character, guard a prisoner, or help barricade a door.
\item If an NPC contributes greatly to the party's success in a battle, the NPC should receive an equal share of the XP earned for the encounter. (The characters receive less XP as a consequence.)
\item NPCs have their own lives and goals. Consequently, an NPC should remain with the party only as long as makes sense for those goals.
\end{itemize}

\subsection{7. Twin Pools Cave}
...
If the characters began with the "Meet Me in Phandalin" adventure hook, they can be paid by Barthen's Provisions for delivering the wagonload of supplies. If the characters rescued \textbf{Sildar Hallwinter} the wounded warrior would appreciate an escort to Phandalin (and will pay 50 gp for the service). Details contained within the characters' backgrounds might prompt them to seek out specific NPCs in the town.
...
\subsection{Awarding Experience Points}
...
If \textbf{Sildar Hallwinter} is with the party, add:
...
\begin{itemize}
\item \textbf{Barthen's Provisions.} If the characters have the wagonload of supplies from the "Meet Me in Phandalin" adventure hook, they are meant to deliver it to this shop.
\item \textbf{Lionshield Coster.} If the characters retrieved the stolen goods from the Cragmaw hideout, they might want to return them to the rightful owner.
\item \textbf{Stonehill Inn.} If the characters have \textbf{Sildar Hallwinter} with them, the knight suggests heading for this inn to find lodgings. If the characters are otherwise looking for a place to eat and sleep, they discover that the Stonehill appears to be the best available option.
\end{itemize}

\section{Encounters in Phandalin}
...
\subsection{Finding Cragmaw Castle}
The characters might want to seek out Cragmaw Castle to find and rescue \textbf{Gundren Rockseeker}. Most of the townsfolk are preoccupied with the Redbrands, and no one in town knows the location of Cragmaw Castle. Qelline Alderleaf, \textbf{Sildar Hallwinter}, and Halia Thornton can offer suggestions on how the party might find someone who knows the location.
...
\textbf{Sildar Hallwinter} & \textbf{Sildar Hallwinter} is a retired soldier and sellsword who hails from the city of Neverwinter. He is a loyal member of the Lords' Alliance, a political organization that unites the various free cities and towns of the North.\\
\end{DndTable}

\subsection{Roleplaying Phandalin NPCs}
...
\begin{itemize}
\item \textbf{Relax.} Don't worry about impressing your players with your thespian skills (or lack thereof).
\item \textbf{Get inside the NPCs' minds.} Imagine how they might react to the characters, and strive to be realistic.
\item \textbf{Mug it up.} Scowl, smile, snarl, flutter your eyelashes, pout, cross your eyes, rub your hands together-what-ever it takes to make your NPCs come to life.
\item \textbf{Try different voices.} Borrow distinctive speech patterns from real life, movies, and television. Adjust the volume as appropriate. An NPC can be loud, soft-spoken, or something in between.
\item \textbf{Keep the game moving.} Let the players steer the interactions with the NPCs.
\end{itemize}
...
This modest inn has six rooms for rent (\textbf{Sildar Hallwinter} takes one). If the characters decide to stay here, see "Food, Drink, and Lodging" in the rulebook for pricing. (The characters' other alternative for lodging is to camp outside the town, or to persuade a farmer such as Daran Edermath or Qelline Alderleaf to let them sleep in a hayloft.)
...
\begin{DndSidebar}[float=!b]{Narth, an old farmer}
...
\begin{DndSidebar}[float=!b]{Elsa, a gossipy barmaid}
...
\begin{DndSidebar}[float=!b]{Lanar, a miner}
...
\begin{DndSidebar}[float=!b]{Trilena, the innkeeper's wife}
...
\begin{DndSidebar}[float=!b]{Pip, Toblen's young son}
...
\begin{DndSidebar}[float=!b]{Freda, a weaver}
...
\subsection{Delivering the Supplies}
If the characters began play with the "Meet Me in Phandalin" adventure hook, their orders are to deliver the wagon of supplies to Barthen's. Barthen pays the agreed amount (10 gp to each character) and takes possession of the wagon and its supplies. If the characters tell him of \textbf{Gundren Rockseeker}'s capture, Barthen is saddened by the news and encourages the party to find and rescue the dwarf. He considers Gundren a friend and was excited by talk of discovering the lost mine of the Phandelver's Pact in the nearby hills. If the party hasn't already learned details of the mine from \textbf{Sildar Hallwinter}, a character who succeeds on a DC 15 Intelligence (History) check can relate the information from the first two paragraphs of the "Background" section at the start of the adventure.
...
\subsection{Quest: Old Owl Trouble}
...
\subsection{Joining the Order of the Gauntlet}
...
\section{Phandalin Miner's Exchange}
...
\subsection{Quest: Halia's Job Offer}
...
\subsection{Joining the Zhentarim}
...
\subsection{Quest: Reidoth the Druid}
...
\subsection{Quest: The Banshee's Bargain}
...
\subsection{Joining the Harpers}
...
\subsection{Quest: Finding Cragmaw Castle}
After resting at the Stonehill Inn, \textbf{Sildar Hallwinter} establishes himself at the townmaster's hall. As an agent of the Lords' Alliance, his goal is to bring law and order to Phandalin. As such, he wants to find the lost mine of Wave Echo Cave and help the Rockseeker brothers put it back into production, believing that bringing prosperity to the region will help civilize the town.
...
\subsection{Quest: Finding Iarno}
...
\subsection{Joining the Lords' Alliance}
If the party eliminates the goblin threat from Cragmaw Castle or uncovers Iarno's treachery, \textbf{Sildar Hallwinter} privately approaches certain members of the group to urge them to join the Lords' Alliance. He speaks with those who exemplify a desire for the security of civilization through action. If a character agrees, \textbf{Sildar Hallwinter} awards the individual the title of Cloak.

\section{Tresendar Manor}
...
\begin{itemize}
\item After speaking with a number of NPCs in town, the characters decide to confront the Redbrands at the Sleeping Giant tap house.
\item The characters decide to investigate Tresendar Manor. Skip the encounter and go straight to "Redbrand Hideout."
\item If the characters show no interest in the Redbrands, a gang of the ruffians seeks them out and picks a fight in street. Run this encounter as the characters are leaving one of the locations in the town.
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Redbrand Ruffian}
...
Continue the insults and baiting as long as you like. The Redbrands attack in a round or two if the characters don't. Neither side is Surprise, because it's obvious that a fight is brewing.
...
\textbf{Do the Players Need Direction?}
...
A locked door can be picked with \textit{thieves' tools} and a successful DC 10 Dexterity check. A door can also be broken down with a successful DC 20 Strength check.
...
\begin{itemize}
\item The leader of the Redbrands is a human wizard known as Glasstaff, so named because his magic staff is made of glass.(Only Iarno Albrek and the Black Spider know Glasstaff's real name.) Glasstaff's chambers are in the western end of the stronghold (see areas 11 and 12).
\item A mysterious figure called the Black Spider has hired the Redbrands to frighten off adventurers and intimidate the locals, for reasons unknown. The Black Spider has sent bugbears to reinforce the Redbrands and provide extra muscle (see 9).
\item The lower part of the complex is guarded by a hideous "eye monster" (see 8).
\item The Redbrands have a handful of captives in a holding area "near the old crypts," which are guarded by skeletons (see areas 4 and 5).
\end{itemize}
...
\subsection{Treasure}
The satchel hidden in the cistern is waterproof and contains a \textit{potion of healing}, a \textit{potion of invisibility}, 50 gp, and a clean set of ordinary travel clothing. This is a getaway kit that Iarno keeps here in case of an emergency.
...
\subsection{Cell Doors}
The cell doors feature simple locks requiring \textit{thieves' tools} and a successful DC 10 Dexterity check to pick. The doors can also be wrenched open by brute force with a successful DC 22 Strength check.
...
\subsubsection{Quest: Mirna's Heirloom}
...
\section{7. Storeroom and Work Area}
...
The bottom of the crevasse feels unnaturally cold. When viewed with a \textit{detect magic} spell, the area emanates a faint necromantic aura. The magic causes all organic matter in the crevasse to age and decompose at half the normal rate.
...
Three bugbears and one \textbf{goblin} are present. The goblin, Droop, falls unconscious at the sight of the party, but another creature can use an action to wake him. Otherwise, Droop remains unconscious for 1d10 minutes.
...
\section{12. Glasstaff's Quarters}
...
If Iarno is Surprise, add the following paragraph:
...
\begin{itemize}
\item The Black Spider is a drow (dark elf).
\item The Black Spider sent three bugbears to help Iarno keep the population of Phandalin under control, but the Redbrands have managed without them. The bugbears know the way to Wave Echo Cave, but Iarno does not.
\item The Black Spider is searching Wave Echo Cave for the Forge of Spells. Dwarves and gnomes of the Phandelver's Pact used the magical forge to fashion powerful magic items.
\item No other members of the Lords' Alliance know of Iarno's betrayal.
\end{itemize}
...
\begin{DndSidebar}[float=!b]{Iarno}
Lord Albrek,
...
If Iarno is taken into custody, \textbf{Sildar Hallwinter} arranges to have the wizard incarcerated in the townmaster's hall until he can be safely transported back to Neverwinter. Whether Iarno stands trial for his crimes is beyond the scope of this adventure. The Black Spider is too preoccupied to meddle in the wizard's fate.
...
Iarno also wields a \textit{staff of defense}.

\subsection{Awarding Experience Points}
Divide 200 XP equally among the characters if the party slays Iarno Albrek. Double the XP award if they capture Iarno and deliver him to \textbf{Sildar Hallwinter} in Phandalin.
...
\DndDropCapLine{I}{}n this part of the adventure, the characters follow up on existing leads and lines of inquiry. They can't learn much more in Phandalin, so they need to set out into the forests and hills surrounding the town to uncover the larger plots they are caught up in. The characters are not required to visit all the locations in this section. Depending on which NPCs the characters met and which quests or clues they picked up, some or all the following information might be known to them:



\begin{itemize}
\item Sister Garaele wants the characters to seek out the banshee Agatha in the ruined town of Conybery and ask her about Bowgentle's spellbook.
\item Daran Edermath wants the characters to find out who is lurking near the ruins at Old Owl Well.
\item Quelline Alderleaf has suggested that the characters go to the ruined town of Thundertree and consult with the druid Reidoth, who might know the whereabouts of Cragmaw Castle, Wave Echo Cave, or both.
\item Townmaster Harbin Wester wants the characters to seek out an orc encampment near Wyvern Tor and chase the orcs away from the area.
\item \textbf{Sildar Hallwinter} wants the characters to find Cragmaw Castle, search for \textbf{Gundren Rockseeker}, rescue the dwarf, and retrieve his map.
\end{itemize}
...
\subsection{Using the Overland Map}
...
\includegraphics[width=0.4\textwidth]{None}
\includegraphics[width=0.4\textwidth]{None}
\subsection{Wilderness Encounters}
...
\textbf{Wilderness Encounters}

\begin{DndTable}[header=Wilderness Encounters (Day)]{cX}
...
\begin{DndTable}[header=Wilderness Encounters (Night)]{cX}
...
7-8 & Orcs (1d4 + 2)\\
9-10 & Wolves (1d4 + 2)\\
11-12 & \textbf{Owlbear} (1)\\
\end{DndTable}

\subsubsection{Stirges}
...
\subsection{Dealing With Agatha}
...
\begin{DndSidebar}[float=!b]{Where's the Map?}
...
If a battle erupts, Hamun Kost, the \textbf{evil mage}, emerges from his tent and asks,

\begin{DndSidebar}[float=!b]{Red-Robed Mage}
...
\begin{itemize}
\item He wants the orcs at Wyvern Tor removed, since they have scouted out his camp and seem inclined to cause trouble.
\item He wants to ask a question of Agatha the banshee: "What is the name of the wizard who built the tower at Old Owl Well?" Kost won't risk the banshee's anger, but the characters could ask the question for him. (Agatha knows the name: Arthindol.)
\end{itemize}

\subsection{Treasure}
Hamun Kost's tent contains a comfortable traveling suite, including a cot, a chair, a writing desk, supplies, and a chest of clothes. In the chest is a leather bag containing 35 sp, 20 ep, 20 gp, 5 pp, one pearl (100 gp), a \textit{potion of healing}, a Spell Scroll (2nd level) \textit{darkness} in a bone tube, and a tiny jeweled box (25 gp) containing a \textit{ring of protection} from ancient Netheril, the Red Wizard's most interesting discovery so far.
...
\begin{DndSidebar}[float=!b]{Ash Zombies}
...
\subsection{Treasure}
The corpse of an unfortunate adventurer is cocooned in spider silk in the western half of the building. The body is shriveled up and sucked dry, but appears to have been a male elf. The body wears \textit{studded leather armor} and a shortsword in the scabbard at its hip. A careful search also yields a \textit{potion of healing} in a belt pouch, along with 23 gp and 35 sp.

\subsection{Awarding Experience Points}
Divide 400 XP equally among the characters if the party defeats the giant spiders.

\section{7. Dragon's Tower}
...
A \textbf{young green dragon} named \textbf{Venomfang} has recently claimed the tower, having passed over Thundertree while searching Neverwinter Wood for a suitable lair. The giant spider corpses are the former residents of the tower, killed by the dragon after it tore its way through the roof. Since then, \textbf{Venomfang} has been laying low.
...
\textbf{Venomfang} does not want to give up such a promising lair, but if the characters reduce the dragon to half its hit points, it climbs to the top of the tower and flies off to fight another day.
...
\subsection{Treasure}
An old wooden chest broken open on the tower floor holds the last of the dead wizard's treasure: 800 sp, 150 gp, four silver goblets set with moonstones (60 gp each), a Spell Scroll (2nd level) \textit{misty step}, and a Spell Scroll (3rd level) \textit{lightning bolt}. \textbf{Venomfang} spends much of his time greedily admiring the loot.
...
\subsection{Awarding Experience Points}
Divide 2,000 XP equally among the characters if the party drives away \textbf{Venomfang}. Given their level, the characters aren't likely to slay the dragon, but it is worth 3,900 XP.

\section{8. Old Smithy}
...
Six twig blights lurk in the thicket south of this ruin. Allow each character to attempt a Wisdom (Perception) check contested by the blights' Dexterity (Stealth) check to avoid being Surprise by them.
...
\subsection{Roleplaying the Cultists}
...
\subsection{Treasure}
In the main room, Favric has a small coffer containing tribute for the green dragon: three diamonds (100 gp each). He also carries a \textit{potion of flying} in a stoppered vial around his neck.
...
If the characters can quietly and expeditiously take out the lone \textbf{orc}, they have a chance to surprise the orcs in the cave. If the sentry spots the characters sneaking up, or if it is not silenced during the surprise round, the orc retreats back to the cave to warn the others.

The marauders in the cave include Brughor Axe-Biter (an \textbf{orc} with 30 hit points), six ordinary orcs, and a filthy \textbf{ogre} named Gog. Gog fights until slain, while the orcs fight until Brughor is killed, at which point any remaining orcs flee.
...
\subsection{Sildar's Gear}
The chain mail and longsword belong to \textbf{Sildar Hallwinter}. Sildar is grateful if at least his longsword is returned to him.

\section{6. Hobgoblin Barracks}
...
This hall holds seven miserable goblins and their leader—a fat, cantankerous \textbf{goblin} with 12 hit points named Yegg. Yegg is the chief cook for the Cragmaws, and he viciously bullies his unwilling assistants as they go about the work of putting food on the tribe's table. If Yegg is killed, any goblins left alive flee to the east or west, avoiding the north door because of the trap in 2.
...
This chamber contains a \textbf{grick}, the special pet of the goblin Lhupo (9). The grick like to climb up to a ledge hidden in the shadows of the statuary in the higher reaches of the room. It quietly observes intruders that enter the area before dropping down to strike. Compare the grick's Dexterity (Stealth) check to the characters' Wisdom (Perception) checks (or their passive scores) to determine who among them is Surprise. The grick knows that goblins are not to be eaten unless Lhupo says so. The rest of the Cragmaws are terrified of Lhupo's pet and hurry through this room, preferably in twos or threes.
...
\subsection{Developments}
If combat erupts here, the goblins in 9 cannot be Surprise.
...
A \textit{detect magic} spell reveals that the statuette is imbued with divination magic. Any non-evil creature grasping the statue can ask it a question and receive a telepathic response, as though it had cast \textit{augury} (see the rulebook for a description of this spell). Once a creature has asked its question and received a response, it can never activate the statuette again.

\subsection{Awarding Experience Points}
Divide 450 XP equally among the characters if the party defeats the grick.

\section{9. Goblin Shrine}
...
This shrine is home to Lhupo (a \textbf{goblin} with 12 hit points) and two ordinary goblins that serve as his "acolytes." They all wear filthy robes over their armor, but none of them possess divine powers (although Lhupo claims to hear Maglubiyet speaking to him). If the goblins heard the characters fighting the grick in 8, they hide behind the altar and attempt to surprise the characters. Otherwise, all three goblins are kneeling before the altar, praying to their evil god.
...
The iron door is locked. It can be opened with \textit{thieves' tools} and a successful DC 15 Dexterity check, or knocked down with a successful DC 25 Strength check.

\subsection{Arrow Slits}
...
The Cragmaws have captured an \textbf{owlbear} and confined it to this tower. The room is kept dark to keep the beast calm, but King Grol doesn't know what to do with it yet. If a character throws it fresh meat, the owlbear devours the food. Otherwise, it attacks the first creature it sees in the doorway.
...
\subsection{Treasure}
All that remains of the tower's second floor is a jagged ledge, upon which sits a battered wooden chest. The chest is hard to see from the floor, requiring a successful DC 15 Wisdom (Perception) check to notice. The chest is unlocked and contains 90 ep, 120 gp, a \textit{potion of healing}, a Spell Scroll (2nd level) \textit{silence}, and a Spell Scroll (3rd level) \textit{revivify}.

\subsection{Awarding Experience Points}
Divide 700 XP equally among the characters if the party defeats the owlbear or releases it.

\section{14. King's Quarters}
...
King Grol is a fierce old \textbf{bugbear} with 45 hit points. He rules the Cragmaws through pure intimidation. Age has stooped his shoulders and hunched his back, but he remains surprisingly agile and strong. He is demanding and vindictive, and no Cragmaw dares to cross him.

Grol is attended by Snarl, a \textbf{wolf} with 18 hit points, and a \textbf{doppelganger} disguised as a female drow. The doppelganger, Vyerith, is a messenger from the Black Spider, come to collect \textbf{Gundren Rockseeker} and the map of Wave Echo Cave from King Grol. Grol wants to sell the map instead of surrendering it. and he and the drow are negotiating a price. Vyerith first wants to question Gundren to find out if anyone else knows the location of the mine. Then the doppelganger intends to kill the dwarf and destroy the map.
...
\subsection{Unconscious Dwarf}
Near the southwest corner of the room is \textbf{Gundren Rockseeker}, a dwarf \textbf{commoner}. He is unconscious but stable at 0 hit points.
...
Award an additional 200 XP to the party if the characters rescue \textbf{Gundren Rockseeker} and escort him safely back to Phandalin.

\section{Returning War Band}
You can add a complication in the form of a hobgoblin war band returning home, just as the characters are preparing to leave. This war band consists of three hobgoblins led by Targor Bloodsword, a \textbf{hobgoblin} with 20 hit points. Targor also has two wolves as pets.
...
\chapter{Wave Echo Cave}
\DndDropCapLine{F}{}ifteen miles east of Phandalin, in the deep vales of the Sword Mountains, lies Wave Echo Cave. The rich mine of the Phandelver's Pact was lost five hundred years ago during orc invasions that devastated this part of the North.
...
\section{Experience Point Awards}
...
\begin{DndTable}[header=Wandering Monsters]{XX}
...
\subsection{Treasure}
Tharden wears a pair of \textit{boots of striding and springing}. In his haste to explore the rest of Wave Echo Cave, Nezznar overlooked them.

\section{2. Mine Tunnels}
...
The dead-end passages are places where the miners gave up and decided to move on to other spots. Patiently lurking in one is an \textbf{ochre jelly}. When the party enters this section of the mine, the jelly begins to stalk the group, instinctively waiting for an opportunity to attack a lone target.

\section{3. Old Entrance}
...
Clinging to the ceiling like bats are ten stirges. The monsters find scant living prey in the mines, and they are ravenous. If the characters are looking down at the skeletons on the floor, the stirges are likely get the drop on them. Any character who isn't watching the ceiling is Surprise unless his or her passive Wisdom (Perception) score is higher than the stirges' Dexterity (Stealth) check total (roll once for all of them). Characters who aren't Surprise hear a flapping noise as the stirges descend to attack.

The lanterns and the carvings of miners at work were meant as a welcome to newcomers.

\section{4. Old Guardroom}
...
\subsection{Treasure}
Behind the counter sits a locked iron strongbox, requiring \textit{thieves' tools} and a successful DC 20 Dexterity check to open. This pay chest was overlooked in the fighting and contains 600 cp, 180 sp, 90 ep, and 60 gp.

\section{6. South Barracks}
...
\subsection{Treasure}
The skeleton wears two platinum rings (75 gp each) and clutches a \textit{wand of magic missiles} in its bony fingers.

\section{11. North Barracks}
...
\subsection{Treasure}
The largest bugbear carries a pouch containing 15 cp. 13ep, and a \textit{potion of vitality}.

\section{12. Smelter Cavern}
...
Any character proficient in Arcana can sense a subtle aura of magic in this cavern. (A \textit{detect magic} spell reveals the same.) The aura becomes stronger as one approaches the northern building (15).

\section{14. Wizards' Quarters}
...
This room contains the restless spirit of the last wizard to die here: \textbf{Mormesk the wraith}. He is not immediately visible but rises up out of the floor when a living creature enters the room.
...
\subsection{Roleplaying Mormesk}
...
\subsection{Brazier of Green Flame}
A successful DC 15 Intelligence (Arcana) check identifies the brazier as the source of the magic that suffuses the surrounding caverns. This magic has waned over the years, to the extent that it can no longer be harnessed to permanently enchant magic items. However, any nonmagical weapon or armor bathed in the green flame for at least 1 minute becomes a \textit{+1 weapon} or \textit{+1 armor}, respectively, for 1d12 hours. The brazier cannot be removed from the Forge of Spells.

\subsection{Northern Room}
...
\subsection{Treasure}
On the worktable in the southeast corner of the room are the last items the spectator was charged to protect: \textit{Lightbringer} and \textit{Dragonguard}.

\section{16. Booming Cavern}
...
Three bugbears are stationed here. Two of them are clearing rock on the rift floor while one more stands guard in the western half of the cavern. A \textbf{doppelganger} named Vhalak supervises the operation in the guise of a male drow. If a fight breaks out in the main cavern, the two bugbears in the rift climb up the ropes to join the fray.
...
\textbf{Nezznar the Black Spider} is joined by four giant spiders that defend their master to the death. If they are expecting trouble, the spiders hide behind pillars, and Nezznar casts \textit{invisibility} on himself and stands near the table. Make a Dexterity (Stealth) check for the spiders. When intruders appear, the spiders try to entangle them in webs before closing to melee range. Nezznar joins the fray on the round after the spiders attack.

If the \textbf{doppelganger} from 18 retreated to this area, it assumes the guise of \textbf{Nundro Rockseeker} so that Nezznar can use the "dwarf" as leverage to force the party's surrender (although the drow won't actually harm the doppelganger). See the "Roleplaying Nezznar" section for more information on the drow villain.

\subsection{Statue}
The statue depicts Dumathoin, the dwarven god of mining. Any character who has proficiency in Religion recognizes the deity. The statue is beautifully carved, and its emerald eyes appear extremely valuable. However, the jewels are clever fakes made of worthless glass, as close inspection and a successful DC 15 Intelligence (Investigation) check reveals. Nevertheless, a powerful spell protects them, and a \textit{detect magic} spell reveals a strong aura of abjuration magic surrounding the statue.
...
\subsection{Roleplaying Nezznar}
...
If the characters capture Nezznar and deliver him to the townmaster's hall in Phandalin, the drow is locked up until \textbf{Sildar Hallwinter} or another representative of the Lords' Alliance can escort him to Neverwinter to face justice and interrogation. However, unless the characters post guards outside Nezznar's cell, Halia Thornton (see page 17) breaks him out of jail, smuggles him out of Phandalin, and delivers him into the waiting arms of the Zhentarim. The Zhents want to learn everything the Black Spider knows about Wave Echo Cave. What happens to Nezznar at that point is up to you.

\subsection{Treasure}
Nezznar carries a \textit{potion of healing} and a \textit{spider staff}. In addition, the drow carries an iron key with a head shaped like an anvil. This key unlocks the door to 20.
...
\subsection{Awarding Experience Points}
If Nezznar is captured alive and delivered to \textbf{Sildar Hallwinter} or Townmaster Wester in Phandalin, award the party double his XP value.

\section{20. Priests' Quarters}
The door to this room is locked, requiring \textit{thieves' tools} and a successful DC 15 Dexterity check to open. Nezznar (19) carries the key.
...
\item \textit{Spider Staff}
\item \textit{Staff of Defense}
...
\begin{itemize}
\begin{multicols}{3}
\item \textbf{Ash Zombie}
\item \textbf{Bugbear}
\item \textbf{Commoner}
\item \textbf{Cultist}
\item \textbf{Doppelganger}
\item \textbf{Evil Mage}
\item \textbf{Flameskull}
\item \textbf{Ghoul}
\item \textbf{Giant Spider}
\item \textbf{Goblin}
\item \textbf{Grick}
\item \textbf{Gundren Rockseeker}
\item \textbf{Hobgoblin}
\item \textbf{Mormesk the Wraith}
\item \textbf{Nezznar the Black Spider}
\item \textbf{Nothic}
\item \textbf{Nundro Rockseeker}
\item \textbf{Ochre Jelly}
\item \textbf{Ogre}
\item \textbf{Orc}
\item \textbf{Owlbear}
\item \textbf{Redbrand Ruffian}
\item \textbf{Sildar Hallwinter}
\item \textbf{Skeleton}
\item \textbf{Spectator}
\item \textbf{Stirge}
\item \textbf{Twig Blight}
\item \textbf{Wolf}
\item \textbf{Young Green Dragon} (\textbf{Venomfang})
\item \textbf{Zombie}
\end{multicols}
...
\DndItemHeader{Thieves' Tools}{n, o, n, e}
...
\begin{DndMonster}[float=t]{Ash Zombie}
...
\begin{DndMonster}[float=t]{Evil Mage}
...
\begin{DndMonsterSpells}
  \DndMonsterSpellLevel{\textit{light}, \textit{mage hand}, \textit{shocking grasp}}
   \DndMonsterSpellLevel[1][4]{\textit{charm person}, \textit{magic missile}}
   \DndMonsterSpellLevel[2][3]{\textit{hold person}, \textit{misty step}}
\end{DndMonsterSpells}
\DndMonsterSection{Actions}
\DndMonsterAction{Quarterstaff}
\textsl{Melee Weapon Attack:} 1 to hit, reach 5 ft., one target. \textsl{Hit:} 3 (1d8 - 1) bludgeoning damage.
...
\begin{DndMonster}[float=t]{Gundren Rockseeker}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
armor-class = {10},
hit-points = {\DndDice{1d8}},
...
\begin{DndMonster}[float=t]{Mormesk the Wraith}
\DndMonsterType{Medium undead, neutral evil}
\DndMonsterBasics[
armor-class = {13},
...
\textsl{Melee Weapon Attack:} 5 to hit, reach 5 ft., one creature. \textsl{Hit:} 16 (3d8 + 3) necrotic damage, and the target must succeed on a DC 13 Constitution saving throw or its hit point maximum is reduced by an amount equal to the damage taken. If this attack reduces the target's hit point maximum to 0, the target dies. This reduction to the target's hit point maximum lasts until the target finishes a long rest.

\end{DndMonster}



\begin{DndMonster}[float=t]{Nezznar the Black Spider}
\DndMonsterType{Medium humanoid (elf), neutral evil}
\DndMonsterBasics[
armor-class = {11 (14 with \textit{mage armor})},
hit-points = {\DndDice{6d8}},
speed = {30 ft.}
]
\DndMonsterAbilityScores[
...
Nezznar has a \textit{spider staff}.
...
\begin{DndMonsterSpells}
  ...
  \DndInnateSpellLevel[1e]{\textit{darkness}, \textit{faerie fire} (save DC 12)}
\end{DndMonsterSpells}
\DndMonsterAction{Spellcasting}
...
\begin{DndMonsterSpells}
  \DndMonsterSpellLevel{\textit{mage hand}, \textit{ray of frost}, \textit{shocking grasp}}
   \DndMonsterSpellLevel[1][4]{\textit{mage armor}, \textit{magic missile}, \textit{shield}}
   \DndMonsterSpellLevel[2][3]{\textit{invisibility}, \textit{suggestion}}
\end{DndMonsterSpells}
\DndMonsterSection{Actions}
\DndMonsterAction{Spider Staff}
\textsl{Melee Weapon Attack:} 1 to hit, reach 5 ft., one target. \textsl{Hit:} 2 (1d6 - 1) bludgeoning damage plus 3 (1d6) poison damage.
...
\begin{DndMonster}[float=t]{Nundro Rockseeker}
\DndMonsterType{Medium humanoid (any race), any alignment}
\DndMonsterBasics[
armor-class = {10},
hit-points = {\DndDice{1d8}},
...
\begin{DndMonster}[float=t]{Redbrand Ruffian}
...
\begin{DndMonster}[float=t]{Sildar Hallwinter}
...
\begin{DndMonster}[float=t]{Venomfang}
...
\addcontentsline{toc}{section}{Faerie Fire}
...
\addcontentsline{toc}{section}{Spider Climb}
...
{1 action}
{Touch}
{V, S, a drop of bitumen and a spider}
{Concentration, up to 1 hour}
