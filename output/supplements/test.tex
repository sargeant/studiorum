\documentclass[10pt,a4,twoside,twocolumn,openany,nodeprecatedcode]{dndbook}
...
\begin{DndComment}{What Is Critical Role?}
...
\begin{DndTable}[header=Character Level Advancement]{ >{\hsize=0.083\hsize}c >{\hsize=0.917\hsize}X }
...
\begin{DndTable}[header=Underwater Encounter Distance]{ >{\hsize=0.500\hsize}X >{\hsize=0.500\hsize}X }
...
\begin{DndTable}[header=Physical Signs of Ruidium Corruption]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
\begin{DndComment}{Ruidium Spell Components}
...
\begin{DndTable}[header=Rivals' Goals]{ >{\hsize=0.167\hsize}X >{\hsize=0.833\hsize}X }
...
\begin{DndTable}[header=Rival Stat Blocks]{ >{\hsize=0.500\hsize}X >{\hsize=0.500\hsize}X }
...
\begin{DndComment}{Vital Nonplayer Characters}
...
\begin{DndComment}{Making Mistakes}
...
\begin{DndTable}[header=Pronunciations]{ >{\hsize=0.250\hsize}X >{\hsize=0.250\hsize}X >{\hsize=0.500\hsize}X }
...
\listparagraph[6pt]{J1: Best Pies in the Jumble}
...
\listparagraph{J2: One-Shot Solution}
...
\listparagraph{J3: The Ifolon Plunge}
...
\listparagraph{J5: Wetwalks Paddywhack}
...
\listparagraph[6pt]{Male Drow:}
{{+0}}
\listparagraph{Female Halfling:}
{{+2}}
\listparagraph{Irvan Wastewalker:}
...
\listparagraph[6pt]{Ayo Jabe:}
{{+4}}
\listparagraph{Male Orc:}
{{+0}}
\listparagraph{Female Human:}
{{+2}}
\listparagraph{Male Goblin:}
{{-1}}
...
\listparagraph[6pt]{Maggie Keeneyes:}
{{+4}}
\listparagraph{Maryl Bronzefang:}
{{+4}}
\listparagraph{Female Drow:}
{{+3}}
...
This event is managed by two neutral good \textbf{Goblin} named Beetle and Zag. Their farm is jointly run by the Gakthash and Uvuroh goblin clans, and every year, the goblin couple uses the festival competitions as a labor-saving way to harvest their crops.
...
\listparagraph[6pt]{Bottle 1}
{{This purple bottle is filled with berry juice.}}
\listparagraph{Bottle 2}
...
A character who explores this cave discovers a vial containing a potion of healing and a soggy but usable spell scroll of \textit{thunderwave}.
\paragraph{Race Progression}
...
\listparagraph{Slow Pace (16 or More Rounds)}
...
\listparagraph[6pt]{Friendly or Indifferent Rivals}
...
\listparagraph[6pt]{Heroic Quest}
...
\listparagraph{Warring Destinies}
...
\textbf{Ayo Jabe (Tier 1)} doesn't mince words; she wants to know what they found in the grotto. If she gets the sense that the characters have stumbled onto something big, her eyes grow wide. She decides that she and her group want a piece of the action and proposes that they travel with the characters, saying that there's safety in numbers. A character who makes a successful DC 13 Wisdom (Insight) check realizes that she isn't hiding anything and wants nothing more than to be a part of a grand adventure.
The other rivals have their own opinions:
\begin{itemize}

\item \textbf{Dermot Wurder (Tier 1)} is genuinely concerned for the characters' well-being. He mentions that he heard what sounded like a voice in the grotto and wants to know if the characters heard it too.
\item \textbf{Galsariad Ardyth (Tier 1)} is curious about what the characters learned in their vision and is eager for the characters to share any magical secrets they might have discovered.
\item \textbf{Irvan Wastewalker (Tier 1)} has no interest in what happened in the grotto, but he is interested in learning what the jewel can do.
\item \textbf{Maggie Keeneyes (Tier 1)} agrees with anyone who expresses concern for the characters but doesn't say much on her own. She has her suspicions that more happened than what they have related during the event in the grotto, but she won't push them if they don't want to reveal the full truth.
\end{itemize}
...
\begin{DndComment}{Refusing the Call}
...
\listparagraph[6pt]{Caught Sleeping}
...
\listparagraph[6pt]{Rivals' Reunion}
...
\listparagraph{Emerald Loop Caravan Stop}
...
\begin{DndTable}[header=Xhorhas Encounters]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
\listparagraph[6pt]{Patrol at Rest}
{{The characters come across six lawful neutral Aurora Watch \textbf{Veteran} (a mix of lawful good drow, humans, and orcs) who are resting at a campsite just off the road. Clearly in good spirits, they invite the characters to join them. Traveling with this patrol is a lawful good, drow \textbf{scout} who also serves as a cook. If the characters take a long rest with the patrol, the food they were given the night before grants them 1d10 temporary hit points when they awaken the next day.}}
\listparagraph{Patrol in Battle}
{{The characters see six lawful neutral Aurora Watch \textbf{Veteran} (a mix of lawful good drow, humans, and orcs) fighting a \textbf{hezrou}. If the characters help the Aurora Watch slay the demon, the soldiers thank them, give them a total of 50 gp as a reward, and promise to commend them to Taskhand \textbf{Verin Thelyss} when the patrol returns to Bazzoxan. If the characters do nothing to help, the soldiers slay the demon, but only after one soldier is killed and two others are reduced to 0 hit points (one stable, the other dying).}}
\listparagraph{Lost Patrol}
{{On the road in front of the characters are the bodies of six Aurora Watch soldiers near the corpse of a hezrou that is slowly dissolving into black ichor. Two \textbf{Shadow Demon} and two \textbf{Quasit} lurk beneath the soldiers' corpses, waiting for more prey to arrive. They fight to the death.}}
...
The carrion bird is a \textbf{vrock} that has been feeding on the mortal flesh strewn about the battlefield. It swoops down to attack characters who disturb any of the corpses. In addition, three \textbf{Quasit} hide in the udaak's fur and attack non-demons that come within 10 feet of the udaak's melting corpse.
...
The characters see a \textbf{gloomstalker} (see appendix A) antagonizing 1d3 \textbf{Mammoth} that are moving slowly across the wastes, minding their own business. The creatures are 3d6 * 100 feet away from the characters when the encounter begins.
...
Each time the gloomstalker uses Shriek during the battle against the characters, 1d6 \textbf{Skeleton} of dead human soldiers burst up out of the ground within 30 feet of the characters and attack them, acting on their own initiative count. Skeletons that aren't reduced to 0 hit points collapse into inanimate piles of bones after 10 minutes or when the gloomstalker is slain.
...
The characters hear a wild yell. In the distance, they see a lawful neutral, tiefling \textbf{scout} named Justice on the back of a \textbf{moorbounder} (see appendix A) and hanging on for dear life as the creature snarls and bucks about. Two \textbf{Bristled Moorbounder} (see appendix A) are circling the imperiled tiefling. Justice can hang on for another minute at most, and the moment he touches the ground, the bristled moorbounders intend to tear him limb from limb.
...
\listparagraph[6pt]{L2a: Upladder}
...
\item The Acorn Sisters, Lanata and Robur, are \textbf{Dryad}. As the caretakers of this forest, they're fine with bonfires as long as only dead wood is burned. It's customary to share food, drink, and song with them in appreciation for their hospitality. Characters who show them great respect by making an offering directly to them awaken in the morning with a \textit{charm of vitality} (see the rules for supernatural gifts in the Dungeon Master's Guide).
\end{itemize}


\paragraph{Shopping}
The caravanners parked around the bonfire—including Justice's employers, if he is present—have merchandise for sale. Two neutral \textbf{Bugbear Chief} guard the wagons, and six lawful neutral Aurora Watch \textbf{Veteran} (a mix of drow, humans, and orcs) resting at the camp are prepared to apprehend any thieves and drag them to Bazzoxan in chains.
...
\begin{DndTable}[header=Merchants' Wares]{ >{\hsize=0.667\hsize}X X >{\hsize=0.167\hsize}c }
...
This chapter begins as two Aurora Watch \textbf{Guard} guide the characters from the gate of Bazzoxan toward the Gatehold Barracks. Read or paraphrase the following as the characters enter the town:
\begin{DndReadAloud}{}
...
Five \textbf{Gibbering Mouther} have sneaked into Bazzoxan and are intent on consuming anyone in their path. Opposing them are members of the Aurora Watch led by Taskhand \textbf{Verin Thelyss} (see the accompanying stat block).
...
\subsection{Fight!}
If the characters choose to help the Aurora Watch, everyone rolls initiative. \textbf{Verin Thelyss} and two orc \textbf{Guard} of the Aurora Watch stay with the party, while the rest of the soldiers leave to secure other parts of the city.
\paragraph{Rivals}
...
\begin{DndTable}[header=Bazzoxan Scenes]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
4 & An Aurora Watch soldier (lawful good \textbf{drow elite warrior}) breaks up a fight between two sobbing citizens (lawful good \textbf{Commoner}).\\
5 & Ten Aurora Watch \textbf{Guard} (lawful good drow, humans, and orcs) jog in formation, keeping tempo by singing about the ways they'll die.\\
...
Anyone who tinkers with the puzzle box's locking mechanism for 1 minute can make a DC 20 Intelligence check, opening the box on a success. The box contains a folded-up spell scroll of \textit{bestow curse}.
...
Bautha also has a spell scroll of \textit{greater restoration}. She must succeed on a DC 15 Wisdom check to cast the spell from the scroll; otherwise, the scroll is destroyed with no effect. She will sell it to the characters for 500 gp.
...
\listparagraph[6pt]{Shooting Match}
...
\begin{DndComment}{Firbolgs of Exandria}
...
The escaped creatures are two \textbf{Gloomstalker} (see appendix A). The soldiers stationed outside can assist the characters in battling the gloomstalkers, or you can have them rush inside to help three gravely injured Aurora Watch soldiers (lawful good, orc \textbf{Knight}) in area R1.
...
\begin{DndTable}[header=Betrayers' Rise Encounters]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }

d10 & Encounter\\
1 & The characters enter a room lined with flickering candles, only to discover that their shadows have detached from them and transformed into \textbf{Shadow Demon} (one per character).\\
2 & Four \textbf{Ochre Jelly} burble along the walls of a hallway, looking for prey to devour.\\
...
5 & Two invisible \textbf{Barlgura} ambush the characters.\\
6 & A passageway opens into what was once a coliseum and now contains three enraged \textbf{Nightmare}.\\
7 & A gurgling, acidic river cuts through a cavern where three \textbf{Roper} stealthily await.\\
8 & Three \textbf{Chasme} emerge from their hive, which has overtaken what was once a chandelier.\\
...
\begin{DndTable}[header=Betrayers' Rise Reinforcements]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }

d6 & Encounter\\
1 & 1d6 \textbf{Quasit} nesting in the corpses of the area's previous inhabitants or crawling on the walls in centipede form\\
2 & 1 \textbf{chasme} clinging to the ceiling\\
3 & 1 invisible \textbf{barlgura} standing guard\\
4 & 1d4 \textbf{Shadow Demon} lurking in the darkness\\
...
Opening the door to this room releases three hostile \textbf{Flameskull}—the remains of torturers who served the Betrayer Gods long ago.
\begin{DndReadAloud}{}
...
The two \textbf{Drider} are former drow warriors of the Aurora Watch mutated by the demonic magic of Lolth the Spider Queen. The two \textbf{Giant Spider} in this area have also been tainted, changing their type to Fiend.
...
\begin{DndTable}[header=Symbols of the Gods]{ >{\hsize=0.833\hsize}X >{\hsize=0.167\hsize}c }
...
\begin{DndTable}[header=Symbol Sequence]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
The \textbf{Fiendish Orc} are two \textbf{Orc War Chief} that were once valiant soldiers of the Aurora Watch. Both have been corrupted by demonic magic and have the following changes to their statistics:
\begin{itemize}
...
\paragraph{Treasure}
A character who inspects the remains of the two Cobalt Soul explorers finds a cloak of protection and a cracked driftglobe. In its damaged state, the Cracked Driftglobe can be used only to cast the \textit{light} spell.
...
\listparagraph[6pt]{Friendly Rivals}
...
\listparagraph{Indifferent Rivals}
...
\listparagraph[6pt]{Prolix Yusaf}
...
\listparagraph{Taskhand Verin Thelyss}
...
\listparagraph[6pt]{Faction Story Tracks}
...
\listparagraph[6pt]{Friendly Rivals}
{{If the rivals are predominantly friendly toward the characters, they cordially part ways after the "Arrival in Ank'Harel" scenario. The rivals find an inn that they make their semi-permanent residence, and a few days later Galsariad shares the address with the characters using a spell scroll of \textit{sending}.}}
\listparagraph{Indifferent Rivals}
...
\listparagraph[6pt]{Population}
{{293,500 (predominantly humans, orcs, and elves)}}
\listparagraph{Leader}
...
\begin{DndTable}[header=Ank'Harel Lodgings]{ >{\hsize=0.667\hsize}X >{\hsize=0.167\hsize}c >{\hsize=0.167\hsize}c }
...
\listparagraph[6pt]{Headquarters}
...
\begin{DndComment}{Goliaths of Exandria}
...
The shop is run by Bas and Kovra Lyrean, twin sisters who are neutral evil, half-elf \textbf{Bandit}. Originally alchemists by trade, they use their knowledge to brew magic potions deemed by the Hands of Ord to be too dangerous for public consumption.
...
\listparagraph[6pt]{S1: Crystal Chateau Entrance}
{{This elite university is described below.}}
\listparagraph{S2: Teleportation Atrium}
...
\listparagraph{S5: Scroll's Alcove}
...
\listparagraph[6pt]{T1: Welcome Arch}
{{This vaulted stone archway draped with crimson banners welcomes everyone to the bazaar.}}
\listparagraph{T2: Battlements}
{{The walls of the Suncut Bazaar are made of sandstone and patrolled day and night by Hands of Ord \textbf{Guard} and \textbf{Veteran}.}}
\listparagraph{T3: Central Street}
...
\listparagraph[6pt]{Expeditions to Cael Morrow}
...
\listparagraph{Sentinels of Memory}
...
\listparagraph[6pt]{Maw of Cael Morrow}
...
\subsubsection{Returning to the Chateau}
If the characters defeat \textbf{Galeokaerda}, the headmasters give them the 1,000 gp reward as promised, and Alakritos tells them to expect their next mission in a week's time. If the characters bring back the ruidium greataxe (the Key to the Netherdeep), they are awarded an additional 1,000 gp.
...
\begin{DndComment}{Which Faction Should the Rivals Join?}
...
At night the casino is crowded, as people filter in after work has finished for the day to try their hand at one of the casino's games. Each floor of the casino is patrolled by four \textbf{Guard}; in addition, the ground floor is staffed by ten \textbf{Commoner}. A pair of finely upholstered spiral staircases in the back of the building connects the three floors. Each staircase is magical and functions like an escalator—one has stairs that carry patrons upward, while the other has stairs that move downward.
...
\item Duskwood (chaotic neutral, half-elf \textbf{spy}), like Ena, masquerades as a casino patron and wears a hat of disguise.
\item \textbf{Koris} (lawful neutral, tiefling \textbf{assassin}), the crew's leader, works at one of the casino's card tables—a job she has held for about a month. She carries a potion of gaseous form, a tiny packet containing dust of disappearance, and a bag of holding.
\end{itemize}
...
\item New members can buy the following magic items at the Temple of the Mentor: a spell scroll of \textit{detect magic} (10 gp), a spell scroll of \textit{divination} (125 gp), a spell scroll of \textit{commune} (250 gp), and a pair of sending stones (250 gp).
\end{itemize}
...
This combat encounter takes place on the Streets of the Suncut Bazaar map. The crystalline creatures are two \textbf{Ruidium Elephant} (see their stat block earlier in the adventure). These elephants are running amok and must be destroyed before they cause any further damage.
...
\item Earn \textbf{Insight Acuere}'s trust and learn how to access the Netherdeep.
...
The characters can meet \textbf{Insight Acuere} in the Allegiance base camp (area M3 in chapter 5). She tells them that her companions are searching for the writings of an ancient hero who tried to save Cael Morrow from destruction during the Calamity. Earlier expeditions found dozens of stone tablets from the period in question at the south end of the excavation site. Her team, however, no longer has the force of arms to fight the dangerous creatures that lurk in this region. If the characters can find more of these tablets and return them to her, she'll be grateful.
\paragraph{Insight's Reward}
If the characters bring back the tablet from area M10 in chapter 5, \textbf{Insight Acuere} shares the following information:
\begin{itemize}

\item \textbf{Insight Acuere} reveals the location of the rift leading to the Netherdeep (area M17 in chapter 5) and informs the characters that weapons infused with ruidium can open this rift.
\item \textbf{Insight Acuere} believes there might be keys to the rift in Cael Morrow—left behind by agents of the Consortium of the Vermilion Dream.
\end{itemize}
...
This location contains the tablet that \textbf{Insight Acuere} seeks.
\paragraph{Cliffside Villa (Chapter 5, Area M13)}
...
\begin{DndComment}{Allegiance of Allsight Badges}
...
\begin{DndTable}[header=Aboleth's Location]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
\begin{DndTable}[header=Poisoned Emotions]{ >{\hsize=0.167\hsize}c >{\hsize=0.250\hsize}X >{\hsize=0.583\hsize}X }
...
\begin{DndTable}[header=Cael Morrow Encounters]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }

d12 & Encounter\\
1 & A \textbf{swarm of sorrowfish} (see appendix A) flocks around the detritus of a shark's corpse, ravenous for more prey.\\
2 & Three \textbf{Scuttling Serpentmaw} (see appendix A) search for food.\\
...
5 & Two \textbf{Slithering Bloodfin} (see appendix A) streak through the water, eager for a meal.\\
...
Two \textbf{Scholarly Agent} (see appendix A) stand outside the door to area M3. One is a lawful neutral human named Kal, and the other is a lawful good halfling named Nadiya.
...
If \textbf{Insight Acuere}, \textbf{Scribble}, and \textbf{Xot} become hostile toward intruders, they fight to kill. On the first turn of combat, \textbf{Insight Acuere} uses a sending stone to contact Headmaster Cryon in the Crystal Chateau and request aid. Twenty minutes later, ten \textbf{Scholarly Agent} and five \textbf{Scholarly Excavator} (see appendix A for both stat blocks) arrive by way of area M1 to secure the base camp.
\paragraph{Insight Acuere}
The \textbf{Insight Acuere} uses the \textbf{scholarly mastermind} stat block (see appendix A), with these changes:
\begin{itemize}
...
\textbf{Insight Acuere} won't cooperate with the Consortium of the Vermilion Dream unless she is tricked or magically compelled into doing so. If the characters are members of the Allegiance of Allsight, \textbf{Insight Acuere} informs them that they have arrived earlier than she expected, but she's nonetheless happy to see them. If they're allied with the Cobalt Soul, she requires them to prove their usefulness before she reveals any information (see "Insight's Quest" in mission 4 of the Cobalt Soul Story Track in chapter 4).
\textbf{Insight Acuere} is the primary archivist for the Cael Morrow archaeological project and would put her life on the line to ensure its success. She is willing to share the results of her research with fellow Allegiance members. \textbf{Insight Acuere} can offer the following information in response to the characters' questions:
\begin{itemize}
...
\item A fourth member of the expedition, \textbf{Insight Acuere}'s friend \textbf{Galeokaerda}, a high elf professor of ancient literature, hasn't been seen in three days. \textbf{Insight Acuere} is concerned but hasn't yet considered raising a search party because \textbf{Galeokaerda} has a shield guardian to protect her.
\end{itemize}
...
\listparagraph[6pt]{First and Second Floors}
...
\paragraph{Treasure}
Any character who spends 10 minutes searching through the rubble can make a DC 20 Intelligence (Investigation) check. On a successful check, the character finds a spell scroll of \textit{teleport}. Only one such scroll can be found here.
...
\listparagraph[6pt]{Magically Preserved Wine}
...
Modify \textbf{Galeokaerda} stat block as follows:
\begin{itemize}
...
As described in the faction story tracks in chapter 4, \textbf{Galeokaerda} has long posed as a professor of the Allegiance of Allsight and has become \textbf{Insight Acuere}'s friend. Now she regrets betraying her friend and secretly hopes that she can convince \textbf{Insight Acuere} to turn against the Allegiance of Allsight when \textbf{Galeokaerda} and the Consortium of the Vermilion Dream take over Cael Morrow.
...
Four \textbf{Scuttling Serpentmaw} (see appendix A) lurk amid the rubble and scuttle across the floor to attack characters who investigate the room. Characters who have a passive Wisdom (Perception) score of 18 or higher notice the serpentmaws and aren't Surprise when they attack.
\paragraph{Clay Tablets}
Characters who spend 10 minutes searching the floor of the building find, among other clay tablets that describe ancient prayers and catechisms of the monks of the temple of Corellon, the particular tablet that \textbf{Insight Acuere} has been seeking (see "Insight's Quest" in mission 4 of the Cobalt Soul Story Track in chapter 4). This tablet is written in Celestial script. It reads:
\begin{DndReadAloud}{}
...
\paragraph{Treasure}
Embedded in the \textbf{death embrace}'s bell is a ruidium greataxe (see appendix B), the so-called Key to the Netherdeep that the Allegiance of Allsight and the Consortium of the Vermilion Dream are after (see chapter 4). The axe can be removed from the \textbf{death embrace} only after the creature is dead.
...
The tower is haunted by eight \textbf{Sword Wraith Warrior} under the command of Beltreath, a lawful neutral \textbf{sword wraith commander}. See appendix A for these creatures' stat blocks.
...
If combat breaks out and Beltreath is reduced to 50 hit points or fewer, he surrenders and begs the characters not to destroy him, for Hadarai's sake. If the characters show mercy, Hadarai is grateful and offers to assist them in any way he can. For example, the ghost, as a priest of Corellon, can help the characters bypass the magic ward around the temple (area M9) or can warn the characters about the \textbf{Alyxian Aboleth} that haunts the city.
...
A character who searches the opening for traps and succeeds on a DC 17 Intelligence (Investigation) check spots a tiny glyph inscribed along the edge of the opening, in a location that's not visible while the trapdoor is closed. If this glyph is dispelled with a successful casting of \textit{dispel magic} (DC 17) or defaced using mason's tools or similar equipment, the following trap ceases to function.
\paragraph{Trap}
...
The burst of light from this trap attracts the \textbf{Slithering Bloodfin} in area M16 and possibly the \textbf{Alyxian Aboleth} (see appendix A for their stat blocks). If the aboleth is in the nearby kelp forest (area M11) when the trap is sprung, it sees the light and immediately moves to investigate it.
\paragraph{Treasure}
The walls of the armory are festooned with longswords, shortswords, spears, longbows, shortbows, arrows in leather quivers, and steel shields—all corroded or rotted beyond usefulness. Among these objects are two magic items, both of which can be located quickly by using a \textit{detect magic} spell: a sentinel shield and a frost brand longsword. A character must otherwise spend at least 1 minute searching the armory to find these magic items.
...
Unless the characters killed them in area M15, three \textbf{Slithering Bloodfin} (see appendix A) prowl this area in search of prey. The characters spot them—three streaks of crimson darting through the ruins. Unless the characters move away from the ruins immediately, the bloodfins swim toward the intruders and attack.
...
\begin{DndTable}[header=Fragments of Suffering]{ >{\hsize=0.500\hsize}c >{\hsize=0.500\hsize}c }
...
\begin{DndTable}[header=Apotheon Lore]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
\begin{DndTable}[header=Evidence of Rivals]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
\Large \centering «
\large \centering I lived in service of others, selflessly, for I knew no other way. Now, forgotten, hanging between life and death, I can think of naught but regret for a life haunted and unlived.
\Large »
 
 \normalsize \raggedleft \textit{ - Alyxian the Apotheon, Unknown source}
\end{DndSidebar}
\endgroup
...
\begin{DndComment}{Emotional Torment}
...
Swimming in the dark water 20 feet above the characters (30 feet above the floor) are two \textbf{Light Devourer} and a \textbf{slithering bloodfin} (see appendix A for their stat blocks) that act as sentries. Characters who find themselves outmatched by the monsters or unable to cope with the water pressure can retreat through the open rift and return to Cael Morrow.
\paragraph{Statues}
...
\paragraph{Raiders}
A group of soldiers—allies of Alyxian in the battle against Torog—have decided that since they saved this village, it is theirs to pillage. Four \textbf{Sword Wraith Warrior} led by a \textbf{sword wraith commander} (see appendix A for their stat blocks) take the shadowy shape of Alyxian's crass allies. They are bullying a group of ten \textbf{Commoner} in the middle of the village. As the characters approach, the commander, a neutral evil human in his mid-twenties named Kalagothe, looks to them as if they were Alyxian and roars, "Commander Alyxian, these people refuse to pay us tribute!"
...
When the characters learn all three names, three \textbf{Ghost} rise from the women's corpses and attack the intruders until at least one of the ghosts' names is spoken aloud. The ghosts resemble the three women, but they are not restless spirits. Rather, they are manifestations of Alyxian's rage and regret. The characters can destroy these ghosts by reducing each of them to 0 hit points.
...
\DndSetThemeColor[DmgLavender]\begin{DndSidebar}{}
\Large \centering «
\large \centering I sacrificed everything for them! And now they tear at my flesh to slake their greed, with no thought for their savior. There is only one way to repay their ill gratitude.
\Large »
...
Three \textbf{Scuttling Serpentmaw} (see appendix A) hide behind the statues and ruidium spikes in the middle of the area. A character who tries to cross the cavern must succeed on a DC 19 Wisdom (Perception) check to avoid being Surprise when the serpentmaws attack.
\paragraph{Apotheon's Fury}
...
\paragraph{Bones}
The floor contains the bones of three slithering bloodfins. If the secret door to area N14a is opened, the bones quietly knit themselves back together and attack any other creatures in the cavern. These \textbf{Skeletal Bloodfin} have glowing red eyes and use the \textbf{slithering bloodfin} stat block (see appendix A), with these changes:
\begin{itemize}
...
\begin{DndComment}{Roleplaying Theo}
...
\begin{DndTable}[header=Curses of Ruidus]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
When a character touches the mote of light (see "Fragment of Melancholy" below), three \textbf{Chuul} hidden under the sandy floor in the middle of the grotto rise and attack. Theo shrieks and cowers from the chuuls, which do not attack him. The chuuls pursue prey into area N17 but won't go any farther.
...
\DndSetThemeColor[DmgLavender]\begin{DndSidebar}{}
\Large \centering «
\large \centering Those I saved live on. Their joy, their struggles, their ambitions, filter into my home in the depths like sunlight through the waves. How I long to feel that again—the fluttering of another living soul.
\Large »
...
\begin{DndTable}[header=Weird Events]{ >{\hsize=0.167\hsize}c >{\hsize=0.833\hsize}X }
...
\item The rolled-up scroll is a spell scroll of \textit{Otiluke's resilient sphere} tied with a green ribbon.
\end{itemize}
...
The key to the door can be found in area N16a. A character can use an action to try to pick the lock with thieves' tools, doing so with a successful DC 22 Dexterity check. A \textit{knock} spell or similar magic also opens the door.
...
\listparagraph[6pt]{Purple Layer}
...
\listparagraph[6pt]{Alyxian's Personality}
...
\listparagraph{Alyxian's Future}
...
\listparagraph{Alyxian's Regret}
...
\listparagraph{Alyxian's Yearning}
...
\listparagraph{The Heart of Despair}
...
\listparagraph[6pt]{Avandra's Grasp}
...
\listparagraph{Corellon's Charm}
...
\listparagraph{Sehanine's Torment}
...
\begin{DndComment}{Roleplaying Alyxian the Absolved}
...
\listparagraph[6pt]{Alyxian Is Killed}
...
\listparagraph{Alyxian Is Unleashed}
...
\listparagraph{Alyxian Is Redeemed}
...
\listparagraph[6pt]{Avandra the Change Bringer}
{{Avandra might reach out to paladins, druids, clerics, wizards, the adventurous, and the bold. She encourages her faithful to grasp their fate, embrace change for the better, and rise against the threat posed by Alyxian. If the characters need her aid, her \textbf{Solar} and \textbf{Planetar} might deliver useful information about places they hope to visit, or Avandra might provide the occasional swing of fate in the characters' favor.}}
\listparagraph{Corellon the Arch Heart}
...
\listparagraph{Sehanine the Moon Weaver}
...
\begin{DndTable}[header=Battle Chatter]{ >{\hsize=0.167\hsize}X >{\hsize=0.833\hsize}X }
...
\begin{DndComment}{Vestiges of Divergence}
...
\item Jewel of Three Prayers
\item Ring of Free Action
\item Ring of Red Fury
\item Ruidium Armor
\item Ruidium Shield
\item Ruidium Weapon
\end{itemize}
...
\item Medal of Muscle
\item Medal of the Conch
\item Medal of the Horizonback
\item Medal of the Maze
\item Medal of the Meat Pie
\item Medal of the Wetlands
\item Medal of Wit
\end{itemize}
