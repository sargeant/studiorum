...
\begin{DndTable}[header=Feywild Weather]{XX}
...
\begin{DndTable}[header=Feywild Guide Names]{XX}
...
\begin{DndTable}[header=Feywild Guide Identities]{XX}
...
\begin{DndTable}[header=Feywild Guide Quirks]{XX}
...
\paragraph{Taking a Life in Debt}
...
\begin{DndTable}[header=Fey Desires for Greater Contracts]{XX}
...
\begin{DndTable}[header=Fey Desires for Lesser Contracts]{XX}
...
\begin{DndTable}[header=Breaking a Greater Contract]{XX}
...
\begin{DndTable}[header=Breaking a Lesser Contract]{XX}
...
\begin{DndTable}[header=Fey Curses]{XX}
...
\begin{DndTable}[header=Ending the Curse]{XX}
...
\begin{DndTable}[header=Fey Abodes]{XX}
...
\begin{DndTable}[header=Archfey's Presentation]{XX}
...
\begin{DndTable}[header=Archfey's Personality]{XX}
...
\begin{DndTable}[header=Archfey Obsession]{XX}
...
\begin{DndTable}[header=Signature Magic]{XX}
...
\begin{DndTable}[header=Magical Gifts]{XX}
...
\paragraph{Legendary Resistance (3/Day)}
...
\begin{DndTable}[header=Geographical Features]{XX}
...
\begin{DndTable}[header=Domain Theme]{XX}
...
\begin{DndTable}[header=Fey Crossings]{XX}
...
\begin{DndTable}[header=Shortcut Routines]{XX}
...
\begin{DndTable}[header=Domain Drama]{XX}
...
\begin{DndTable}[header=Weird Magic Effects]{XX}
...
\begin{DndComment}{Awakened Beasts}
...
\begin{DndTable}[header=Feywild Creatures]{XX}
...
1 & \textbf{Animated armor}, \textbf{brown bear}, \textbf{bugbear}, \textbf{dryad}, \textbf{faerie dragon (red)}, \textbf{giant eagle}, \textbf{giant hyena}, \textbf{giant octopus}, \textbf{giant spider}, \textbf{giant toad}, \textbf{giant vulture}, \textbf{goblin boss}, \textbf{half-ogre (ogrillon)}, \textbf{harpy}, \textbf{hippogriff}, \textbf{lion}, \textbf{quickling}, \textbf{scarecrow}, \textbf{spy}, \textbf{swarm of campestris}, \textbf{tiger}\\
2 & \textbf{Awakened tree}, \textbf{bandit captain}, \textbf{berserker}, \textbf{centaur}, \textbf{darkling elder}, \textbf{druid}, \textbf{ettercap}, \textbf{faerie dragon (violet)}, \textbf{giant boar}, \textbf{giant constrictor snake}, \textbf{giant elk}, \textbf{griffon}, \textbf{merrow}, \textbf{myconid sovereign}, \textbf{ogre}, \textbf{peryton}, \textbf{sea hag}, \textbf{swarm of poisonous snakes}, \textbf{treant sapling}, \textbf{will-o'-wisp}\\
...
\begin{DndTable}[header=Domain Visitors]{XX}
