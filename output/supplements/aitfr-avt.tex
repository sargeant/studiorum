...
\subsection{In Previous Adventures}
...
\subsection{Tyreus the Trespasser}
...
\subsection{A Visitor in Secret}
...
(In truth, Durow is the victim of a modify memory spell cast by Tyreus, who "confessed" his plans for Sylvene's tomb to Durow as a means of flushing out rivals and other enemies. Tyreus has already been to Sylvene's tomb.)
\subsection{A Treasure Lost to History}
...
\begin{DndComment}{Be Careful About Piling On}
...
Last spring, three water weird flowed into this area when the river overflowed. They remain here still, swirling through the water like transparent snakes and steeping in a sense of sorrow and pride from the crypts beyond. They do not threaten the other monsters that dwell here, but they waste no time attacking those they deem trespassers.
\section{2. Garden Shrine}
\begin{DndReadAloud}{}
...
It takes a successful DC 12 Strength (Athletics) check to open the iron gate. Unsealing the stone slab requires a successful DC 20 check.
Loudly opening the iron gate or unsealing the stone slab likely alerts all creatures in the mausoleum as far as area 7.
\chapter{Part 2: Inside the Crypts}
...
The grave-robbers had gathered grave goods, candlesticks, metal fixtures, and other art objects worth a total of 440 gp, plus a spell scroll of lesser restoration, a Potion of Greater Healing, and a chime of opening.
\section{7. Grand Mausoleum}
\begin{DndReadAloud}{}
...
\section{8. Processional Corridor}
\begin{DndReadAloud}{}
...
In the corridor, 30 feet beyond the once-sealed doorway, Sylvene installed one of her magic stele traps, facing this door. It has disadvantage on its passive Perception score to detect trespassers peering through the gaps in the doorway.
\subsubsection{Magic Stele Trap}
The stele can detect trespassers out to a range of 60 feet in front of it. It has a passive Perception score of 18. To disarm or dispel this trap requires a successful DC 18 check. When triggered, the trap emits a bolt of lightning 60 feet long. Any creature in the target area that fails a DC 15 Dexterity saving throw takes 22 (4d10) lightning damage, or half as much damage with a successful save.
...
\begin{DndComment}{Medallion of Safe Passage}
...
This short passage was a gift to Sylvene from Artura, to wow her upon her entrance to the site for Waltarn's burial. It was never intended to be trapped, but it is now. This is as far as Tyreus ventured into the tomb after entering through area 11. He left two traps here using linked glyphs (see appendix A). Finding any of these glyphs requires a successful DC 17 Intelligence (Investigation) check.
First, an alarm glyph has been placed on the stairs (A) to alert Tyreus and let him know it is time for him to cast project image and appear in area 11.
Secondly, a detection glyph has been placed on the stairs in almost the same spot (A), linked to an effect glyph (B), which casts fear (DC 17) up the stairs to the east when any humanoid creature touches or passes over the detection glyph.
Tyreus's aim is to drive frightened intruders toward the spell glyphs in area 10.
\section{10. Memorial Chamber}
\begin{DndReadAloud}{}
...
\begin{itemize}
\item Artura Dwaircalis
\item Waltarn Everlake
\item Sylvene herself
\item Hamish Hewland
\end{itemize}

Tyreus hated this room. He has hidden a glyph of warding on Waltarn's face, created to cast phantasmal killer on the first humanoid to get within 5 feet of the glyph.
\section{11. Grand Crypt}
\begin{DndReadAloud}{}
...
\subsubsection{Development}
If he can arrange it, Tyreus appears to be standing in the teleportation circle when the adventurers arrive. (It is actually an illusory image of Tyreus, who is hundreds of miles away at Highstar Lake and making use of a project image spell.)
...
\subsubsection{Treasure}
Funeral goods, mementos, prayer objects, and other nonmagical treasures in the area are made predominantly of silver, worth a total of 510 gp. In a prayer bowl in the northern area of the crypt waits more treasure, overlooked by Tyreus when he was here: two chip of creation (see appendix B).
\begin{DndComment}{Variant: Tenebrous Assassins}
...
\subsection{Tyreus Came to Talk}
...
\begin{itemize}
\item He only recently learned—from diaries he took from Sylvene's libraries—that Waltarn Everlake was his grandfather. He's not impressed with Waltarn; Tyreus considers him a weak, common simpleton.
\item Waltarn and his family didn't want him brought back to life after he was slain on an adventure. "What cowards," Tyreus might say. "What a lack of vision."
\item Tyreus took the five keystones of creation Sylvene attempted to hide here with Waltarn. With them, he will "create for myself a place worthy of the followers I deserve."
\end{itemize}

\chapter{Part 3: What's Next}
...
\begin{itemize}
\begin{multicols}{3}
\item Stone of Creation
\item Chip of Creation
\item Keystone of Creation
\end{multicols}
...
\item[Adventure Writing & Maps]
Will Hindmarch
\item[Adventure Graphic Designer]
Bree Heiss
\item[Illustrators]
Andrey Kuzinskiy and Lindsey Look
\item[Adventures in the Forgotten Realms Set Leads]
