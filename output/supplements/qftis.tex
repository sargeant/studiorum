...
Cave morays inside their burrows have Cover. A creature within 5 feet of a burrow can pull a cave moray from its burrow by grappling it. If removed from its burrow, a cave moray frantically tries to escape back to its hole.
...
\begin{DndTable}[header=Vestibule Destinations]{XX}
...
\begin{DndTable}[header=Figuring Out Alien Technology]{lX}
...
\begin{DndTable}[header=Key Card Access]{lX}
...
The behir makes one bite attack against a Medium or smaller target it is grappling. If the attack hits, the target is also swallowed, and the grapple ends. While swallowed, the target is blinded and restrained, it has Cover against attacks and other effects outside the behir, and it takes 21 (6d6) acid damage at the start of each of the behir's turns. A behir can have only one creature swallowed at a time.
...
Creatures inside the cube can be seen but have Cover.
...
Creatures within 10 feet of the horrid plant and not behind Cover must make a DC 14 Dexterity saving throw, taking 21 (6d6) slashing damage on a failed save or half as much damage on a successful one.
